...
import { h as ct, m as Ce, S as lt } from "./db-master-DiZIyMfK.js";
import { k as ie, m as ce, j as dt } from "./@tanstack-m-1uuL6k.js";
import { _ as mt, __tla as __tla_0 } from "./index-CF4MAqFH.js";
import { C as pt, A as ut } from "./AutoScrollDownArea-DZN1gH-S.js";
import { S as ht } from "./session-manager.class-CMli7K9_.js";
        ...
        async updateSessionInDB () {
            if (o.currentSession) try {
                const { masterDb: t } = await mt(async ()=>{
                    const { masterDb: r } = await import("./db-master-DiZIyMfK.js").then((a)=>a.w);
                    return {
                        masterDb: r
                    };
