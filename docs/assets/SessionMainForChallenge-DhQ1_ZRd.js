...
import { D as O, F as V, r as j, u as F, E as se, j as s } from "./react-BPCshYXX.js";
...
import { m as fe, P as xe, C as H, a as _e } from "./PlayerInputItem-Cw3shOQU.js";
import { B as P } from "./button-CKyQl8ny.js";
import { T as ye } from "./textarea-Dc_MpBxB.js";
import { B as D } from "./badge-b3CWeD_H.js";
import { C as be } from "./CharacterAvatar-DwtbYeXp.js";
import { u as Se, a as ve } from "./global-llm-config.store-B8jg895c.js";
import { c as v } from "./shadcn-utils-BMZD7_jZ.js";
import { ai as E, o as L, v as W, C as R, _ as Ce, r as we, ak as Ne, ag as ke, ah as je, V as Ie, E as Me, I as Pe } from "./icons-BpfK1DnB.js";
...
`) || "\u65E0\u516C\u5F00\u53D8\u91CF";
    return [
      {
        role: "system",
        content: Ee.replace("{{title}}", i.title || "\u6587\u5B57\u6311\u6218").replace("{{characterName}}", a.name).replace("{{characterDescription}}", a.description || "\u795E\u79D8\u89D2\u8272").replace("{{gameGoals}}", r).replace("{{failureConditions}}", n).replace("{{variableDescriptions}}", c).replace("{{userGuidance}}", t.userGuidance)
      }
    ];
  }
  function Ae(i, e) {
...
`) || "\u65E0\u5931\u8D25\u5224\u5B9A", o = Q(e, i), f = ((_a = e.getLastUserMessage()) == null ? void 0 : _a.data.content) || "";
    return [
      {
        role: "system",
        content: Te.replace("{{characterName}}", r.name).replace("{{gameGoals}}", c).replace("{{failureConditions}}", g).replace("{{historyMessages}}", o).replace("{{variablesJSON}}", n).replace("{{userInput}}", f)
      }
    ];
  }
  function Fe(i, e) {
...
`) || "\u65E0\u5931\u8D25\u5224\u5B9A", o = Q(e, i), f = ((_a = e.getLastUserMessage()) == null ? void 0 : _a.data.content) || "", h = ((_b = e.getHistoryItems().findLast((_) => _.type === "challenge_mode_dm_eval")) == null ? void 0 : _b.data.analyze) || "\u6839\u636E\u73A9\u5BB6\u884C\u52A8\u66F4\u65B0\u4E86\u76F8\u5173\u72B6\u6001\u3002";
    return [
      {
        role: "system",
        content: Ue.replace("{{characterName}}", r.name).replace("{{gameGoals}}", c).replace("{{failureConditions}}", g).replace("{{variablesJSON}}", n).replace("{{userInput}}", f).replace("{{historyMessages}}", o).replace("{{evalAnalyze}}", h)
      }
    ];
  }
  function $e(i, e) {
...
3. \u5982\u679C\u76EE\u6807\u5DF2\u8FBE\u6210\uFF0C\u4F60\u5E94\u8BE5\u5728\u56DE\u5E94\u4E2D\u81EA\u7136\u5730\u6D41\u9732\u51FA\u6210\u529F\u6216\u9636\u6BB5\u6027\u8FDB\u5C55\u7684\u559C\u60A6\u3002`, [
  ...
  class X {
    ...
    performOperation(e) {
      ...
      } else if (re.safeParse(e).success) {
        const [t, a, r] = e;
        switch (t) {
          case "delta":
            this.delta(a, r);
    ...
    checkCondition(e) {
      ...
      } else if (ce.safeParse(e).success || le.safeParse(e).success) {
        const [t, a] = e;
        switch (t) {
          case "and":
            return this.and(a);
  ...
  class Re extends ge {
    ...
    async executeCurrentStateLogic(e) {
      var _a;
      const t = this.session.modeState.currentPhase, a = new X(this.session.modeState.variableStates, this.session.modeConfig.variables);
      switch (t) {
        case "dm_intro":
          return this.setCurrentUIState(this.getReadyUIStateForPhase("dm_intro")), {
            type: "LLM_CALL",
            messages: De(this.session),
  ...
  const p = O({
    ...
    loadSession(i, e) {
      this.currentSession = i, i.modeState.currentUIState = "idle", this.sessionManager = new Re(i);
      const t = O(e || {
        historyItems: [],
        processingItem: void 0
      });
      this.contextManager = new pe(t), i.modeState && i.modeConfig && (this.variablesManager = new X(i.modeState.variableStates, i.modeConfig.variables || {}));
    },
    ...
    async saveNewContextItemsToDB(i, e) {
      const { SessionDB: t } = await G(async () => {
        const { SessionDB: n } = await import("./db-master-xI8DZi24.js").then((c) => c.s);
        return {
          SessionDB: n
        };
    ...
    async updateSessionInDB() {
      ...
      const { masterDb: i } = await G(async () => {
        const { masterDb: t } = await import("./db-master-xI8DZi24.js").then((a) => a.t);
        return {
          masterDb: t
        };
  ...
  function Oe() {
    const i = Se((o) => o.config), e = j.useRef(false), t = K(), a = async (o, d, f, l, h = {}) => {
      ...
      if (o.callbackPhase === "dm_eval_changes") {
        try {
          ...
          console.error("Failed to parse DM evaluation", m), F.error("DM \u8BC4\u4F30\u6570\u636E\u89E3\u6790\u5931\u8D25\uFF0C\u5C06\u5FFD\u7565\u672C\u6B21\u53D8\u66F4");
        }
      ...
      try {
        ...
        console.error("ChallengeLoop Critical Error:", l), F.error("LLM \u8C03\u7528\u5931\u8D25\uFF0C\u8BF7\u524D\u5F80 LLM \u914D\u7F6E\u9875\u9762\u8FDB\u884C\u914D\u7F6E", {
  ...
  mt = (i) => {
    ...
    const e = K(), [t, a] = j.useState(""), r = j.useRef(null), [n, c] = j.useState(false), [g, o] = j.useState(false), d = se(p), { data: f = [] } = B((u) => u.from({
      s: de
    })), { data: l = [] } = B((u) => u.from({
      c: ue
    ...
    j.useEffect(() => {
      ...
      return (async () => {
        try {
          const S = await me.createSessionDB(h.id).getContextItems();
          if (u) return;
    ...
    const b = async () => {
      ...
      if (u && x) {
        c(true);
        try {
          if (x.getHistoryItems().some((A) => A.type === "challenge_mode_ending")) {
    ...
    const w = async () => {
      ...
      const u = await he.sessions.getTable().get(h.id);
            ...
            s.jsx("div", {
              ...
              children: s.jsx("div", {
                ...
                children: (() => {
                  ...
                  return x && !x.hidden && !u.some((S) => S.id === x.id) && N.push(x), N.map((S, A) => s.jsx(Ve, {
                    item: S,
                    character: m
                  }, `[${A}]${S.id}`));
                })()
  ...
  Ve = (i) => {
    const { item: e, character: t } = i, r = (() => {
      ...
      }) : n.type && (n.type === "success" || n.type === "failure") && typeof n.description == "string" ? s.jsx(Y, {
        item: {
          ...e,
          type: "challenge_mode_ending"
        }
        ...
        s.jsxs("div", {
          ...
          children: [
            ...
            s.jsx("div", {
              ...
              children: i.data.operations.map((e, t) => s.jsx(Be, {
                operation: e
              }, t))
            })
          ]
