import { j as e, r as i, u } from "./react-BPCshYXX.js";
import { B as w } from "./button-CKyQl8ny.js";
import { I as f } from "./input-Dje6SeH9.js";
import { L as h } from "./label-DxXosFPV.js";
import { C as H, a as V, b as K, c as J, d as G } from "./card-B79febki.js";
import { c as C } from "./shadcn-utils-BMZD7_jZ.js";
import { B as k } from "./badge-b3CWeD_H.js";
import { D as Y, a as Q, b as W, c as Z, d as q, e as ee } from "./dialog-CbwgCfJB.js";
import { S as se, a as ae, b as te, c as re, d as S } from "./select-CgkKzHrj.js";
import { T as le, a as ne, b as U, c as R } from "./tabs-ZtUtVHhO.js";
import { C as M } from "./checkbox-BCgVagup.js";
import { r as ce, l as ie, P as oe, R as L, U as de, g as me } from "./icons-BpfK1DnB.js";
...
function ge({ onLogin: s, defaultApiUrl: t }) {
  ...
  return e.jsx("div", { className: "h-full flex items-center justify-center bg-muted/20 p-4", children: e.jsxs(H, { className: "w-full max-w-md", children: [e.jsxs(V, { className: "space-y-1", children: [e.jsxs(K, { className: "text-2xl font-bold flex items-center gap-2", children: [e.jsx(ie, { className: "w-6 h-6 text-primary" }), "\u7BA1\u7406\u5458\u767B\u5F55"] }), e.jsx(J, { children: "\u8BF7\u8F93\u5165\u7BA1\u7406\u5458\u51ED\u8BC1\u4EE5\u8BBF\u95EE\u63A7\u5236\u53F0" })] }), e.jsx(G, { children: e.jsxs("form", { onSubmit: p, className: "space-y-4", children: [e.jsxs("div", { className: "space-y-2", children: [e.jsx(h, { htmlFor: "url", children: "API \u5730\u5740" }), e.jsx(f, { id: "url", placeholder: "https://auth.example.workers.dev", value: o, onChange: (a) => l(a.target.value) })] }), e.jsxs("div", { className: "space-y-2", children: [e.jsx(h, { htmlFor: "username", children: "\u7528\u6237\u540D" }), e.jsx(f, { id: "username", value: x, onChange: (a) => c(a.target.value) })] }), e.jsxs("div", { className: "space-y-2", children: [e.jsx(h, { htmlFor: "password", children: "\u5BC6\u7801" }), e.jsx(f, { id: "password", type: "password", value: d, onChange: (a) => n(a.target.value) })] }), e.jsx(w, { type: "submit", className: "w-full", disabled: g, children: g ? "\u767B\u5F55\u4E2D..." : "\u767B\u5F55" })] }) })] }) });
}
function je({ apiUrl: s, token: t, onLogout: o }) {
  const [l, x] = i.useState([]), [c, d] = i.useState(true), [n, g] = i.useState(false), r = async () => {
    d(true);
    try {
...
function pe({ open: s, onOpenChange: t, apiUrl: o, token: l, onSuccess: x }) {
  const [c, d] = i.useState("single"), [n, g] = i.useState({ code: "", memo: "", max_usages: 3, days_valid: "0", features: [] }), [r, p] = i.useState({ prefix: "NEX-", count: 10, memo: "", max_usages: 3, days_valid: "0", features: [] }), [a, m] = i.useState(false), N = () => {
    ...
    try {
      ...
      b.ok ? (u.success(c === "single" ? "\u9080\u8BF7\u7801\u521B\u5EFA\u6210\u529F" : `\u6210\u529F\u521B\u5EFA ${F.message}`), t(false), x(), g({ code: "", memo: "", max_usages: 3, days_valid: "0", features: [] }), p({ prefix: "NEX-", count: 10, memo: "", max_usages: 3, days_valid: "0", features: [] })) : u.error(F.error || "\u521B\u5EFA\u5931\u8D25");
    } catch {
      u.error("\u7F51\u7EDC\u9519\u8BEF");
    } finally {
      m(false);
  ...
  return e.jsx(Y, { open: s, onOpenChange: t, children: e.jsxs(Q, { className: "sm:max-w-125", children: [e.jsxs(W, { children: [e.jsx(Z, { children: "\u521B\u5EFA\u9080\u8BF7\u7801" }), e.jsx(q, { children: "\u751F\u6210\u5355\u4E2A\u6216\u6279\u91CF\u751F\u6210\u9080\u8BF7\u7801\u3002" })] }), e.jsxs(le, { defaultValue: "single", value: c, onValueChange: d, children: [e.jsxs(ne, { className: "grid w-full grid-cols-2", children: [e.jsx(U, { value: "single", children: "\u5355\u4E2A\u521B\u5EFA" }), e.jsx(U, { value: "bulk", children: "\u6279\u91CF\u751F\u6210" })] }), e.jsxs("form", { onSubmit: T, className: "py-4 space-y-4", children: [e.jsxs(R, { value: "single", className: "space-y-4 mt-0", children: [e.jsxs("div", { className: "grid grid-cols-4 items-center gap-4", children: [e.jsx(h, { htmlFor: "code", className: "text-right", children: "\u9080\u8BF7\u7801" }), e.jsxs("div", { className: "col-span-3 flex gap-2", children: [e.jsx(f, { id: "code", value: n.code, onChange: (j) => g({ ...n, code: j.target.value }), placeholder: "\u4F8B\u5982: NEX-8888", required: c === "single" }), e.jsx(w, { type: "button", variant: "secondary", size: "icon", onClick: N, title: "\u968F\u673A\u751F\u6210", children: e.jsx(L, { className: "w-4 h-4" }) })] })] }), e.jsx(z, { data: n, setData: g })] }), e.jsxs(R, { value: "bulk", className: "space-y-4 mt-0", children: [e.jsxs("div", { className: "grid grid-cols-4 items-center gap-4", children: [e.jsx(h, { htmlFor: "prefix", className: "text-right", children: "\u524D\u7F00" }), e.jsx(f, { id: "prefix", value: r.prefix, onChange: (j) => p({ ...r, prefix: j.target.value }), className: "col-span-3", placeholder: "\u4F8B\u5982: NEX-" })] }), e.jsxs("div", { className: "grid grid-cols-4 items-center gap-4", children: [e.jsx(h, { htmlFor: "count", className: "text-right", children: "\u6570\u91CF" }), e.jsxs("div", { className: "col-span-3 flex items-center gap-2", children: [e.jsx(f, { id: "count", type: "number", min: "1", max: "50", value: r.count, onChange: (j) => p({ ...r, count: Number(j.target.value) }) }), e.jsx("span", { className: "text-xs text-muted-foreground whitespace-nowrap", children: "\u6700\u591A 50 \u4E2A" })] })] }), e.jsx(z, { data: r, setData: p })] }), e.jsx(ee, { children: e.jsxs(w, { type: "submit", disabled: a, children: [a && e.jsx(L, { className: "mr-2 h-4 w-4 animate-spin" }), c === "single" ? "\u521B\u5EFA" : "\u6279\u91CF\u751F\u6210"] }) })] })] })] }) });
}
