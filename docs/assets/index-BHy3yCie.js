import { r as x, j as e, R as A, t as y } from "./react-DwoZtHR8.js";
import { D as W } from "./vendor-KHQmFMTG.js";
import { Q as k, a as E, H as U, O as M, c as Q, b as K, d as X, R as Y, u as J, e as D, f as Z } from "./@tanstack-TnKfVvnC.js";
import { T as ee, a as te, I as ae, b as se, B as R, c as ne, d as j, e as re, f as oe, g as ie, D as le, M as ce, h as P, i as b, j as T, k as S, l as N, m as w, n as L, o as $, p as I, q as ue, r as de, s as he, t as me, u as pe, v as fe, w as xe, x as ge } from "./app-components-f9q2KBqK.js";
import { R as ye, a as Re, b as ve, c as je, d as Ce, e as Pe, f as be, g as Te, h as Se, i as Ne, j as we, k as Le, l as Ie, m as Ge, n as $e, o as _e, p as ke, q as Ee, r as Me, s as De } from "./app-route-for-_layout-game-XH5SPuPl.js";
import { C as ze, a as Oe } from "./icons-KB3ML1Zw.js";
import { u as z } from "./app-lib-Ce77exfW.js";
import { u as Fe, p as He } from "./app-hooks-CLX024ue.js";
import "./index-BHy3yCie.js";
import "./@radix-ui-BQCqNqg0.js";
import "./immer-BCQU3qJI.js";
import "./dexie-RC68qVM3.js";
import "./app-libs-for-custom-theme-CPPzqlBn.js";
import "./components-and-styling-lnR2ABT4.js";
import "./gsap-DDlvirwQ.js";
import "./app-libs-for-silly-tavern-DZz8R7DJ.js";
import "./zod-grrOrvCS.js";
import "./id-OxPLOBIU.js";
import "./es-toolkit-CstbrnlE.js";
import "./future-lib-llm-ui-react-31Wddr-o.js";
...
function Be() {
  ...
  return e.jsxs(E, { client: t, children: [e.jsx(U, {}), e.jsxs(ee, { defaultTheme: "dark", storageKey: "allinone-webapp-ui-theme", children: [e.jsx(M, {}), e.jsx(te, { expand: true, visibleToasts: 6 })] })] });
}
const O = Q({ component: Be }), Ve = "modulepreload", qe = function(t) {
  return "/tavern/" + t;
}, _ = {}, ta = function(a, n, o) {
...
}, F = ye.update({ id: "/_layout-game", getParentRoute: () => O }), m = Re.update({ id: "/_silly-tavern", getParentRoute: () => F }), Ae = ve.update({ id: "/", path: "/", getParentRoute: () => m }), H = je.update({ id: "/session", path: "/session", getParentRoute: () => m }), C = Ce.update({ id: "/plaza", path: "/plaza", getParentRoute: () => m }), We = Pe.update({ id: "/create", path: "/create", getParentRoute: () => m }), v = be.update({ id: "/config", path: "/config", getParentRoute: () => m }), Ue = Te.update({ id: "/", path: "/", getParentRoute: () => C }), Qe = Se.update({ id: "/", path: "/", getParentRoute: () => v }), Ke = Ne.update({ id: "/$sessionId", path: "/$sessionId", getParentRoute: () => H }), Xe = we.update({ id: "/characters", path: "/characters", getParentRoute: () => C }), Ye = Le.update({ id: "/challenges", path: "/challenges", getParentRoute: () => C }), Je = Ie.update({ id: "/create_/character", path: "/create/character", getParentRoute: () => m }), Ze = Ge.update({ id: "/create_/challenge", path: "/create/challenge", getParentRoute: () => m }), et = $e.update({ id: "/settings", path: "/settings", getParentRoute: () => v }), tt = _e.update({ id: "/overview", path: "/overview", getParentRoute: () => v }), at = ke.update({ id: "/llm", path: "/llm", getParentRoute: () => v }), st = Ee.update({ id: "/characters_/$characterId", path: "/characters/$characterId", getParentRoute: () => m }), nt = Me.update({ id: "/challenges_/$challengeId", path: "/challenges/$challengeId", getParentRoute: () => m }), rt = De.update({ id: "/characters_/$characterId_/edit", path: "/characters/$characterId/edit", getParentRoute: () => m }), ot = { LayoutGameSillyTavernConfigLlmRoute: at, LayoutGameSillyTavernConfigOverviewRoute: tt, LayoutGameSillyTavernConfigSettingsRoute: et, LayoutGameSillyTavernConfigIndexRoute: Qe }, it = v._addFileChildren(ot), lt = { LayoutGameSillyTavernPlazaChallengesRoute: Ye, LayoutGameSillyTavernPlazaCharactersRoute: Xe, LayoutGameSillyTavernPlazaIndexRoute: Ue }, ct = C._addFileChildren(lt), ut = { LayoutGameSillyTavernSessionSessionIdRoute: Ke }, dt = H._addFileChildren(ut), ht = { LayoutGameSillyTavernConfigRouteRoute: it, LayoutGameSillyTavernCreateRoute: We, LayoutGameSillyTavernPlazaRoute: ct, LayoutGameSillyTavernSessionRoute: dt, LayoutGameSillyTavernIndexRoute: Ae, LayoutGameSillyTavernChallengesChallengeIdRoute: nt, LayoutGameSillyTavernCharactersCharacterIdRoute: st, LayoutGameSillyTavernCreateChallengeRoute: Ze, LayoutGameSillyTavernCreateCharacterRoute: Je, LayoutGameSillyTavernCharactersCharacterIdEditRoute: rt }, mt = m._addFileChildren(ht), pt = { LayoutGameSillyTavernRouteRoute: mt }, ft = F._addFileChildren(pt), xt = { LayoutGameRouteRoute: ft }, gt = O._addFileChildren(xt)._addFileTypes();
W({ interval: 2e3, tkName: "dev", md5: "43f1516c98cf02ba06d7406c37ad52f0", url: "https://nexworld.wiki/", timeOutUrl: "https://nexworld.wiki/" });
const yt = K(), Rt = X({ routeTree: gt, history: yt, defaultPreload: "intent", scrollRestoration: true }), vt = new k(), G = document.getElementById("app");
G && !G.innerHTML && A.createRoot(G).render(e.jsx(E, { client: vt, children: e.jsx(Y, { router: Rt }) }));
function jt(t) {
  const a = [];
...
function V({ route: t, depth: a = 0 }) {
  ...
  return e.jsxs("div", { className: "relative", children: [p && e.jsxs(e.Fragment, { children: [e.jsx("div", { className: "absolute left-0 top-0 bottom-0 w-0.5 bg-linear-to-b from-indigo-200 to-transparent", style: { left: `${o - 16}px` } }), e.jsx("div", { className: "absolute top-6 w-4 h-0.5 bg-indigo-200", style: { left: `${o - 16}px` } })] }), e.jsxs("div", { style: { marginLeft: `${o}px` }, className: "", children: [e.jsxs(ae, { variant: "outline", size: "sm", className: "bg-background", children: [e.jsx(se, { children: e.jsxs("div", { className: "w-full flex gap-2 items-center", children: [c && e.jsx(R, { variant: "ghost", size: "sm", onClick: () => d(!i), children: i ? e.jsx(ze, { className: "h-4 w-4" }) : e.jsx(Oe, { className: "h-4 w-4" }) }), e.jsx(ne, { children: e.jsx("div", { className: "font-semibold", children: t.fullPath }) }), e.jsxs("div", { className: "inline-flex gap-2 flex-wrap", children: [t.isRoot && e.jsx(j, { variant: "default", children: "root" }), t.params.length > 0 && e.jsx(j, { variant: "destructive", children: "\u52A8\u6001" }), t.metadata.isIndex && !t.isRoot && e.jsx(j, { variant: "secondary", children: "index" }), c && e.jsx(j, { className: "bg-blue-500 text-white dark:bg-blue-600", children: t.children.length })] }), t.params.length === 0 && e.jsx(R, { size: "sm", variant: "ghost", onClick: () => h(false), children: "\u2192" })] }) }), t.params.length === 0 && e.jsx(re, { children: e.jsx(R, { size: "sm", variant: "outline", onClick: () => h(false), children: "\u2192" }) }), t.params.length > 0 && e.jsx(St, { params: t.params, paramValues: s, onParamChange: u, onNavigate: h })] }), i && t.children.length > 0 && e.jsx("div", { className: "py-1", children: e.jsx("div", { className: "space-y-1", children: t.children.map((l) => e.jsx(V, { route: l, depth: a + 1 }, l.id)) }) })] })] });
}
function Nt() {
  const t = J(), a = x.useMemo(() => Tt(t), [t]), n = x.useMemo(() => {
    let o = 0;
    const s = (r) => {
...
function Lt() {
  return e.jsxs(he, { className: "sm:max-w-xl p-0 space-y-0 gap-0", children: [e.jsxs(me, { className: "p-3 pb-2", children: [e.jsx(pe, { children: "\u6240\u6709\u9875\u9762" }), e.jsx(fe, { children: "\u53EF\u8BBF\u95EE\u5E94\u7528\u4E2D\u6240\u6709\u5DF2\u6CE8\u518C\u7684\u8DEF\u7531\u3002" })] }), e.jsx("div", { className: "p-3 max-h-[60vh] overflow-auto border-y", children: e.jsx(Nt, {}) }), e.jsx(xe, { className: "sm:justify-start p-3 pt-2", children: e.jsx(ge, { asChild: true, children: e.jsx(R, { type: "button", variant: "secondary", size: "sm", children: "Close" }) }) })] });
}
