...
import { h as se, S as ae } from "./db-master-DD6OhUmP.js";
import { s as ne } from "./db-CxJzSoDx.js";
import { _ as G, __tla as __tla_0 } from "./index-CGPGHBpG.js";
import { C as re, A as oe } from "./AutoScrollDownArea-Ba3IDTZB.js";
import { S as ie } from "./session-manager.class-AUxlG8RK.js";
...
import { b as R, a as he } from "./analytics-CvRoWAme.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-DD6OhUmP.js").then((i)=>i.v);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-DD6OhUmP.js").then((o)=>o.w);
                return {
                    masterDb: n
                };
