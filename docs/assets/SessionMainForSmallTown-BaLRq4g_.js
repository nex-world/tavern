...
import { ak as H, a5 as Te, j as o, r as x, u as se } from "./react-CAuF6Uwp.js";
import { i as ve, n as be } from "./@tanstack-D67abzz0.js";
import { S as je, j as ke, h as Ne } from "./db-master-DKnNNmTP.js";
import { _ as J, __tla as __tla_0 } from "./index-C4wlxMXN.js";
import { n as G } from "./id-BY9c7rfI.js";
import { f as ne, M as ie, a as Ce, W as we, L as F, G as I, b as A, I as S, d as oe, R as ae, T as $e, e as Ie, g as W, D as Ae, h as K, S as Z, i as Ee, j as Me } from "./slider-Bs_1KIyO.js";
import { C as Pe, A as De } from "./AutoScrollDownArea-hJ97JLYP.js";
import { B as _ } from "./button-B6v19V-K.js";
import { ax as Re, aw as Le, n as Oe, aB as _e } from "./icons-Cmb87C8b.js";
import { C as re } from "./CharacterAvatar-yPJ36Fh6.js";
import { Q as V } from "./vendor-R_RbF-Qb.js";
import { u as Fe } from "./useLLM-CenwGE9_.js";
import { D as le, a as ce, b as de, c as ue, d as me, e as Be } from "./dialog-5F19wRbJ.js";
import { L as R } from "./label-aTtBzjKl.js";
import { S as q } from "./switch-BFRi9ePD.js";
import { I as z } from "./input-CEZpKHBj.js";
import { c as We } from "./shadcn-utils-Cnr6N47i.js";
import { l as Ye } from "./zod-D7Re9cnc.js";
    ...
    const f = H({
        ...
        async saveContextItemToDB (e, t) {
            const { SessionDB: s } = await J(async ()=>{
                const { SessionDB: l } = await import("./db-master-DKnNNmTP.js").then((r)=>r.v);
                return {
                    SessionDB: l
                };
            }, __vite__mapDeps([0,1,2,3,4,5,6,7,8])), n = new s(e), i = JSON.parse(JSON.stringify(t));
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: e } = await J(async ()=>{
                const { masterDb: s } = await import("./db-master-DKnNNmTP.js").then((n)=>n.w);
                return {
                    masterDb: s
                };
            }, __vite__mapDeps([0,1,2,3,4,5,6,7,8])), t = Te(this.currentSession.modeState);
...
返回 JSON:
{
  ...
  "wisdom": "一句感悟或智慧 (30字以内)"
    ...
    function qt() {
        const e = x.useRef(void 0), t = x.useRef(void 0), s = (n)=>{
            if (t.current !== void 0) {
                const i = (n - t.current) / 1e3, l = f.currentSession;
                if (l && l.modeState.isRunning) {
...
export { Es as SessionMainForSmallTown, __tla };
