import { g as qe } from "./react-BPCshYXX.js";
var at = { exports: {} }, lt = {};
var pn;
function Wr() {
...
var qr = Lr();
const Do = qe(qr), jr = ["top", "right", "bottom", "left"], be = Math.min, te = Math.max, Qe = Math.round, Je = Math.floor, ae = (t) => ({ x: t, y: t }), Hr = { left: "right", right: "left", bottom: "top", top: "bottom" }, Ur = { start: "end", end: "start" };
function jt(t, n, o) {
  return te(t, be(n, o));
}
function he(t, n) {
...
function Ht(t) {
  return t.replace(/start|end/g, (n) => Ur[n]);
}
const mn = ["left", "right"], wn = ["right", "left"], Yr = ["top", "bottom"], Kr = ["bottom", "top"];
function Xr(t, n, o) {
  switch (t) {
    case "top":
    case "bottom":
      return o ? n ? wn : mn : n ? mn : wn;
    case "left":
    case "right":
      return n ? Yr : Kr;
    default:
...
function Gr(t, n, o, e) {
  const r = _e(t);
  let i = Xr(pe(t), o === "start", e);
  return r && (i = i.map((a) => a + "-" + r), n && (i = i.concat(i.map(Ht)))), i;
}
function Ze(t) {
  return t.replace(/left|right|bottom|top/g, (n) => Hr[n]);
}
function Qr(t) {
  return { top: 0, right: 0, bottom: 0, left: 0, ...t };
}
function fr(t) {
  return typeof t != "number" ? Qr(t) : { top: t, right: t, bottom: t, left: t };
}
function $e(t) {
...
const $r = async (t, n, o) => {
  ...
  let u = await a.getElementRects({ reference: t, floating: n, strategy: r }), { x: l, y: f } = bn(u, e, c), d = e, h = {}, g = 0;
  for (let p = 0; p < s.length; p++) {
    var v;
    const { name: w, fn: b } = s[p], { x: y, y: F, data: P, reset: S } = await b({ x: l, y: f, initialPlacement: e, placement: d, strategy: r, middlewareData: h, rects: u, platform: { ...a, detectOverflow: (v = a.detectOverflow) != null ? v : Zr }, elements: { reference: t, floating: n } });
    l = y ?? l, f = F ?? f, h = { ...h, [w]: { ...h[w], ...P } }, S && g <= 50 && (g++, typeof S == "object" && (S.placement && (d = S.placement), S.rects && (u = S.rects === true ? await a.getElementRects({ reference: t, floating: n, strategy: r }) : S.rects), { x: l, y: f } = bn(u, d, c)), p = -1);
  }
  return { x: l, y: f, placement: d, strategy: r, middlewareData: h };
}, ei = (t) => ({ name: "arrow", options: t, async fn(n) {
  const { x: o, y: e, placement: r, rects: i, platform: a, elements: s, middlewareData: c } = n, { element: u, padding: l = 0 } = he(t, n) || {};
  if (u == null) return {};
  const f = fr(l), d = { x: o, y: e }, h = Kt(r), g = Yt(h), v = await a.getDimensions(u), p = h === "y", w = p ? "top" : "left", b = p ? "bottom" : "right", y = p ? "clientHeight" : "clientWidth", F = i.reference[g] + i.reference[h] - d[h] - i.floating[g], P = d[h] - i.reference[h], S = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(u));
  let T = S ? S[y] : 0;
  ...
  return t === void 0 && (t = {}), { name: "flip", options: t, async fn(n) {
    ...
    const w = pe(r), b = se(s), y = pe(s) === s, F = await (c.isRTL == null ? void 0 : c.isRTL(u.floating)), P = d || (y || !v ? [Ze(s)] : Vr(s)), S = g !== "none";
    !d && S && P.push(...Gr(s, v, g, F));
  ...
  return t === void 0 && (t = {}), { name: "hide", options: t, async fn(n) {
    ...
    switch (r) {
      case "referenceHidden": {
        const a = await e.detectOverflow(n, { ...i, elementContext: "reference" }), s = yn(a, o.reference);
        return { data: { referenceHiddenOffsets: s, referenceHidden: An(s) } };
      }
      case "escaped": {
        const a = await e.detectOverflow(n, { ...i, altBoundary: true }), s = yn(a, o.floating);
        return { data: { escapedOffsets: s, escaped: An(s) } };
      }
      default:
        return {};
    }
...
async function ri(t, n) {
  const { placement: o, platform: e, elements: r } = t, i = await (e.isRTL == null ? void 0 : e.isRTL(r.floating)), a = pe(o), s = _e(o), c = se(o) === "y", u = cr.has(a) ? -1 : 1, l = i && c ? -1 : 1, f = he(n, t);
...
const ii = function(t) {
  return t === void 0 && (t = 0), { name: "offset", options: t, async fn(n) {
    var o, e;
    const { x: r, y: i, placement: a, middlewareData: s } = n, c = await ri(n, t);
  ...
  return t === void 0 && (t = {}), { options: t, fn(n) {
    ...
    if (u) {
      var w, b;
      const y = d === "y" ? "width" : "height", F = cr.has(pe(r)), P = i.reference[f] - i.floating[y] + (F && ((w = a.offset) == null ? void 0 : w[f]) || 0) + (F ? 0 : p.crossAxis), S = i.reference[f] + i.reference[y] + (F ? 0 : ((b = a.offset) == null ? void 0 : b[f]) || 0) - (F ? p.crossAxis : 0);
      g < P ? g = P : g > S && (g = S);
    }
    return { [d]: h, [f]: g };
  } };
...
function ue(t) {
  var n;
  return (n = (dr(t) ? t.ownerDocument : t.document) || window.document) == null ? void 0 : n.documentElement;
}
function dr(t) {
...
function je(t) {
  ...
  return /auto|scroll|overlay|hidden|clip/.test(n + e + o) && !li.has(r);
}
const ui = /* @__PURE__ */ new Set(["table", "td", "th"]);
function fi(t) {
  return ui.has(Te(t));
}
const ci = [":popover-open", ":modal"];
function nt(t) {
  return ci.some((n) => {
    try {
      return t.matches(n);
...
const di = ["transform", "translate", "scale", "rotate", "perspective"], hi = ["transform", "translate", "scale", "rotate", "perspective", "filter"], pi = ["paint", "layout", "strict", "content"];
function Xt(t) {
  const n = Gt(), o = ie(t) ? oe(t) : t;
  return di.some((e) => o[e] ? o[e] !== "none" : false) || (o.containerType ? o.containerType !== "normal" : false) || !n && (o.backdropFilter ? o.backdropFilter !== "none" : false) || !n && (o.filter ? o.filter !== "none" : false) || hi.some((e) => (o.willChange || "").includes(e)) || pi.some((e) => (o.contain || "").includes(e));
}
function gi(t) {
  let n = ye(t);
  for (; le(n) && !Re(n); ) {
...
const vi = /* @__PURE__ */ new Set(["html", "body", "#document"]);
function Re(t) {
  return vi.has(Te(t));
}
function oe(t) {
...
function ye(t) {
  ...
  const n = t.assignedSlot || t.parentNode || Cn(t) && t.host || ue(t);
  return Cn(n) ? n.host : n;
}
function hr(t) {
  const n = ye(t);
  return Re(n) ? t.ownerDocument ? t.ownerDocument.body : t.body : le(n) && je(n) ? n : hr(n);
}
function Le(t, n, o) {
  var e;
  n === void 0 && (n = []), o === void 0 && (o = true);
  const r = hr(t), i = r === ((e = t.ownerDocument) == null ? void 0 : e.body), a = ne(r);
  if (i) {
    const s = Ut(a);
...
function Ee(t) {
  const n = Qt(t);
  if (!le(n)) return ae(1);
  const o = n.getBoundingClientRect(), { width: e, height: r, $: i } = pr(n);
...
function gr(t) {
  const n = ne(t);
  return !Gt() || !n.visualViewport ? mi : { x: n.visualViewport.offsetLeft, y: n.visualViewport.offsetTop };
}
function wi(t, n, o) {
...
function On(t, n, o) {
  let e;
  if (n === "viewport") e = Ci(t, o);
  else if (n === "document") e = Ai(ue(t));
  else if (ie(n)) e = Oi(n, o);
  else {
    const r = gr(t);
...
function mr(t, n) {
  const o = ye(t);
  return o === n || !ie(o) || Re(o) ? false : oe(o).position === "fixed" || mr(o, n);
}
function ki(t, n) {
  const o = n.get(t);
  if (o) return o;
  ...
  for (; ie(a) && !Re(a); ) {
    const s = oe(a), c = Xt(a);
    !c && s.position === "fixed" && (r = null), (i ? !c && !r : !c && s.position === "static" && !!r && Fi.has(r.position) || je(a) && !c && mr(t, a)) ? e = e.filter((l) => l !== a) : r = s, a = ye(a);
  }
  return n.set(t, e), e;
}
function xi(t) {
  let { element: n, boundary: o, rootBoundary: e, strategy: r } = t;
  const a = [...o === "clippingAncestors" ? nt(n) ? [] : ki(n, this._c) : [].concat(o), e], s = a[0], c = a.reduce((u, l) => {
    const f = On(n, l, r);
...
function Pi(t, n, o) {
  ...
  i && !e && r && u();
  const l = r && !e && !i ? vr(r, s) : ae(0), f = a.left + s.scrollLeft - c.x - l.x, d = a.top + s.scrollTop - c.y - l.y;
...
function wr(t, n) {
  ...
  if (!le(t)) {
    let r = ye(t);
    for (; r && !Re(r); ) {
      if (ie(r) && !ut(r)) return r;
      r = ye(r);
    }
    return o;
  }
  let e = kn(t, n);
  for (; e && fi(e) && ut(e); ) e = kn(e, n);
  return e && Re(e) && ut(e) && !Xt(e) ? o : e || gi(t) || o;
}
const Si = async function(t) {
  const n = this.getOffsetParent || wr, o = this.getDimensions, e = await o(t.floating);
  return { reference: Pi(t.reference, await n(t.floating), t.strategy), floating: { x: 0, y: 0, width: e.width, height: e.height } };
};
function Mi(t) {
  return oe(t).direction === "rtl";
}
const Ei = { convertOffsetParentRelativeRectToViewportRelativeRect: bi, getDocumentElement: ue, getClippingRect: xi, getOffsetParent: wr, getElementRects: Si, getClientRects: yi, getDimensions: Di, getScale: Ee, isElement: ie, isRTL: Mi };
function br(t, n) {
...
function Ri(t, n) {
  ...
  function a(s, c) {
    ...
    if (s || n(), !d || !h) return;
    const g = Je(f), v = Je(r.clientWidth - (l + d)), p = Je(r.clientHeight - (f + h)), w = Je(l), y = { rootMargin: -g + "px " + -v + "px " + -p + "px " + -w + "px", threshold: te(0, be(1, c)) || 1 };
    let F = true;
    function P(S) {
      ...
      T === 1 && !br(u, t.getBoundingClientRect()) && a(), F = false;
    }
    try {
...
function Po(t, n, o, e) {
  ...
  function p() {
    const w = Fe(t);
    v && !br(v, w) && o(), v = w, g = requestAnimationFrame(p);
  }
  return o(), () => {
    var w;
    l.forEach((b) => {
...
const So = ii, Mo = oi, Eo = ti, Ro = ai, _o = ni, To = ei, No = si, Wo = (t, n, o) => {
  const e = /* @__PURE__ */ new Map(), r = { platform: Ei, ...o }, i = { ...r.platform, _c: e };
...
var _i = function(t) {
...
}, Se = /* @__PURE__ */ new WeakMap(), ze = /* @__PURE__ */ new WeakMap(), Ve = {}, ft = 0, yr = function(t) {
  return t && (t.host || yr(t.parentNode));
}, Ti = function(t, n) {
  ...
  var r = Ti(n, Array.isArray(t) ? t : [t]);
  Ve[o] || (Ve[o] = /* @__PURE__ */ new WeakMap());
  var i = Ve[o], a = [], s = /* @__PURE__ */ new Set(), c = new Set(r), u = function(f) {
  ...
  var l = function(f) {
    !f || c.has(f) || Array.prototype.forEach.call(f.children, function(d) {
      if (s.has(d)) l(d);
        ...
        Se.set(d, v), i.set(d, p), a.push(d), v === 1 && g && ze.set(d, true), p === 1 && d.setAttribute(o, "true"), g || d.setAttribute(e, "true");
      } catch (w) {
        console.error("aria-hidden: cannot operate on ", d, w);
      }
    });
  };
  return l(n), s.clear(), ft++, function() {
    a.forEach(function(f) {
      var d = Se.get(f) - 1, h = i.get(f) - 1;
      Se.set(f, d), i.set(f, h), d || (ze.has(f) || f.removeAttribute(e), ze.delete(f)), h || f.removeAttribute(o);
    }), ft--, ft || (Se = /* @__PURE__ */ new WeakMap(), Se = /* @__PURE__ */ new WeakMap(), ze = /* @__PURE__ */ new WeakMap(), Ve = {});
  };
}, Io = function(t, n, o) {
  o === void 0 && (o = "data-aria-hidden");
  var e = Array.from(Array.isArray(t) ? t : [t]), r = _i(t);
  return r ? (e.push.apply(e, Array.from(r.querySelectorAll("[aria-live], script"))), Ni(e, r, o, "aria-hidden")) : function() {
    return null;
  };
}, xn = function() {
