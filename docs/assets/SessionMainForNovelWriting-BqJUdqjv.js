...
import { h as ct, m as Ce, S as lt } from "./db-master-DD6OhUmP.js";
import { k as ie, m as ce, j as dt } from "./@tanstack-DHpjEvx5.js";
import { _ as mt, __tla as __tla_0 } from "./index-CGPGHBpG.js";
import { C as pt, A as ut } from "./AutoScrollDownArea-Ba3IDTZB.js";
import { S as ht } from "./session-manager.class-AUxlG8RK.js";
        ...
        async updateSessionInDB () {
            if (o.currentSession) try {
                const { masterDb: t } = await mt(async ()=>{
                    const { masterDb: r } = await import("./db-master-DD6OhUmP.js").then((a)=>a.w);
                    return {
                        masterDb: r
                    };
