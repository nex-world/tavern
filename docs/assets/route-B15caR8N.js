import { r as l, j as e } from "./react-gFHNOnf5.js";
import { O as t, L as r } from "./@tanstack-DDpiKjUN.js";
import { B as a } from "./button-D3G-RLOw.js";
import { S as i, a as c, b as m } from "./sheet-CbrpXbKg.js";
import { M as d } from "./icons-CW-0NDo_.js";
...
function C() {
  ...
  return e.jsxs("div", { className: "flex h-full", children: [e.jsx("nav", { className: "hidden md:block w-64 p-4 bg-foreground/5 overflow-y-auto", children: s }), e.jsxs(i, { open: n, onOpenChange: o, children: [e.jsx(c, { asChild: true, children: e.jsx(a, { variant: "outline", size: "icon", className: "md:hidden fixed bottom-24 right-6 rounded-full shadow-lg z-50 h-12 w-12", children: e.jsx(d, { className: "h-4 w-4" }) }) }), e.jsx(m, { side: "left", className: "w-64 p-4 overflow-y-auto", children: s })] }), e.jsx("main", { className: "flex-1 p-4 lg:px-8 xl:px-12 overflow-auto", children: e.jsx(t, {}) })] });
}
export {
  C as component
};
