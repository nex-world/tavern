...
import { h as se, S as ae } from "./db-master-DiZIyMfK.js";
import { s as ne } from "./db-seQgP_Jc.js";
import { _ as G, __tla as __tla_0 } from "./index-CF4MAqFH.js";
import { C as re, A as oe } from "./AutoScrollDownArea-DZN1gH-S.js";
import { S as ie } from "./session-manager.class-CMli7K9_.js";
...
import { b as R, a as he } from "./analytics-CNfxmEQT.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-DiZIyMfK.js").then((i)=>i.v);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-DiZIyMfK.js").then((o)=>o.w);
                return {
                    masterDb: n
                };
