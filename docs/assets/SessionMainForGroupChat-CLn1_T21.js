...
import { h as se, S as ae } from "./db-master-BD5cuqGE.js";
import { s as ne } from "./db-CJsO4wQm.js";
import { _ as G, __tla as __tla_0 } from "./index-CUosL2Px.js";
import { C as re, A as oe } from "./AutoScrollDownArea-DjEl-AZw.js";
import { S as ie } from "./session-manager.class-DXIUTdQf.js";
...
import { b as R, a as he } from "./analytics-CgY6CsYJ.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-BD5cuqGE.js").then((i)=>i.v);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-BD5cuqGE.js").then((o)=>o.w);
                return {
                    masterDb: n
                };
