...
import { D as T, F as $, aH as Z, r as C, t as R, E as ee, j as e } from "./react-D9TtqY-V.js";
import { f as F, i as te } from "./@tanstack-3iyDWv8L.js";
import { r as se, S as ae } from "./db-master-BrZHBPj2.js";
import { s as ne } from "./db--eUIPBg3.js";
import { _ as U, __tla as __tla_0 } from "./index-Cxjv2Jza.js";
import { C as re } from "./context-manager.class-B2xis078.js";
import { S as oe } from "./session-manager.class-DPAZ4frV.js";
import { B as j } from "./button-CMoAlsw3.js";
import { T as ie } from "./textarea-NuAUq_bK.js";
import { B as y } from "./badge-B6qKYUZD.js";
import { n as _ } from "./id-OxPLOBIU.js";
import { u as ce, a as de } from "./global-llm-config.store-C91qlFOh.js";
...
import { C as V } from "./CharacterAvatar-Cnp2urxB.js";
import { ai as pe, n as G, t as xe, ap as he, W as ge, a8 as B, c as fe } from "./icons-d5PdVRlQ.js";
  ...
  const w = T({
    ...
    async saveNewContextItemsToDB(s, t) {
      const { SessionDB: a } = await U(async () => {
        const { SessionDB: m } = await import("./db-master-BrZHBPj2.js").then((g) => g.s);
        return {
          SessionDB: m
        };
    ...
    async updateSessionInDB() {
      ...
      const { masterDb: s } = await U(async () => {
        const { masterDb: n } = await import("./db-master-BrZHBPj2.js").then((o) => o.t);
        return {
          masterDb: n
        };
...
`);
    ...
    const s = ce((l) => l.config), t = C.useRef(false), a = F(), n = C.useCallback(async (l, r, c, u = {}) => {
      ...
      try {
        for (; ; ) {
          ...
          const v = Ie(c, x);
          await n(l, v, "gc_character_message", {
  ...
  tt = (s) => {
    ...
    const p = ((_b = (_a = i.currentSession) == null ? void 0 : _a.modeState) == null ? void 0 : _b.currentUIState) || "idle", v = O[p] || O.idle, S = (_e2 = (_d = (_c = i.currentSession) == null ? void 0 : _c.modeConfig) == null ? void 0 : _d.participantSnapshots) == null ? void 0 : _e2.find((d) => {
      var _a2, _b2;
      ...
      to: "/plaza"
    }), Y = (_g = (_f = i.contextManager) == null ? void 0 : _f.state.processingItem) == null ? void 0 : _g.id;
    return e.jsxs("div", {
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsx("span", {
                          ...
                          children: S && p === "ai_loop_running" ? `${S.name} \u6B63\u5728\u8F93\u5165...` : v.label
                        })
                      ]
                    })
                  ]
            ...
            e.jsx("div", {
              ...
              children: e.jsx("div", {
                ...
                children: (() => {
                  ...
                  const d = (((_a2 = i.contextManager) == null ? void 0 : _a2.state.historyItems) || []).filter((b) => !b.hidden), I = (_b2 = i.contextManager) == null ? void 0 : _b2.state.processingItem;
                  if (p === "idle") {
                  ...
                  return I && !I.hidden && !d.some((b) => b.id === I.id) && k.push(I), k.map((b, D) => {
                    var _a3, _b3, _c3, _d3;
                    return e.jsx(Me, {
                      item: b,
              ...
              children: [
                ...
                e.jsx("div", {
                  ...
                  children: (_u = (_t = (_s = i.currentSession) == null ? void 0 : _s.modeConfig) == null ? void 0 : _t.participantSnapshots) == null ? void 0 : _u.map((d) => {
                    ...
                    const I = d.id === ((_b2 = (_a2 = i.currentSession) == null ? void 0 : _a2.modeState) == null ? void 0 : _b2.currentSpeakerId) && p === "ai_loop_running", k = ((_e3 = (_d2 = (_c2 = i.currentSession) == null ? void 0 : _c2.modeState) == null ? void 0 : _d2.speakCounts) == null ? void 0 : _e3[d.id]) || 0;
                    return e.jsx("div", {
