const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/db-master-VtknO8mG.js","assets/@tanstack-Bc2-Ej4a.js","assets/react-djKJ3iBo.js","assets/vendor-B5WA8jn2.js","assets/formatting--AnFUVTy.js","assets/@radix-ui-BQCqNqg0.js","assets/immer-BCQU3qJI.js","assets/dexie-BrH4iHrF.js","assets/zod-BTj0C3yc.js","assets/analytics-ZtTVKL1H.js","assets/nex-tavern-uuid-lTfx0jwM.js","assets/index-B0z0gi2T.js","assets/icons-q2kNJThM.js","assets/index-DvZEohGi.css","assets/id-BY9c7rfI.js","assets/PlayerInputItem-mDCVdi-3.js","assets/CharacterAvatar-Bwr0FQyu.js","assets/shadcn-utils-Cnr6N47i.js","assets/components-and-styling-lnR2ABT4.js","assets/@tailwind-CPcsbTWB.js"])))=>i.map(i=>d[i]);
import { y as N, r as d, t as _, j as t } from "./react-djKJ3iBo.js";
import { S as B, C as R, k as L } from "./db-master-VtknO8mG.js";
import { f as F, j as k } from "./@tanstack-Bc2-Ej4a.js";
import { s as z } from "./db-DhVDeork.js";
import { _ as b, __tla as __tla_0 } from "./index-B0z0gi2T.js";
import { n as M } from "./id-BY9c7rfI.js";
import { C as v, A as H } from "./AutoScrollDownArea-Cp4EfHjS.js";
import { m as O, P as D, C as P, a as V } from "./PlayerInputItem-mDCVdi-3.js";
import { B as U } from "./button-wZFYkzV6.js";
import { T as $ } from "./textarea-B7nHRwfm.js";
import { B as T } from "./badge-D22VkVbS.js";
import { C as E } from "./CharacterAvatar-Bwr0FQyu.js";
import { u as K } from "./useLLM-D5qSJJPS.js";
import { a as Y } from "./analytics-ZtTVKL1H.js";
import { e as Q } from "./icons-q2kNJThM.js";
...
let __tla = Promise.all([
    ...
    const m = N({
        ...
        async saveNewContextItemsToDB (e, a) {
            const { SessionDB: o } = await b(async ()=>{
                const { SessionDB: u } = await import("./db-master-VtknO8mG.js").then((w)=>w.z);
                return {
                    SessionDB: u
                };
        ...
        const o = K(), i = d.useRef(!1), u = F(), w = d.useCallback(async (p)=>{
            if (!(i.current || !a || a.getHistoryCount() > 0 || !e)) try {
                ...
                const { makeChatModeStartingContextItems_CN: x } = await b(async ()=>{
                    const { makeChatModeStartingContextItems_CN: r } = await import("./PlayerInputItem-mDCVdi-3.js").then((n)=>n.c);
                    return {
            ...
            if (!(i.current || !e || !a)) try {
                ...
                const { makeChatModeLLMMessagesFromContextStateForCharacterId: g } = await b(async ()=>{
                    const { makeChatModeLLMMessagesFromContextStateForCharacterId: l } = await import("./PlayerInputItem-mDCVdi-3.js").then((C)=>C.c);
                    return {
    ...
    let G, J;
    je = (e)=>{
        const [a, o] = d.useState(""), [i, u] = d.useState(!1), [w, y] = d.useState(""), [p, x] = d.useState(!1), { data: g = [] } = k((s)=>s.from({
                s: B
            })), { data: S = [] } = k((s)=>s.from({
                c: R
    ...
    G = (e)=>{
        switch(e.item.type){
            ...
            case "participant_message_group":
                return t.jsx("div", {
                    className: "space-y-4",
                    children: (e.item.data.list || []).map((a, o)=>t.jsx(D, {
                            item: {
                                ...e.item,
