...
import { h as se, S as ae } from "./db-master-D0ahR8Qm.js";
import { s as ne } from "./db-a5TFd8lR.js";
import { _ as G, __tla as __tla_0 } from "./index-rrWAXvvv.js";
import { C as re, A as oe } from "./AutoScrollDownArea-BTDHzY0Y.js";
import { S as ie } from "./session-manager.class-BfmlsvKQ.js";
...
import { b as R, a as he } from "./analytics-D0sC1eqJ.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-D0ahR8Qm.js").then((i)=>i.v);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-D0ahR8Qm.js").then((o)=>o.w);
                return {
                    masterDb: n
                };
