...
import { j as Ne, S as De, m as je } from "./db-master-eAmex8rT.js";
import { s as Ie } from "./db-g5sbJCRD.js";
import { _ as ee, __tla as __tla_0 } from "./index-DNgj8bwD.js";
import { C as we, A as Me } from "./AutoScrollDownArea-cUzgyL9F.js";
import { n as $ } from "./id-BY9c7rfI.js";
import { S as ve } from "./session-manager.class-jV90p7NY.js";
...
import { b as He, a as Fe } from "./analytics-BTxGqTJY.js";
    ...
    const m = Q({
        ...
        async saveNewContextItemsToDB (a, t) {
            const { SessionDB: e } = await ee(async ()=>{
                const { SessionDB: o } = await import("./db-master-eAmex8rT.js").then((i)=>i.z);
                return {
                    SessionDB: o
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: a } = await ee(async ()=>{
                const { masterDb: s } = await import("./db-master-eAmex8rT.js").then((r)=>r.A);
                return {
                    masterDb: s
                };
