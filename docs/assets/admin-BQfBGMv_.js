import { j as e, r as i, u } from "./react-gFHNOnf5.js";
import { B as w } from "./button-D3G-RLOw.js";
import { I as f } from "./input-KwncZLGm.js";
import { L as h } from "./label-BU_LC6Ti.js";
import { C as H, a as V, b as K, c as J, d as G } from "./card-B4CxGEM-.js";
import { c as C } from "./shadcn-utils-BMZD7_jZ.js";
import { B as k } from "./badge-C9CmQsZA.js";
import { D as Y, a as Q, b as W, c as Z, d as q, e as ee } from "./dialog-CPE3M3ew.js";
import { S as se, a as ae, b as te, c as re, d as S } from "./select-BkM7Xz_F.js";
import { T as le, a as ne, b as U, c as R } from "./tabs-DYyOSGrZ.js";
import { C as M } from "./checkbox-DcACMCG8.js";
import { u as ce, p as ie, P as oe, R as L, U as de, j as me } from "./icons-CW-0NDo_.js";
...
function je({ onLogin: s, defaultApiUrl: t }) {
  ...
  return e.jsx("div", { className: "h-full flex items-center justify-center bg-muted/20 p-4", children: e.jsxs(H, { className: "w-full max-w-md", children: [e.jsxs(V, { className: "space-y-1", children: [e.jsxs(K, { className: "text-2xl font-bold flex items-center gap-2", children: [e.jsx(ie, { className: "w-6 h-6 text-primary" }), "\u7BA1\u7406\u5458\u767B\u5F55"] }), e.jsx(J, { children: "\u8BF7\u8F93\u5165\u7BA1\u7406\u5458\u51ED\u8BC1\u4EE5\u8BBF\u95EE\u63A7\u5236\u53F0" })] }), e.jsx(G, { children: e.jsxs("form", { onSubmit: g, className: "space-y-4", children: [e.jsxs("div", { className: "space-y-2", children: [e.jsx(h, { htmlFor: "url", children: "API \u5730\u5740" }), e.jsx(f, { id: "url", placeholder: "https://auth.example.workers.dev", value: o, onChange: (a) => l(a.target.value) })] }), e.jsxs("div", { className: "space-y-2", children: [e.jsx(h, { htmlFor: "username", children: "\u7528\u6237\u540D" }), e.jsx(f, { id: "username", value: x, onChange: (a) => c(a.target.value) })] }), e.jsxs("div", { className: "space-y-2", children: [e.jsx(h, { htmlFor: "password", children: "\u5BC6\u7801" }), e.jsx(f, { id: "password", type: "password", value: d, onChange: (a) => n(a.target.value) })] }), e.jsx(w, { type: "submit", className: "w-full", disabled: j, children: j ? "\u767B\u5F55\u4E2D..." : "\u767B\u5F55" })] }) })] }) });
}
function pe({ apiUrl: s, token: t, onLogout: o }) {
  const [l, x] = i.useState([]), [c, d] = i.useState(true), [n, j] = i.useState(false), r = async () => {
    d(true);
    try {
  ...
  }) })] }) })] }), e.jsx(ge, { open: n, onOpenChange: j, apiUrl: s, token: t, onSuccess: r })] });
}
function ge({ open: s, onOpenChange: t, apiUrl: o, token: l, onSuccess: x }) {
  const [c, d] = i.useState("single"), [n, j] = i.useState({ code: "", memo: "", max_usages: 3, days_valid: "0", features: [] }), [r, g] = i.useState({ prefix: "NEX-", count: 10, memo: "", max_usages: 3, days_valid: "0", features: [] }), [a, m] = i.useState(false), N = () => {
    const p = "ABCDEFGHJKLMNPQRSTUVWXYZ23456789";
    let v = "NEX-";
    for (let b = 0; b < 8; b++) v += p.charAt(Math.floor(Math.random() * p.length));
    j((b) => ({ ...b, code: v }));
  }, T = async (p) => {
    p.preventDefault(), m(true);
    try {
      let v;
      ...
      b.ok ? (u.success(c === "single" ? "\u9080\u8BF7\u7801\u521B\u5EFA\u6210\u529F" : `\u6210\u529F\u521B\u5EFA ${F.message}`), t(false), x(), j({ code: "", memo: "", max_usages: 3, days_valid: "0", features: [] }), g({ prefix: "NEX-", count: 10, memo: "", max_usages: 3, days_valid: "0", features: [] })) : u.error(F.error || "\u521B\u5EFA\u5931\u8D25");
    } catch {
      u.error("\u7F51\u7EDC\u9519\u8BEF");
    } finally {
      m(false);
  ...
  return e.jsx(Y, { open: s, onOpenChange: t, children: e.jsxs(Q, { className: "sm:max-w-125", children: [e.jsxs(W, { children: [e.jsx(Z, { children: "\u521B\u5EFA\u9080\u8BF7\u7801" }), e.jsx(q, { children: "\u751F\u6210\u5355\u4E2A\u6216\u6279\u91CF\u751F\u6210\u9080\u8BF7\u7801\u3002" })] }), e.jsxs(le, { defaultValue: "single", value: c, onValueChange: d, children: [e.jsxs(ne, { className: "grid w-full grid-cols-2", children: [e.jsx(U, { value: "single", children: "\u5355\u4E2A\u521B\u5EFA" }), e.jsx(U, { value: "bulk", children: "\u6279\u91CF\u751F\u6210" })] }), e.jsxs("form", { onSubmit: T, className: "py-4 space-y-4", children: [e.jsxs(R, { value: "single", className: "space-y-4 mt-0", children: [e.jsxs("div", { className: "grid grid-cols-4 items-center gap-4", children: [e.jsx(h, { htmlFor: "code", className: "text-right", children: "\u9080\u8BF7\u7801" }), e.jsxs("div", { className: "col-span-3 flex gap-2", children: [e.jsx(f, { id: "code", value: n.code, onChange: (p) => j({ ...n, code: p.target.value }), placeholder: "\u4F8B\u5982: NEX-8888", required: c === "single" }), e.jsx(w, { type: "button", variant: "secondary", size: "icon", onClick: N, title: "\u968F\u673A\u751F\u6210", children: e.jsx(L, { className: "w-4 h-4" }) })] })] }), e.jsx(z, { data: n, setData: j })] }), e.jsxs(R, { value: "bulk", className: "space-y-4 mt-0", children: [e.jsxs("div", { className: "grid grid-cols-4 items-center gap-4", children: [e.jsx(h, { htmlFor: "prefix", className: "text-right", children: "\u524D\u7F00" }), e.jsx(f, { id: "prefix", value: r.prefix, onChange: (p) => g({ ...r, prefix: p.target.value }), className: "col-span-3", placeholder: "\u4F8B\u5982: NEX-" })] }), e.jsxs("div", { className: "grid grid-cols-4 items-center gap-4", children: [e.jsx(h, { htmlFor: "count", className: "text-right", children: "\u6570\u91CF" }), e.jsxs("div", { className: "col-span-3 flex items-center gap-2", children: [e.jsx(f, { id: "count", type: "number", min: "1", max: "50", value: r.count, onChange: (p) => g({ ...r, count: Number(p.target.value) }) }), e.jsx("span", { className: "text-xs text-muted-foreground whitespace-nowrap", children: "\u6700\u591A 50 \u4E2A" })] })] }), e.jsx(z, { data: r, setData: g })] }), e.jsx(ee, { children: e.jsxs(w, { type: "submit", disabled: a, children: [a && e.jsx(L, { className: "mr-2 h-4 w-4 animate-spin" }), c === "single" ? "\u521B\u5EFA" : "\u6279\u91CF\u751F\u6210"] }) })] })] })] }) });
}
