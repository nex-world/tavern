...
import { al as T, a6 as $, aI as Z, r as C, u as R, v as ee, j as e } from "./react-gFHNOnf5.js";
import { f as F, i as te } from "./@tanstack-DDpiKjUN.js";
import { r as se, S as ae } from "./db-master-DI3V0061.js";
import { s as ne } from "./db-BmpCv5B4.js";
import { _ as U, __tla as __tla_0 } from "./index-7c6pKJ8J.js";
import { C as re } from "./context-manager.class-BTc8g_cx.js";
import { S as oe } from "./session-manager.class-z-y1oVSb.js";
import { B as j } from "./button-D3G-RLOw.js";
import { T as ie } from "./textarea-DqdRyzs9.js";
import { B as y } from "./badge-C9CmQsZA.js";
import { n as _ } from "./id-OxPLOBIU.js";
import { u as ce, a as de } from "./global-llm-config.store-BYX0tcdb.js";
import { _ as J, o as L, s as f, n as A, a as le, r as ue, l as me } from "./zod-DPWJ_A9_.js";
import { c as P } from "./shadcn-utils-BMZD7_jZ.js";
import { C as V } from "./CharacterAvatar-TKrkqhhW.js";
import { an as pe, x as G, Q as xe, au as he, a8 as ge, f as B, u as fe } from "./icons-CW-0NDo_.js";
  ...
  const w = T({
    ...
    async saveNewContextItemsToDB(s, t) {
      const { SessionDB: a } = await U(async () => {
        const { SessionDB: m } = await import("./db-master-DI3V0061.js").then((g) => g.s);
        return {
          SessionDB: m
        };
    ...
    async updateSessionInDB() {
      ...
      const { masterDb: s } = await U(async () => {
        const { masterDb: n } = await import("./db-master-DI3V0061.js").then((o) => o.t);
        return {
          masterDb: n
        };
...
`);
  ...
  z = ({ item: s, participants: t, isStreaming: a }) => {
    const n = s.data, o = t.find((i) => i.id === n.characterId), m = n.characterName || (o == null ? void 0 : o.name) || "\u89D2\u8272", g = a ? "..." : Q(s.timestamp);
    return e.jsxs("div", {
