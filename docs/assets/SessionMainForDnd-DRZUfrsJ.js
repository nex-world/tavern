...
import { s as Z, aw as V, aZ as xe, r as b, t as W, u as Ce, j as s } from "./react-Cp7JIDMn.js";
import { C as be, a as De, b as Ie, d as ke } from "./card--sAYb8Bf.js";
import { P as Me } from "./progress-T13oMyRS.js";
import { S as Ne, a as je, b as Pe, __tla as __tla_0 } from "./session._sessionId-BpsB7WAa.js";
import { A as we, a as $e, b as ve } from "./alert-l3_BzK2Q.js";
import { S as J } from "./spinner-fCA3hgE0.js";
import { C as Te, M as Y, b as se, c as re, a as oe } from "./conversation-message-BZgJiHtS.js";
import { I as Le, c as Re, b as Ae } from "./input-group-BLS_bbvz.js";
import { f as ie, m as Ue } from "./@tanstack-8dqqXYTU.js";
import { j as Ee, S as He } from "./db-master-DpInMzGh.js";
import { s as Fe } from "./db-C6a7nMI2.js";
import { _ as Q, __tla as __tla_1 } from "./index-Dvos9xYb.js";
import { C as Be } from "./context-manager.class-CetS2fXT.js";
import { n as v } from "./id-BY9c7rfI.js";
import { S as Oe } from "./session-manager.class-D6gTmGU7.js";
import { B as X } from "./button-p-Zf1khH.js";
import { B as A } from "./badge-8hWiZNtW.js";
import { u as Ge, g as ze, a as Je } from "./global-llm-config.store-CXBroG1M.js";
import { o as T, n as M, s as S, _ as K, c as ce, b as Xe, r as qe, l as Ke } from "./zod-BTj0C3yc.js";
import { S as Ve } from "./switch-B4Jbj6hs.js";
import { C as de } from "./CharacterAvatar-C7K0X6_t.js";
import { b as We, a as Ze } from "./analytics-DqIS_F3D.js";
import { ax as Ye, ay as Qe, p as et, s as tt, a0 as nt, af as le, k as at, f as st } from "./icons-Dc5fwOe3.js";
...
`);
    ...
    function ft(n, t) {
        const e = F(n), a = L(n), r = n.modeState.turnCounts, o = n.modeConfig.gameMode, i = `你是 DM (地下城主)。请为这个 DND 冒险创建引人入胜的开场介绍，设置世界背景和初始场景。
${H(o)}
${e.systemPrompt}
${e.globalKnowledge ? `
【世界观补充】
...
`);
    ...
    function yt(n, t) {
        const e = F(n), a = L(n), r = n.modeState.turnCounts, o = n.modeConfig.gameMode, i = n.modeState.historySummary, l = `你是 DM。请根据当前剧情进展描写场景，推进故事。
...
`);
    ...
    function St(n, t) {
        const e = L(n), a = n.modeState.turnCounts, r = n.modeConfig.gameMode, o = e.map((f)=>a[f.id] || 0), l = (o.length > 0 ? Math.min(...o) : 0) + 2, d = e.filter((f)=>(a[f.id] || 0) <= l).sort((f, m)=>(a[f.id] || 0) - (a[m.id] || 0)), y = `你是 DM。请根据刚才的叙事，从候选名单中指定【下一个】行动的角色。
${H(r)}
...
`);
    ...
    function Ct(n, t) {
        const e = F(n), a = L(n), r = n.modeState.turnCounts, o = n.modeState.historySummary, i = `你是 DM。请评价刚才玩家的行动，并描写其初步反应。
...
`);
    ...
    function bt(n, t) {
        const e = F(n), a = L(n), r = n.modeState.turnCounts, o = n.modeState.historySummary, i = n.modeConfig.gameMode, l = `你是 DM。基于玩家刚才的行动，决定是否需要进行 DND 5e 检定。
${H(i)}
如果需要，只输出 JSON 块：
\`\`\`json
{
...
`);
    ...
    function Dt(n, t) {
        const e = F(n), a = L(n), r = n.modeState.turnCounts, o = n.modeState.historySummary, i = n.modeState.lastCheckResult, l = n.modeState.lastCheckSpec, d = `你是 DM。检定结果已出。请根据结果描述后果，并引导剧情。
${e.systemPrompt}
...
`);
    ...
    const u = Z({
        ...
        async saveNewContextItemsToDB (n, t) {
            const { SessionDB: e } = await Q(async ()=>{
                const { SessionDB: o } = await import("./db-master-DpInMzGh.js").then((i)=>i.A);
                return {
                    SessionDB: o
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: n } = await Q(async ()=>{
                const { masterDb: a } = await import("./db-master-DpInMzGh.js").then((r)=>r.D);
                return {
                    masterDb: a
                };
    ...
    function kt() {
        const n = Ge((m)=>ze(m.config)), t = b.useRef(!1), e = b.useRef(async ()=>{}), a = b.useRef(!1), [r, o] = b.useState("running"), i = b.useCallback(()=>{
            ...
            try {
                ...
                console.error("[DndLoop] Critical Error:", _), W.error("LLM 调用失败，请前往 LLM 配置页面进行配置", {
    ...
    Ee.extend({
        ...
        modeConfig: Lt.describe("DnD 模式配置"),
        modeState: Rt.describe("DnD 模式状态")
    });
    let At, q, ae, Ut, Et;
    Rn = (n)=>{
                ...
                children: [
                    ...
                    s.jsx(Te, {
                        children: (()=>{
                            ...
                            return k && !k.hidden && !c.some((I)=>I.id === k.id) && P.push(k), P.map((I)=>s.jsx(Y, {
                                    messageId: I.id,
