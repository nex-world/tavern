...
import { s as E, aw as P, aZ as ee, r as _, t as G, u as te, j as s } from "./react-Cp7JIDMn.js";
import { C as se, a as ne, b as ae, d as re } from "./card--sAYb8Bf.js";
import { S as oe, a as ie, b as ce, __tla as __tla_0 } from "./session._sessionId-BpsB7WAa.js";
import { S as de } from "./spinner-fCA3hgE0.js";
import { C as ue, M as R, a as F } from "./conversation-message-BZgJiHtS.js";
import { I as me, c as pe, b as le } from "./input-group-BLS_bbvz.js";
import { f as J, m as he } from "./@tanstack-8dqqXYTU.js";
import { j as Se, S as ge } from "./db-master-DpInMzGh.js";
import { s as fe } from "./db-C6a7nMI2.js";
import { _ as U, __tla as __tla_1 } from "./index-Dvos9xYb.js";
import { C as xe } from "./context-manager.class-CetS2fXT.js";
import { S as Ce } from "./session-manager.class-D6gTmGU7.js";
import { B as A } from "./button-p-Zf1khH.js";
import { B as N } from "./badge-8hWiZNtW.js";
import { n as D } from "./id-BY9c7rfI.js";
import { u as Ie, g as ke, a as ye } from "./global-llm-config.store-CXBroG1M.js";
import { _ as V, o as L, s as x, n as v, b as _e, r as be, l as we } from "./zod-BTj0C3yc.js";
import { C as q } from "./CharacterAvatar-C7K0X6_t.js";
import { b as T, a as Me } from "./analytics-DqIS_F3D.js";
import { p as je, Z as Ae, a0 as Ne, az as De, f as ve } from "./icons-Dc5fwOe3.js";
    ...
    const y = E({
        ...
        async saveNewContextItemsToDB (t, e) {
            const { SessionDB: n } = await U(async ()=>{
                const { SessionDB: m } = await import("./db-master-DpInMzGh.js").then((r)=>r.A);
                return {
                    SessionDB: m
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: t } = await U(async ()=>{
                const { masterDb: a } = await import("./db-master-DpInMzGh.js").then((i)=>i.D);
                return {
                    masterDb: a
                };
...
`);
        ...
        const t = Ie((d)=>ke(d.config)), e = _.useRef(!1), [n, a] = _.useState(!1), i = J(), m = _.useCallback(async (d, o, S, p = {})=>{
            ...
            try {
                for(;;){
                    ...
                    if (!h) {
                        G.warning("DM 选择发言者失败，请重试"), p.setCurrentUIState("ai_loop_paused"), await o.updateSessionInDB();
                        break;
                    }
    ...
    Rt = (t)=>{
        ...
        const { sendPlayerMessage: C, continueAILoop: d, startChat: o, isRunningRef: S, isRunning: p } = Re();
        ...
        const u = r.currentSession?.modeState?.currentUIState || "idle", h = u === "ai_loop_paused" ? p ? "即将暂停" : "已暂停" : null, I = H[u] || H.idle, b = r.currentSession?.modeConfig?.participantSnapshots?.find((c)=>c.id === r.currentSession?.modeState?.currentSpeakerId), k = async ()=>{
            ...
            S.current || (T(t.sessionId, "group-chat"), await d());
                ...
                to: "/plaza"
            }), Y = r.contextManager?.state.processingItem?.id;
        return s.jsx("div", {
                ...
                children: [
                    ...
                    s.jsx(ue, {
                        children: (()=>{
                                    ...
                                    children: s.jsxs("div", {
                                        ...
                                        children: [
                                            ...
                                            s.jsxs("p", {
                                                ...
                                                children: [
                                                    "与 ",
                                                    r.currentSession?.modeConfig?.participantSnapshots?.map((W)=>W.name).join("、"),
                                                    " 一起聊天"
                                                ]
                                            }),
                                            s.jsxs(A, {
                            ...
                            return M && !M.hidden && !c.some((f)=>f.id === M.id) && j.push(M), j.map((f)=>s.jsx(R, {
                                    messageId: f.id,
    ...
    O = ({ item: t, participants: e, isStreaming: n })=>{
        const a = t.data, i = e.find((g)=>g.id === a.characterId), m = a.characterName || i?.name || "角色", r = n ? "..." : Z(t.timestamp);
        return s.jsx(F, {
            name: m,
            footer: r,
            avatar: s.jsx(q, {
    ...
    Je = ({ item: t, userName: e })=>{
        const n = t.data, a = Z(t.timestamp);
        return s.jsx(F, {
            name: n.userName || e,
            footer: a,
            fromUser: !0,
...
export { Rt as SessionMainForGroupChat, __tla };
