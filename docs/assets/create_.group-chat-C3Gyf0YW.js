import { r, j as e, u as d } from "./react-gFHNOnf5.js";
import { f as F, i as R } from "./@tanstack-DDpiKjUN.js";
import { n as T } from "./id-OxPLOBIU.js";
import { C as U, m as _ } from "./db-master-DI3V0061.js";
import { c as E } from "./llm-readiness-DRaLeVb_.js";
import { B as i } from "./button-D3G-RLOw.js";
import { C as f, a as v, b as C, c as y, d as b } from "./card-B4CxGEM-.js";
import { I as p } from "./input-KwncZLGm.js";
import { L as n } from "./label-BU_LC6Ti.js";
import { T as G } from "./textarea-DqdRyzs9.js";
import { B as $ } from "./badge-C9CmQsZA.js";
import { C as q } from "./CharacterAvatar-TKrkqhhW.js";
import { a2 as H, x as w, U as S, P as Q, X, a4 as J } from "./icons-CW-0NDo_.js";
...
const K = () => {
  const o = F(), [m, I] = r.useState(""), [x, k] = r.useState(""), [u, A] = r.useState(""), [h, D] = r.useState(5), [c, j] = r.useState(/* @__PURE__ */ new Set()), [t, g] = r.useState([]), { data: N = [] } = R((s) => s.from({ c: U })), L = (s) => {
    ...
    try {
      ...
      await _.sessions.add(P), d.success("\u7FA4\u804A\u5DF2\u521B\u5EFA\uFF01"), o({ to: "/session/$sessionId", params: { sessionId: a } });
    } catch (a) {
