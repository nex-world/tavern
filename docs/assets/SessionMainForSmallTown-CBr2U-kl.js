...
import { al as X, a6 as Te, j as o, r as x, v as se } from "./react-gFHNOnf5.js";
import { i as ve, n as be } from "./@tanstack-DDpiKjUN.js";
import { S as je, g as ke } from "./db-master-DI3V0061.js";
import { _ as J, __tla as __tla_0 } from "./index-7c6pKJ8J.js";
import { n as G } from "./id-OxPLOBIU.js";
import { f as ne, M as ie, a as Ne, W as Ce, L as F, G as I, b as A, I as S, d as oe, R as ae, T as we, e as $e, g as W, D as Ie, h as K, S as Z } from "./slider-DrwpTiXR.js";
import { C as Ae } from "./context-manager.class-BTc8g_cx.js";
import { B as _ } from "./button-D3G-RLOw.js";
import { aq as Ee, ap as Pe, n as Me, av as De } from "./icons-CW-0NDo_.js";
import { C as re } from "./CharacterAvatar-TKrkqhhW.js";
import { B as V } from "./vendor-DRKpriaz.js";
import { u as Re } from "./useLLM-B1Ewhspf.js";
import { D as le, a as ce, b as de, c as ue, d as me, e as Le } from "./dialog-CPE3M3ew.js";
import { L as R } from "./label-BU_LC6Ti.js";
import { S as q } from "./switch-D6eVMgf5.js";
import { I as z } from "./input-KwncZLGm.js";
import { c as Oe } from "./shadcn-utils-BMZD7_jZ.js";
...
let __tla = Promise.all([
  ...
  const f = X({
    ...
    loadSession(e, s) {
      this.currentSession = JSON.parse(JSON.stringify(e)), this.currentSession && (this.currentSession.modeState.isRunning = false, this.currentSession.modeState.currentPhase = "paused"), this.currentSession && (this.sessionManager = new _e(this.currentSession));
      const t = X(s || {
        historyItems: [],
        processingItem: void 0
      });
      this.contextManager = new Ae(t), this.historyItems = [
    ...
    async saveContextItemToDB(e, s) {
      const { SessionDB: t } = await J(async () => {
        const { SessionDB: r } = await import("./db-master-DI3V0061.js").then((l) => l.s);
        return {
          SessionDB: r
        };
    ...
    async updateSessionInDB() {
      ...
      const { masterDb: e } = await J(async () => {
        const { masterDb: t } = await import("./db-master-DI3V0061.js").then((n) => n.t);
        return {
          masterDb: t
        };
      }, __vite__mapDeps([0,1,2,3,4,5,6,7])), s = Te(this.currentSession.modeState);
  ...
  function Fe({ gameTime: e, isRunning: s, onToggle: t, onSettings: n }) {
    return o.jsxs("div", {
  ...
  function Be({ config: e, gridSize: s }) {
    const t = {
      position: "absolute",
      left: e.x * s,
      top: e.y * s,
  ...
  const We = 5e3;
  function Ye({ character: e, gridSize: s, isSelected: t, onClick: n }) {
    var _a;
    const i = s * 0.8, r = (s - i) / 2, l = e.visualX ?? e.gridX, d = e.visualY ?? e.gridY, a = {
      ...
      height: i,
      zIndex: t ? 10 : 1
    }, u = e.taskTimer > 0, m = Ce, c = u ? Math.max(0, Math.min(100, (m - e.taskTimer) / m * 100)) : 0, p = e.lastDialogue && Date.now() - e.lastDialogue.timestamp < We, y = ((_a = e.lastDialogue) == null ? void 0 : _a.content) ? e.lastDialogue.content.length > 20 ? `${e.lastDialogue.content.slice(0, 20)}...` : e.lastDialogue.content : "";
    return o.jsxs("div", {
      style: a,
      ...
      children: [
        ...
        o.jsx("button", {
          type: "button",
          className: `relative pointer-events-auto transition-transform hover:scale-110 ${t ? "ring-2 ring-primary ring-offset-2 rounded-full" : ""}`,
          onClick: n,
  ...
  function Ue({ characterStates: e, selectedCharacterId: s, onSelectCharacter: t }) {
    const n = I * A, i = x.useMemo(() => Object.entries(F).map(([d, a]) => o.jsx(Be, {
      locationKey: d,
      config: a,
      gridSize: I
    }, d)), []), r = x.useMemo(() => e.map((d) => o.jsx(Ye, {
      character: d,
      gridSize: I,
      isSelected: d.id === s,
      onClick: () => t(d.id)
  ...
  function He({ character: e, onOpenDiary: s }) {
  ...
  function Je({ contextItems: e, selectedCharacter: s }) {
      ...
      children: [
        ...
        o.jsx("div", {
          ...
          children: i.length === 0 ? o.jsx("p", {
            ...
            className: `flex gap-2 ${Xe(r.type, r.content)}`,
            children: [
              o.jsxs("span", {
  ...
  function et(e, s, t) {
    ...
    const r = st(e, s) ? 1 : 0, l = t - e.createdAt, d = Math.max(0, 1 - l / 50);
    return {
      urgency: n,
      importance: i,
      feasibility: r,
  ...
  function st(e, s) {
    ...
    if (t.items) {
      for (const n of t.items) if (Qe(s, n.itemId) < n.count) return false;
    }
    return true;
  }
  function he(e, s) {
  ...
  function it(e, s) {
    ...
    if ((_a = F[i]) == null ? void 0 : _a.isWork) {
      ...
      n = ye(n, i), n = M(n, s.id), t.historyEntries.push({
        role: "system",
        content: `\u5F00\u59CB\u5728${i}\u5DE5\u4F5C\u3002`
      }), t.logs.push({
  ...
  function ot(e, s) {
    ...
    return n.locationName !== i ? (n = B(n, i), n = M(n, s.id), t.historyEntries.push({
      ...
      source: "\u7CFB\u7EDF",
      type: "sys"
    }), t.updatedChar = n, t) : (ae.includes(i) ? (n = ye(n, i), n = M(n, s.id), t.historyEntries.push({
      role: "system",
      content: `\u5F00\u59CB\u5728${i}\u4F11\u606F\u3002`
    }), t.logs.push({
      content: `${e.name} \u56DE\u5BB6\u4F11\u606F`,
  ...
  function Tt(e, s, t, n, i, r) {
    let l = {
      ...e
    };
    if (l.taskName === "Working" && l.taskTarget) {
      const a = Ve(l, l.taskTarget);
      l = a.char, s(`${e.name} \u5DE5\u4F5C\u5B8C\u6210\uFF0C${a.log}`, "\u7CFB\u7EDF", "sys");
    } else if (l.taskName === "Sleeping") {
      const a = $e, u = l.home.level, m = 15, c = 12, p = 5, y = 0.8 + u / 5 * 0.4, h = Math.round(m * a * y), T = Math.round(c * a * y), g = Math.round(p * a * y);
      l = qe(l, h, T, g), s(`${e.name} \u7761\u9192\u4E86\uFF0C\u4F53\u529B+${h}\uFF0C\u6D3B\u529B+${T}\uFF0C\u6109\u60A6+${g}\u3002`, "\u7CFB\u7EDF", "sys");
    }
    l = pt(l);
    const d = he(l, r);
    if (d) {
  ...
  function kt(e, s, t, n, i, r) {
    ...
    if (l.pendingMoveTo) {
      ...
      if (Math.abs(l.gridX - l.pendingMoveTo.x) + Math.abs(l.gridY - l.pendingMoveTo.y) <= 1) l.pendingMoveTo = void 0;
        ...
        const c = ft(), p = l.visualX !== void 0 ? Math.round(l.visualX) : l.gridX, y = l.visualY !== void 0 ? Math.round(l.visualY) : l.gridY, h = ht(c, p, y, l.pendingMoveTo.x, l.pendingMoveTo.y);
    ...
    if (d && l.taskName !== "Sleeping") {
      const u = 0.8 + Math.random() * 0.4, m = yt(l.taskName), c = Math.round(5 * u * m);
      l.stamina = Math.max(0, l.stamina - c);
    }
    if (d && l.taskName !== "Sleeping") {
      const u = 0.8 + Math.random() * 0.4, m = xt(l.taskName), c = St(s.hour), p = Math.round(4 * u * m * c);
      l.energy = Math.max(0, l.energy - p);
    }
    return l.taskTimer > 0 ? (l.taskTimer--, l.taskTimer === 0 && (l = Tt(l, t, n, i, s, r))) : l = vt(l, t, r), l;
  }
  const w = {
    minInterval: 10,
    maxInterval: 18,
  ...
  function ee(e, s) {
    ...
    if (!n && nt(e) === 0 && t >= w.minInterval / 2) return {
      type: "empty-todo"
    };
...
`);
  ...
  function It(e, s, t, n = []) {
    var _a;
    const i = wt(e.todoList), r = $t(), l = n.filter((h) => h.id !== e.id && Math.abs(h.gridX - e.gridX) + Math.abs(h.gridY - e.gridY) <= 5).map((h) => `${h.name}(\u5728${h.locationName})`), d = l.length > 0 ? `\u9644\u8FD1\u7684\u4EBA: ${l.join(", ")}` : "\u9644\u8FD1\u6CA1\u6709\u4EBA";
    let a = "";
    switch (s.type) {
      case "empty-todo":
...
\u6CE8\u610F: type\u5FC5\u987B\u662F work/rest/social/travel/explore/trade/consume \u4E4B\u4E00\uFF0Clocation\u5FC5\u987B\u662F\u4E0A\u9762\u5217\u51FA\u7684\u82F1\u6587Key`;
  ...
  function Et(e) {
    try {
      ...
      const n = Array.isArray(t.addTodos) ? t.addTodos.map((i) => {
        ...
        return (r == null ? void 0 : r.location) && (r.location = At(r.location)), i;
      }) : [];
      return {
  ...
  function Mt(e, s, t) {
    ...
    for (const d of s.addTodos) {
      ...
      if (d.type === "rest" && !a.location && (a.location = e.homeZoneKey || "Zone_A"), d.type === "social" && delete a.location, Pt(n, d.type, a.location)) {
  ...
  function Dt(e, s, t) {
    const n = xe, i = n.baseResponseProbability, r = Math.pow(n.turnDecayRate, Math.max(0, s.turns - 1)), l = Math.max(0.3, 1 - e.conversationState.totalTurnsToday / n.dailyFatigueThreshold), d = t - s.lastTurnTick, a = Math.max(0.2, 1 - d / n.waitDecayTicks), u = s.sentiment * 0.1, m = i * r * l * a + u;
    return Math.max(n.minResponseProbability, Math.min(n.maxResponseProbability, m));
  }
  function Rt(e, s, t, n, i) {
...
\u6CE8\u610F\uFF1A\u5982\u679C\u4F60\u60F3\u7ED3\u675F\u5BF9\u8BDD\uFF0C\u5C06 endConversation \u8BBE\u4E3A true\uFF0C\u5E76\u5728 dialogue \u4E2D\u8BF4\u4E00\u53E5\u7ED3\u675F\u8BED\u3002`;
  ...
  async function Bt(e, s, t, n, i) {
    try {
      const r = Ot(e, s, t, n), l = [
        {
          role: "system",
...
\u8FD4\u56DE JSON:
{
  ...
  function Yt(e) {
    return e.hour === Ie && e.minute >= K && e.minute < K + ie;
  }
  function Ut() {
    const { callLLMStream: e } = Re(), s = x.useRef({
      ...
      const T = Object.values(((_a = f.currentSession) == null ? void 0 : _a.modeState.characterStates) || {}), g = await Ft(c, h, p, T, (j) => n(j, c.id));
      let v;
      g ? v = Et(g) || te(c) : v = te(c);
      const b = Mt(c, v, y);
      ...
      const v = p.type === "social", b = await Bt(c, T, g.name, v, n);
      if (b && b.dialogue) {
        const j = v ? "\u5BF9" : "\u56DE\u5E94";
        ...
        if (C = E(C, p.id), b.endConversation && (C = Lt(C, T)), f.setCharacterState(c.id, C), g.aiEnabled) {
          const D = Rt(g, c.id, c.name, b.dialogue, h);
      ...
      try {
        ...
        if (Yt(v) && !h.wroteDiaryToday) return await i(h, v), true;
        if (ee(h, b) !== null) {
        ...
        if (C) {
          ...
          await d(C, v, D, (k == null ? void 0 : k.modeState.salesStand) || [], b), Se && (g = true);
        }
      } catch (v) {
  ...
  function Xt() {
    var _a;
    const e = se(f), s = x.useRef(null), t = x.useRef(false), { processAllAI: n } = Ut(), i = x.useRef(n);
    i.current = n;
    const r = ((_a = e.currentSession) == null ? void 0 : _a.modeState.isRunning) ?? false, l = x.useCallback(async () => {
      ...
      for (const v of c) {
        const b = a.modeState.characterStates[v], j = kt(b, h, (k, C, D) => f.addLog(k, C, D), p, y, T);
        ...
        if (r && r.modeState.isRunning) {
          ...
          Object.keys(l).forEach((d) => {
            ...
            if (a.currentPath && a.currentPath.length > 1) {
              ...
              const m = gt(a.visualX, a.visualY, a.currentPath, 4, i);
  ...
  function Gt({ open: e, onOpenChange: s, settings: t, onSave: n }) {
  ...
  function Kt({ className: e, children: s, ...t }) {
    return o.jsx("div", {
      "data-slot": "scroll-area",
      className: Oe("overflow-x-auto overflow-y-auto", e),
      ...t,
      children: s
    });
  }
  function Zt({ open: e, onOpenChange: s, character: t }) {
    if (!t) return null;
    const n = [
      ...t.dailyLog
  ...
  js = function({ sessionId: e }) {
    const { data: s = [] } = ve((n) => n.from({
      s: je
    }).where(({ s: i }) => be(i.id, e))), t = s[0];
    return x.useEffect(() => {
      var _a;
