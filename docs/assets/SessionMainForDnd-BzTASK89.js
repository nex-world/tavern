...
import { D as ne, F as K, aH as be, r as j, t as V, E as ye, j as e } from "./react-BQpw03Eg.js";
import { f as ie, i as Se } from "./@tanstack-B4B5CfFY.js";
import { r as Ce, S as Ne, m as ke } from "./db-master-l33tB5ke.js";
import { s as De } from "./db-BMXax6F-.js";
import { _ as se, __tla as __tla_0 } from "./index-DkZE5rMH.js";
import { C as je } from "./context-manager.class-CwvvDHbt.js";
import { n as P } from "./id-OxPLOBIU.js";
import { S as we } from "./session-manager.class-fBqHHRvS.js";
import { B as v } from "./button-B9brLUSp.js";
import { T as Ie } from "./textarea-D6rL78Aw.js";
import { B as A } from "./badge-DvaSwOwN.js";
import { u as Me, e as ve } from "./global-llm-config.store-DiEUj8Zz.js";
...
import { S as Re } from "./switch-BPeiHTCh.js";
import { aj as W, n as Q, ak as Le, al as Ee, i as ee, J as Ue, a as He, Q as Ae, am as Fe, a8 as de, N as Z, B as Y, an as Be, c as Oe } from "./icons-BC63ChG4.js";
...
let __tla = Promise.all([
  ...
  const Ve = /<think>([\s\S]*?)<\/think>/, We = /<speak>([\s\S]*?)<\/speak>/, Qe = /<action>([\s\S]*?)<\/action>/;
  function me(s) {
    var _a, _b, _c, _d, _e, _f;
    const n = qe(s), t = (_b = (_a = n.match(Ve)) == null ? void 0 : _a[1]) == null ? void 0 : _b.trim(), o = (_d = (_c = n.match(We)) == null ? void 0 : _c[1]) == null ? void 0 : _d.trim(), a = (_f = (_e = n.match(Qe)) == null ? void 0 : _e[1]) == null ? void 0 : _f.trim(), r = n.replace(/<\/?[a-zA-Z]\w*[^>]*>/g, "").trim();
    return {
      think: t,
      speak: o,
      action: a,
  ...
  const m = ne({
    ...
    async saveNewContextItemsToDB(s, n) {
      const { SessionDB: t } = await se(async () => {
        const { SessionDB: r } = await import("./db-master-l33tB5ke.js").then((i) => i.s);
        return {
          SessionDB: r
        };
    ...
    async updateSessionInDB() {
      ...
      const { masterDb: s } = await se(async () => {
        const { masterDb: o } = await import("./db-master-l33tB5ke.js").then((a) => a.t);
        return {
          masterDb: o
        };
