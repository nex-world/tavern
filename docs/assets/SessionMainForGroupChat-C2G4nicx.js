...
import { h as se, S as ae } from "./db-master-t2LgSPF9.js";
import { s as ne } from "./db-YudOy6MF.js";
import { _ as G, __tla as __tla_0 } from "./index-BtQkZkPY.js";
import { C as re, A as oe } from "./AutoScrollDownArea-B77n74t3.js";
import { S as ie } from "./session-manager.class-8r8TPG2j.js";
...
import { b as R, a as he } from "./analytics-Cvk01mJB.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-t2LgSPF9.js").then((i)=>i.v);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-t2LgSPF9.js").then((o)=>o.w);
                return {
                    masterDb: n
                };
