...
import { h as ct, m as Ce, S as lt } from "./db-master-D0ahR8Qm.js";
import { k as ie, m as ce, j as dt } from "./@tanstack-DHpjEvx5.js";
import { _ as mt, __tla as __tla_0 } from "./index-rrWAXvvv.js";
import { C as pt, A as ut } from "./AutoScrollDownArea-BTDHzY0Y.js";
import { S as ht } from "./session-manager.class-BfmlsvKQ.js";
        ...
        async updateSessionInDB () {
            if (o.currentSession) try {
                const { masterDb: t } = await mt(async ()=>{
                    const { masterDb: r } = await import("./db-master-D0ahR8Qm.js").then((a)=>a.w);
                    return {
                        masterDb: r
                    };
