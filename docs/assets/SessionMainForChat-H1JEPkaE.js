const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/db-master-xI8DZi24.js","assets/@tanstack-BuNX36FW.js","assets/react-BPCshYXX.js","assets/vendor-DqU8PgXE.js","assets/@radix-ui-BQCqNqg0.js","assets/immer-BCQU3qJI.js","assets/dexie-DOn8o3hw.js","assets/zod-fbN9ubnj.js","assets/PlayerInputItem-Cw3shOQU.js","assets/id-OxPLOBIU.js","assets/CharacterAvatar-DwtbYeXp.js","assets/shadcn-utils-BMZD7_jZ.js","assets/components-and-styling-lnR2ABT4.js","assets/@tailwind-COJ8Fh6m.js","assets/icons-BpfK1DnB.js"])))=>i.map(i=>d[i]);
import { D as b, r as l, u as L, j as t } from "./react-BPCshYXX.js";
...
import { B as U } from "./button-CKyQl8ny.js";
import { T as $ } from "./textarea-Dc_MpBxB.js";
import { B as E } from "./badge-b3CWeD_H.js";
import { C as B } from "./CharacterAvatar-DwtbYeXp.js";
import { u as K } from "./useLLM-CCvhQGvi.js";
import { _ as Y } from "./icons-BpfK1DnB.js";
  ...
  const m = b({
    ...
    async saveNewContextItemsToDB(e, s) {
      const { SessionDB: o } = await M(async () => {
        const { SessionDB: g } = await import("./db-master-xI8DZi24.js").then((y) => y.s);
        return {
          SessionDB: g
        };
    ...
    const o = K(), n = l.useRef(false), g = H(), y = l.useCallback(async (h) => {
      if (!(n.current || !s || s.getHistoryCount() > 0 || !e)) try {
        ...
        const { makeChatModeStartingContextItems_CN: p } = await M(async () => {
          const { makeChatModeStartingContextItems_CN: d } = await import("./PlayerInputItem-Cw3shOQU.js").then((r) => r.c);
          return {
      ...
      if (!(n.current || !e || !s)) try {
        ...
        const { makeChatModeLLMMessagesFromContextStateForCharacterId: x } = await M(async () => {
          const { makeChatModeLLMMessagesFromContextStateForCharacterId: u } = await import("./PlayerInputItem-Cw3shOQU.js").then((C) => C.c);
          return {
