...
import { e as se, an as Be, j as i, aG as Fe, aH as We, aI as Ge, aJ as He, aK as ze, r as T, u as ve, aL as Ye, aM as Ue, aN as Xe } from "./react-BxzVs1F-.js";
import { k as Je, m as Ze } from "./@tanstack-B5tCGMiu.js";
import { S as Ke, o as Ve, j as qe } from "./db-master-kA5b7Kkp.js";
import { _ as ne, __tla as __tla_0 } from "./index-CRWqN2Z9.js";
import { n as ie } from "./id-BY9c7rfI.js";
import { f as Te, M as je, a as Qe, W as et, L as M, G as $, b as P, I as b, d as be, R as tt, T as st, e as nt, g as Y, D as it, h as oe, S as ae, i as ot, j as at } from "./slider-DihGNT6w.js";
import { C as rt } from "./context-manager.class-D5bFB92s.js";
import { B as w } from "./button-BRW5UoPv.js";
import { aw as lt, av as ct, ay as dt, az as ut, h as mt, U as pt, aA as ft, aB as ht, aC as gt, aD as yt, aE as xt, aF as St } from "./icons-C6_pGF5j.js";
import { C as J } from "./CharacterAvatar-K7qbQSdG.js";
import { c as H } from "./shadcn-utils-Cnr6N47i.js";
import { a as vt, b as Tt, c as jt } from "./tooltip-Dint9o87.js";
import { B as G } from "./badge-Cxz86jq2.js";
import { P as K } from "./progress-BqjBAGm9.js";
import { A as bt } from "./AutoScrollDownArea-m0lCE45e.js";
import { T as Nt, a as U } from "./toggle-group-CbzATKSu.js";
import { S as re } from "./vendor-CJLoHUZS.js";
import { u as kt } from "./useLLM-0gFp44Ix.js";
import { D as Ne, h as ke, a as Ce, b as we, c as $e, d as Ct } from "./responsive-dialog-B5gKVGEy.js";
import { L as _ } from "./label-APquV01x.js";
import { S as le } from "./switch-CO9-2KPd.js";
import { I as ce } from "./input-Cv054FMu.js";
import { l as wt } from "./zod-BTj0C3yc.js";
import "./@radix-ui-BQCqNqg0.js";
import "./immer-BCQU3qJI.js";
import "./dexie-CG_LwvPM.js";
import "./analytics-DHqd3KZu.js";
...
let __tla = Promise.all([
    ...
    const y = se({
        ...
        loadSession (e, t) {
            ...
            this.contextManager = new rt(s), this.historyItems = [
                ...t?.historyItems || []
            ];
        },
        unloadSession () {
        ...
        async saveContextItemToDB (e, t) {
            const { SessionDB: s } = await ne(async ()=>{
                const { SessionDB: c } = await import("./db-master-kA5b7Kkp.js").then((r)=>r.A);
                return {
                    SessionDB: c
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: e } = await ne(async ()=>{
                const { masterDb: s } = await import("./db-master-kA5b7Kkp.js").then((n)=>n.D);
                return {
                    masterDb: s
                };
    ...
    function It({ gameTime: e, isRunning: t, isSidebarOpen: s, onToggle: n, onToggleSidebar: o, onSettings: c }) {
        return i.jsxs("div", {
    ...
    function Ae({ className: e, align: t = "center", sideOffset: s = 4, ...n }) {
        return i.jsx(Ge, {
            children: i.jsx(He, {
    ...
    const de = 6, Et = 14, Dt = 6, V = .25;
    function Rt({ character: e, gridSize: t, boardSize: s, isSelected: n, renderPosition: o, showDialogueBubble: c = !1, onClick: r }) {
        const l = t * .8, a = (t - l) / 2, m = e.taskTimer > 0, f = o?.x ?? e.visualX ?? e.gridX, d = o?.y ?? e.visualY ?? e.gridY, h = f * t + a, x = d * t + a, p = (h + l / 2) / s, u = (x + l / 2) / s < V ? "bottom" : "top", S = p < V ? "start" : p > 1 - V ? "end" : "center", v = {
            ...
            top: Math.min(s - l - Dt, Math.max(Et, x)),
            width: l,
            height: l,
            zIndex: n ? 10 : 1
        }, j = et, N = m ? Math.max(0, Math.min(100, (j - e.taskTimer) / j * 100)) : 0, k = e.lastDialogue?.content ? e.lastDialogue.content.length > 20 ? `${e.lastDialogue.content.slice(0, 20)}...` : e.lastDialogue.content : "";
        return i.jsxs("div", {
            style: v,
    ...
    const X = 4;
    function Lt({ locationKey: e, position: t, characters: s, hiddenCount: n, selectedCharacterId: o, gridSize: c, boardSize: r, onSelectCharacter: l }) {
        const m = c * .8, f = (c - m) / 2, d = Math.min(r - 32 - X, Math.max(X, t.x * c + f - (32 - m) / 2)), h = Math.min(r - 32 - X, Math.max(X, t.y * c + f - (32 - m) / 2)), x = M[e]?.label ?? e;
        return i.jsxs(Ie, {
            children: [
                i.jsx(Mt, {
                    asChild: !0,
    ...
    function Wt(e, t, s = $) {
        ...
        for (const [r, l] of c){
            const a = M[r], m = _t(a, s), f = l.length > m, d = f ? Math.max(1, m - 1) : l.length, h = Ft(l, d, t), x = h.length + (f ? 1 : 0), p = Bt(a, x, s);
            h.forEach((g, u)=>{
                n.set(g.id, p[u]);
            }), f && o.push({
                locationKey: r,
    ...
    const ue = 5e3;
    function Gt({ characterStates: e, selectedCharacterId: t, onSelectCharacter: s, zoom: n = 1 }) {
        const o = $ * P, c = o * n, r = T.useRef(null), l = T.useMemo(()=>Wt(e, t), [
            e,
            t
        ...
        const f = T.useMemo(()=>Object.entries(M).map(([p, g])=>i.jsx(At, {
            ...
            t,
            s
        ]), h = T.useMemo(()=>l.clusters.map((p)=>i.jsx(Lt, {
                    ...p,
    ...
    function Ht({ characters: e, selectedCharacterId: t, onSelectCharacter: s }) {
        const n = [
            ...e
...
注意：如果你想结束对话，将 endConversation 设为 true，并在 dialogue 中说一句结束语。`;
    ...
    function os({ contextItems: e, selectedCharacter: t }) {
    ...
    function ms(e, t) {
        ...
        if (n.locationName !== o) return n = z(n, o), n = R(n, t.id), s.historyEntries.push({
            role: "system",
            content: `前往${o}准备工作。`
        }), s.logs.push({
            content: `${e.name} 前往${o}`,
    ...
    function ps(e, t) {
        ...
        return n.locationName !== o ? (n = z(n, o), n = R(n, t.id), s.historyEntries.push({
            role: "system",
            content: `前往${o}准备休息。`
        }), s.logs.push({
            content: `${e.name} 前往${o}`,
    ...
    function hs(e, t) {
        ...
        const o = t.preconditions.location;
        return o ? n.locationName !== o ? (n = z(n, o), n = R(n, t.id), s.historyEntries.push({
            role: "system",
            content: `移动到${o}。`
        }), s.logs.push({
    ...
    function Ss(e, t) {
        ...
        return o === "Shop" && n.dailyShopVisit ? (n = C(n, t.id), s.updatedChar = n, s.historyEntries.push({
            ...
            role: "system",
            content: "今天已经去过商业大道了。"
        }), s) : (n.locationName !== o && (n = z(n, o)), o === "Shop" ? n.dailyShopVisit = !0 : o === "SalesStand" && (n.dailySalesStandVisit = !0), n = L(n, t.id), n.status = `在${o}交易`, s.completed = !0, s.historyEntries.push({
            role: "system",
            content: `前往${o}进行交易。`
        }), s.updatedChar = n, s);
    }
    ...
    function $s(e, t, s, n, o, c) {
        let r = {
            ...e
        };
        if (r.taskName === "Working" && r.taskTarget) {
            const a = cs(r, r.taskTarget);
            r = a.char, t(`${e.name} 工作完成，${a.log}`, "系统", "sys");
        } else if (r.taskName === "Sleeping") {
            const a = nt, m = r.home.level, f = 15, d = 12, h = 5, x = .8 + m / 5 * .4, p = Math.round(f * a * x), g = Math.round(d * a * x), u = Math.round(h * a * x);
    ...
    function Ps(e, t, s, n, o, c) {
        ...
        if (r.pendingMoveTo) {
            ...
            if (r.gridX === r.pendingMoveTo.x && r.gridY === r.pendingMoveTo.y) r.pendingMoveTo = void 0, r.targetLocationName && (r.locationName = r.targetLocationName, r.targetLocationName = void 0);
                ...
                const f = js(), d = r.visualX !== void 0 ? Math.round(r.visualX) : r.gridX, h = r.visualY !== void 0 ? Math.round(r.visualY) : r.gridY, x = bs(f, d, h, r.pendingMoveTo.x, r.pendingMoveTo.y);
        ...
        return r.taskTimer > 0 ? (r.taskTimer--, r.taskTimer === 0 && (r = $s(r, s, n, o, t, c))) : r = Is(r, s, c), r;
    }
    const I = {
        minInterval: 10,
        maxInterval: 18,
...
`);
    ...
    function Os(e, t, s, n = []) {
        const o = Rs(e.todoList), c = Ls(), r = n.filter((u)=>u.id !== e.id && Math.abs(u.gridX - e.gridX) + Math.abs(u.gridY - e.gridY) <= 5).map((u)=>`${u.name}(在${u.locationName})`), l = r.length > 0 ? `附近的人: ${r.join(", ")}` : "附近没有人", a = n.reduce((u, S)=>{
...
注意: type必须是 work/rest/social/travel/explore/trade/consume 之一，location必须是上面列出的英文Key`;
    ...
    function Bs(e) {
        try {
            ...
            const n = Array.isArray(s.addTodos) ? s.addTodos.map((o)=>{
                ...
                return c?.location && (c.location = _s(c.location)), o;
            }) : [];
            return {
    ...
    function Ws(e, t, s) {
        ...
        for (const l of t.addTodos){
            ...
            if (l.type === "rest" && (a.location = e.homeZoneKey || "Zone_A"), l.type === "social" && delete a.location, Fs(n, l.type, a.location)) {
...
返回 JSON:
{
  ...
  "wisdom": "一句感悟或智慧 (30字以内)"
    ...
    function Ys(e) {
        return e.hour === it && e.minute >= oe && e.minute < oe + je;
    }
    function Us() {
        const { callLLMStream: e } = kt(), t = T.useRef({
            ...
            const g = Object.values(y.currentSession?.modeState.characterStates || {}), u = await Gs(d, p, h, g, (j)=>n(j, d.id));
            let S;
            ...
            const S = h.type === "social", v = await Hs(d, g, u.name, S, n);
            if (v && v.dialogue) {
                const j = S ? "对" : "回应";
                y.addLog(Vt(u.name, v.dialogue, S), d.name, "chat");
                const N = [
                    ...d.history,
                    {
                        role: "assistant",
                ...
                if (k = L(k, h.id), v.endConversation && (k = ts(k, g)), y.setCharacterState(d.id, k), u.aiEnabled) {
            ...
            try {
                ...
                if (Ys(S) && !p.wroteDiaryToday) return await o(p, S), !0;
                if (pe(p, v) !== null) {
    ...
    function Js() {
        const e = ve(y), t = T.useRef(null), s = T.useRef(!1), { processAllAI: n } = Us(), o = T.useRef(n);
        o.current = n;
        const c = e.currentSession?.modeState.isRunning ?? !1, r = T.useCallback(async ()=>{
            ...
            for (const S of d){
                const v = a.modeState.characterStates[S], j = Ps(v, p, (N, k, D)=>y.addLog(N, k, D), h, x, g);
                ...
                if (c?.modeState.isRunning) {
                    ...
                    for (const l of Object.keys(r)){
                        ...
                        if (a.currentPath && a.currentPath.length > 1) {
                            ...
                            const f = Ns(a.visualX, a.visualY, a.currentPath, 4, o);
    ...
    const ge = 1.2, ye = .8, xe = 1.8, Se = .1, en = 100;
    ...
    Wn = function({ sessionId: e }) {
        const { data: t = [] } = Je((n)=>n.from({
                s: Ke
            }).where(({ s: o })=>Ze(o.id, e))), s = nn(t[0]);
        return T.useEffect(()=>{
            if (!s || y.currentSession?.id === e) return;
            (async ()=>{
                try {
                    const r = {
                        historyItems: await new Ve(e).getContextItems(),
                        processingItem: void 0
                    };
                    y.loadSession(s, r);
                } catch (o) {
...
export { Wn as SessionMainForSmallTown, __tla };
