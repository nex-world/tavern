import { r as sE, _ as ga, a as wh, g as fE, b as dE, h as ki, c as pE, o as mE, s as vE, f as hE, d as gE, e as yE, i as Kv, l as bE, j as SE, m as Xv, k as EE, n as xE, p as CE, q as TE } from "./vendor-C4ToNUTj.js";
...
function zh(l) {
  const i = Ex(l), r = d.forwardRef((u, s) => {
    let { children: f, ...m } = u;
    Nh(f) && typeof Li == "function" && (f = Li(f._payload));
...
function Ex(l) {
  const i = d.forwardRef((r, u) => {
    let { children: s, ...f } = r;
    if (Nh(s) && typeof Li == "function" && (s = Li(s._payload)), d.isValidElement(s)) {
...
var Nx = Sf[" useInsertionEffect ".trim().toString()] || dt;
...
var Gs = "focusScope.autoFocusOnMount", Ys = "focusScope.autoFocusOnUnmount", sh = { bubbles: false, cancelable: true }, Qx = "FocusScope", or = d.forwardRef((l, i) => {
  ...
  const O = d.useCallback((x) => {
    ...
    if (T && M) {
      const N = x.currentTarget, [j, Y] = $x(N);
...
var Ih = dC(), qs = function() {
  ...
  return d.createElement(d.Fragment, null, b && d.createElement($, { sideCar: Ih, removeScrollBar: g, shards: v, noRelative: w, noIsolation: O, inert: x, setCallbacks: f, allowPinchZoom: !!T, lockRef: r, gapMode: j }), m ? d.cloneElement(d.Children.only(h), ga(ga({}, V), { ref: J })) : d.createElement(N, ga({}, V, { className: y, ref: J }), h));
});
...
}, NC = function(l, i, r, u, s) {
  var f = OC(l, window.getComputedStyle(i).direction), m = f * u, h = r.target, y = i.contains(h), g = false, b = m > 0, v = 0, C = 0;
  do {
    if (!h) break;
    var w = Ph(l, h), O = w[0], x = w[1], T = w[2], M = x - T - f * O;
    (O || M) && Xh(l, h) && (v += M, C += O);
    var N = h.parentNode;
...
function BC(l) {
  ...
  var h = d.useCallback(function(x, T) {
    ...
    var de = u.current || $;
    return NC(de, T, x, de === "h" ? j : Y);
  }, []), y = d.useCallback(function(x) {
    var T = x;
    if (!(!ql.length || ql[ql.length - 1] !== f)) {
      var M = "deltaY" in T ? yh(T) : zi(T), N = i.current.filter(function($) {
    ...
    var j = { name: x, delta: T, target: M, should: N, shadowParent: HC(M) };
  ...
  return d.createElement(d.Fragment, null, O ? d.createElement(f, { styles: jC(s) }) : null, w ? d.createElement(_C, { noRelative: l.noRelative, gapMode: l.gapMode }) : null);
}
function HC(l) {
...
function tT(l) {
  ...
  }, []), Y = f || O, $ = m || T, J = d.useRef(null), V = d.useRef(null), ae = d.useRef(b), ye = y != null, me = Xs(y), ce = Xs(s), de = Xs(g), pe = d.useCallback(() => {
...
var _f = "PopperContent", [pT, mT] = gg(_f), xg = d.forwardRef((l, i) => {
  ...
  const { __scopePopper: r, side: u = "bottom", sideOffset: s = 0, align: f = "center", alignOffset: m = 0, arrowPadding: h = 0, avoidCollisions: y = true, collisionBoundary: g = [], collisionPadding: b = 0, sticky: v = "partial", hideWhenDetached: C = false, updatePositionStrategy: w = "optimized", onPlaced: O, ...x } = l, T = yg(_f, r), [M, N] = d.useState(null), j = he(i, (K) => N(K)), [Y, $] = d.useState(null), J = Ji(Y), V = (J == null ? void 0 : J.width) ?? 0, ae = (J == null ? void 0 : J.height) ?? 0, ye = u + (f !== "center" ? "-" + f : ""), me = typeof b == "number" ? b : { top: 0, right: 0, bottom: 0, left: 0, ...b }, ce = Array.isArray(g) ? g : [g], de = ce.length > 0, pe = { padding: me, boundary: ce.filter(hT), altBoundary: de }, { refs: be, floatingStyles: Se, placement: I, isPositioned: ee, middlewareData: le } = tT({ strategy: "fixed", placement: ye, whileElementsMounted: (...K) => SE(...K, { animationFrame: w === "always" }), elements: { reference: T.anchor }, middleware: [aT({ mainAxis: s + ae, alignmentAxis: m }), y && lT({ mainAxis: true, crossAxis: false, limiter: v === "partial" ? oT() : void 0, ...pe }), y && rT({ ...pe }), iT({ ...pe, apply: ({ elements: K, rects: te, availableWidth: ie, availableHeight: Ce }) => {
  ...
  } }), Y && cT({ element: Y, padding: h }), gT({ arrowWidth: V, arrowHeight: ae }), C && uT({ strategy: "referenceHidden", ...pe })] }), [ne, Ee] = _g(I), R = cn(O);
  dt(() => {
    ee && (R == null ? void 0 : R());
  }, [ee, R]);
...
var bT = Ag, ST = [" ", "Enter", "ArrowUp", "ArrowDown"], ET = [" ", "Enter"], $a = "Select", [nu, au, xT] = Jl($a), [Fl] = pt($a, [xT, Ea]), lu = Ea(), [CT, xa] = Fl($a), [TT, _T] = Fl($a), Mg = (l) => {
  const { __scopeSelect: i, children: r, open: u, defaultOpen: s, onOpenChange: f, value: m, defaultValue: h, onValueChange: y, dir: g, name: b, autoComplete: v, disabled: C, required: w, form: O } = l, x = lu(i), [T, M] = d.useState(null), [N, j] = d.useState(null), [Y, $] = d.useState(false), J = Wa(g), [V, ae] = xt({ prop: u, defaultProp: s ?? false, onChange: f, caller: $a }), [ye, me] = xt({ prop: m, defaultProp: h, onChange: y, caller: $a }), ce = d.useRef(null), de = T ? O || !!T.closest("form") : true, [pe, be] = d.useState(/* @__PURE__ */ new Set()), Se = Array.from(pe).map((I) => I.props.value).join(";");
  return E.jsx(Fi, { ...x, children: E.jsxs(CT, { required: w, scope: i, trigger: T, onTriggerChange: M, valueNode: N, onValueNodeChange: j, valueNodeHasChildren: Y, onValueNodeHasChildrenChange: $, contentId: Xe(), value: ye, onValueChange: me, open: V, onOpenChange: ae, dir: J, triggerPointerDownPosRef: ce, disabled: C, children: [E.jsx(nu.Provider, { scope: i, children: E.jsx(TT, { scope: l.__scopeSelect, onNativeOptionAdd: d.useCallback((I) => {
  ...
  }, []), children: r }) }), de ? E.jsxs($g, { "aria-hidden": true, required: w, tabIndex: -1, name: b, autoComplete: v, value: ye, onChange: (I) => me(I.target.value), disabled: C, form: O, children: [ye === void 0 ? E.jsx("option", { value: "" }) : null, Array.from(pe)] }, Se) : null] }) });
};
Mg.displayName = $a;
var wg = "SelectTrigger", Dg = d.forwardRef((l, i) => {
  const { __scopeSelect: r, disabled: u = false, ...s } = l, f = lu(r), m = xa(wg, r), h = m.disabled || u, y = he(i, m.onTriggerChange), g = au(r), b = d.useRef("touch"), [v, C, w] = Fg((x) => {
    const T = g().filter((j) => !j.disabled), M = T.find((j) => j.value === m.value), N = Wg(T, x, M);
  ...
  return E.jsx(ur, { asChild: true, ...f, children: E.jsx(ue.button, { type: "button", role: "combobox", "aria-controls": m.contentId, "aria-expanded": m.open, "aria-required": m.required, "aria-autocomplete": "none", dir: m.dir, "data-state": m.open ? "open" : "closed", disabled: h, "data-disabled": h ? "" : void 0, "data-placeholder": Jg(m.value) ? "" : void 0, ...s, ref: y, onClick: W(s.onClick, (x) => {
    ...
    const T = v.current !== "";
    !(x.ctrlKey || x.altKey || x.metaKey) && x.key.length === 1 && C(x.key), !(T && x.key === " ") && ST.includes(x.key) && (O(), x.preventDefault());
  }) }) });
});
Dg.displayName = wg;
var Og = "SelectValue", Ng = d.forwardRef((l, i) => {
  const { __scopeSelect: r, className: u, style: s, children: f, placeholder: m = "", ...h } = l, y = xa(Og, r), { onValueNodeHasChildrenChange: g } = y, b = f !== void 0, v = he(i, y.onValueNodeChange);
  return dt(() => {
    g(b);
...
var un = 10, [Bg, Ca] = Fl(Ja), MT = "SelectContentImpl", wT = Qa("SelectContent.RemoveScroll"), Hg = d.forwardRef((l, i) => {
  ...
  }, [N.value]), P = u === "popper" ? tf : Lg, F = P === tf ? { side: h, sideOffset: y, align: g, alignOffset: b, arrowPadding: v, collisionBoundary: C, collisionPadding: w, sticky: O, hideWhenDetached: x, avoidCollisions: T } : {};
  return E.jsx(Bg, { scope: r, content: j, viewport: $, onViewportChange: J, itemRefCallback: A, selectedItem: ae, onItemLeave: H, itemTextRefCallback: X, focusSelectedItem: ee, selectedItemText: me, position: u, isPositioned: pe, searchRef: Ee, children: E.jsx(ir, { as: wT, allowPinchZoom: true, children: E.jsx(or, { asChild: true, trapped: N.open, onMountAutoFocus: (K) => {
    K.preventDefault();
...
var DT = "SelectItemAlignedPosition", Lg = d.forwardRef((l, i) => {
  const { __scopeSelect: r, onPlaced: u, ...s } = l, f = xa(Ja, r), m = Ca(Ja, r), [h, y] = d.useState(null), [g, b] = d.useState(null), v = he(i, (V) => b(V)), C = au(r), w = d.useRef(false), O = d.useRef(true), { viewport: x, selectedItem: T, selectedItemText: M, focusSelectedItem: N } = m, j = d.useCallback(() => {
  ...
  return E.jsx(NT, { scope: r, contentWrapper: h, shouldExpandOnScrollRef: w, onScrollButtonChange: J, children: E.jsx("div", { ref: y, style: { display: "flex", flexDirection: "column", position: "fixed", zIndex: Y }, children: E.jsx(ue.div, { ...s, ref: v, style: { boxSizing: "border-box", maxHeight: "100%", ...s.style } }) }) });
});
Lg.displayName = DT;
var OT = "SelectPopperPosition", tf = d.forwardRef((l, i) => {
...
tf.displayName = OT;
var [NT, Rf] = Fl(Ja, {}), nf = "SelectViewport", Gg = d.forwardRef((l, i) => {
...
var Vi = "SelectItem", [HT, Ig] = Fl(Vi), qg = d.forwardRef((l, i) => {
  const { __scopeSelect: r, value: u, disabled: s = false, textValue: f, ...m } = l, h = xa(Vi, r), y = Ca(Vi, r), g = h.value === u, [b, v] = d.useState(f ?? ""), [C, w] = d.useState(false), O = he(i, (N) => {
    var _a2;
  ...
  return E.jsx(HT, { scope: r, value: u, disabled: s, textId: x, isSelected: g, onItemTextChange: d.useCallback((N) => {
    v((j) => j || ((N == null ? void 0 : N.textContent) ?? "").trim());
  }, []), children: E.jsx(nu.ItemSlot, { scope: r, value: u, disabled: s, textValue: b, children: E.jsx(ue.div, { role: "option", "aria-labelledby": x, "data-highlighted": C ? "" : void 0, "aria-selected": g && C, "data-state": g ? "checked" : "unchecked", "aria-disabled": s || void 0, "data-disabled": s ? "" : void 0, tabIndex: s ? void 0 : -1, ...m, ref: O, onFocus: W(m.onFocus, () => w(true)), onBlur: W(m.onBlur, () => w(false)), onClick: W(m.onClick, () => {
    T.current !== "mouse" && M();
    ...
    var _a2;
    ((_a2 = y.searchRef) == null ? void 0 : _a2.current) !== "" && N.key === " " || (ET.includes(N.key) && M(), N.key === " " && N.preventDefault());
  }) }) }) });
});
qg.displayName = Vi;
...
var QT = d.forwardRef((l, i) => {
  ...
  const { __scopeRovingFocusGroup: r, focusable: u = true, active: s = false, tabStopId: f, children: m, ...h } = l, y = Xe(), g = f || y, b = kT(ny, r), v = b.currentTabStopId === g, C = ey(r), { onFocusableItemAdd: w, onFocusableItemRemove: O, currentTabStopId: x } = b;
  return d.useEffect(() => {
    if (u) return w(), () => O();
  }, [u, w, O]), E.jsx(rf.ItemSlot, { scope: r, id: g, focusable: u, active: s, children: E.jsx(ue.span, { tabIndex: v ? 0 : -1, "data-orientation": b.orientation, ...h, ref: i, onMouseDown: W(l.onMouseDown, (T) => {
...
var vy = "CheckboxTrigger", hy = d.forwardRef(({ __scopeCheckbox: l, onKeyDown: i, onClick: r, ...u }, s) => {
  const { control: f, value: m, disabled: h, checked: y, required: g, setControl: b, setChecked: v, hasConsumerStoppedPropagationRef: C, isFormControl: w, bubbleInput: O } = Df(vy, l), x = he(s, b), T = d.useRef(y);
  return d.useEffect(() => {
...
var yy = "CheckboxBubbleInput", by = d.forwardRef(({ __scopeCheckbox: l, ...i }, r) => {
  const { control: u, hasConsumerStoppedPropagationRef: s, checked: f, defaultChecked: m, required: h, disabled: y, name: g, value: b, form: v, bubbleInput: C, setBubbleInput: w } = Df(yy, l), O = he(r, w), x = tu(f), T = Ji(u);
  d.useEffect(() => {
    const N = C;
    if (!N) return;
...
var [iu] = pt("Tooltip", [Ea]), Of = Ea(), Ey = "TooltipProvider", i_ = 700, Eh = "tooltip.open", [u_, xy] = iu(Ey), Cy = (l) => {
...
var Ty = "Tooltip", [JM, uu] = iu(Ty), uf = "TooltipTrigger", c_ = d.forwardRef((l, i) => {
  const { __scopeTooltip: r, ...u } = l, s = uu(uf, r), f = xy(uf, r), m = Of(r), h = d.useRef(null), y = he(i, h, s.onTriggerChange), g = d.useRef(false), b = d.useRef(false), v = d.useCallback(() => g.current = false, []);
...
var s_ = "TooltipPortal", [FM, f_] = iu(s_, { forceMount: void 0 }), Ql = "TooltipContent", d_ = d.forwardRef((l, i) => {
  ...
  const r = uu(Ql, l.__scopeTooltip), u = xy(Ql, l.__scopeTooltip), s = d.useRef(null), f = he(i, s), [m, h] = d.useState(null), { trigger: y, onClose: g } = r, b = s.current, { onPointerInTransitChange: v } = u, C = d.useCallback(() => {
    ...
    const T = O.currentTarget, M = { x: O.clientX, y: O.clientY }, N = y_(M, T.getBoundingClientRect()), j = b_(M, N), Y = S_(x.getBoundingClientRect()), $ = x_([...j, ...Y]);
    h($), v(true);
  }, [v]);
  return d.useEffect(() => () => C(), [C]), d.useEffect(() => {
    ...
    if (m) {
      const O = (x) => {
        const T = x.target, M = { x: x.clientX, y: x.clientY }, N = (y == null ? void 0 : y.contains(T)) || (b == null ? void 0 : b.contains(T)), j = !E_(M, m);
        N ? C() : j && (C(), g());
      };
  ...
  const { __scopeTooltip: r, children: u, "aria-label": s, onEscapeKeyDown: f, onPointerDownOutside: m, ...h } = l, y = uu(Ql, r), g = Of(r), { onClose: b } = y;
...
var Ry = "TooltipArrow", g_ = d.forwardRef((l, i) => {
  const { __scopeTooltip: r, ...u } = l, s = Of(r);
...
var WM = Cy, cf = ["Enter", " "], T_ = ["ArrowDown", "PageUp", "Home"], Ay = ["ArrowUp", "PageDown", "End"], __ = [...T_, ...Ay], R_ = { ltr: [...cf, "ArrowRight"], rtl: [...cf, "ArrowLeft"] }, A_ = { ltr: ["ArrowLeft"], rtl: ["ArrowRight"] }, sr = "Menu", [tr, M_, w_] = Jl(sr), [el, Nf] = pt(sr, [w_, Ea, Wl]), fr = Ea(), My = Wl(), [wy, Ta] = el(sr), [D_, dr] = el(sr), Dy = (l) => {
...
Dy.displayName = sr;
var O_ = "MenuAnchor", zf = d.forwardRef((l, i) => {
  const { __scopeMenu: r, ...u } = l, s = fr(r);
  return E.jsx(ur, { ...s, ...u, ref: i });
});
zf.displayName = O_;
var jf = "MenuPortal", [N_, Oy] = el(jf, { forceMount: void 0 }), Ny = (l) => {
  const { __scopeMenu: i, forceMount: r, children: u, container: s } = l, f = Ta(jf, i);
  return E.jsx(N_, { scope: i, forceMount: r, children: E.jsx(Ut, { present: r || f.open, children: E.jsx(rr, { asChild: true, container: s, children: u }) }) });
};
Ny.displayName = jf;
var en = "MenuContent", [z_, Uf] = el(en), zy = d.forwardRef((l, i) => {
  const r = Oy(en, l.__scopeMenu), { forceMount: u = r.forceMount, ...s } = l, f = Ta(en, l.__scopeMenu), m = dr(en, l.__scopeMenu);
  ...
  const { __scopeMenu: r, loop: u = false, trapFocus: s, onOpenAutoFocus: f, onCloseAutoFocus: m, disableOutsidePointerEvents: h, onEntryFocus: y, onEscapeKeyDown: g, onPointerDownOutside: b, onFocusOutside: v, onInteractOutside: C, onDismiss: w, disableOutsideScroll: O, ...x } = l, T = Ta(en, r), M = dr(en, r), N = fr(r), j = My(r), Y = M_(r), [$, J] = d.useState(null), V = d.useRef(null), ae = he(i, V, T.onContentChange), ye = d.useRef(0), me = d.useRef(""), ce = d.useRef(0), de = d.useRef(null), pe = d.useRef("right"), be = d.useRef(0), Se = O ? ir : d.Fragment, I = O ? { as: B_, allowPinchZoom: true } : void 0, ee = (ne) => {
    var _a2, _b2;
  ...
  }), preventScrollOnEntryFocus: true, children: E.jsx(Wi, { role: "menu", "aria-orientation": "vertical", "data-state": $y(T.open), "data-radix-menu-content": "", dir: M.dir, ...N, ...x, ref: ae, style: { outline: "none", ...x.style }, onKeyDown: W(x.onKeyDown, (ne) => {
...
var Uy = d.forwardRef((l, i) => {
  ...
  }, [f.children]), E.jsx(tr.ItemSlot, { scope: r, disabled: u, textValue: s ?? C, children: E.jsx(Mf, { asChild: true, ...h, focusable: !u, children: E.jsx(ue.div, { role: "menuitem", "data-highlighted": b ? "" : void 0, "aria-disabled": u || void 0, "data-disabled": u ? "" : void 0, ...f, ref: g, onPointerMove: W(l.onPointerMove, nr((O) => {
...
var Qy = "MenuSubContent", Zy = d.forwardRef((l, i) => {
  const r = Oy(en, l.__scopeMenu), { forceMount: u = r.forceMount, ...s } = l, f = Ta(en, l.__scopeMenu), m = dr(en, l.__scopeMenu), h = Xy(Qy, l.__scopeMenu), y = d.useRef(null), g = he(i, y);
...
var Jy = Dy, Fy = zf, Wy = Ny, e0 = zy, t0 = Hf, n0 = jy, a0 = cu, l0 = By, o0 = Ly, r0 = Yy, i0 = Iy, u0 = qy, c0 = Ky, J_ = Py, s0 = ky, f0 = Zy, pr = "Menubar", [sf, F_, W_] = Jl(pr), [d0] = pt(pr, [W_, Wl]), gt = Nf(), p0 = Wl(), [eR, Vf] = d0(pr), m0 = d.forwardRef((l, i) => {
  const { __scopeMenubar: r, value: u, onValueChange: s, defaultValue: f, loop: m = true, dir: h, ...y } = l, g = Wa(h), b = p0(r), [v, C] = xt({ prop: u, onChange: s, defaultProp: f ?? "", caller: pr }), [w, O] = d.useState(null);
  return E.jsx(eR, { scope: r, value: v, onMenuOpen: d.useCallback((x) => {
    C(x), O(x);
  }, [C]), onMenuClose: d.useCallback(() => C(""), [C]), onMenuToggle: d.useCallback((x) => {
    C((T) => T ? "" : x), O(x);
  }, [C]), dir: g, loop: m, children: E.jsx(sf.Provider, { scope: r, children: E.jsx(sf.Slot, { scope: r, children: E.jsx(Af, { asChild: true, ...b, orientation: "horizontal", loop: m, dir: g, currentTabStopId: w, onCurrentTabStopIdChange: O, children: E.jsx(ue.div, { role: "menubar", ...y, ref: i }) }) }) }) });
});
m0.displayName = pr;
...
var ew = m0, tw = h0, nw = g0, aw = y0, lw = b0, ow = S0, rw = E0, iw = x0, uw = C0, cw = T0, sw = _0, fw = A0, dw = M0, pw = w0, D0 = "AlertDialog", [yR] = pt(D0, [Qh]), In = Qh(), O0 = (l) => {
  const { __scopeAlertDialog: i, ...r } = l, u = In(i);
  return E.jsx(sg, { ...u, ...r, modal: true });
};
O0.displayName = D0;
var bR = "AlertDialogTrigger", N0 = d.forwardRef((l, i) => {
...
}, mw = O0, vw = N0, hw = z0, gw = j0, yw = U0, bw = Y0, Sw = I0, Ew = H0, xw = G0;
...
let Th = Object.is, wR = (l, i) => new Proxy(l, i), DR = AR, OR = q0, NR = MR;
function zR(l = {}) {
...
var vf = "SliderThumb", tb = d.forwardRef((l, i) => {
  ...
  const { __scopeSlider: r, index: u, name: s, ...f } = l, m = fu(vf, r), h = $0(vf, r), [y, g] = d.useState(null), b = he(i, (N) => g(N)), v = y ? m.form || !!y.closest("form") : true, C = Ji(y), w = m.values[u], O = w === void 0 ? 0 : ab(w, m.min, m.max), x = kR(u, m.values.length), T = C == null ? void 0 : C[h.size], M = T ? ZR(T, O, h.direction) : 0;
  return d.useEffect(() => {
...
var TA = Qa("PopoverContent.RemoveScroll"), _A = d.forwardRef((l, i) => {
  ...
  return d.useEffect(() => {
    const m = u.current;
    if (m) return ki(m);
  }, []), E.jsx(ir, { as: TA, allowPinchZoom: true, children: E.jsx(Nb, { ...l, ref: s, trapFocus: r.open, disableOutsidePointerEvents: true, onCloseAutoFocus: W(l.onCloseAutoFocus, (m) => {
    var _a2;
...
var WA = { position: "absolute", width: "1px", height: "1px", padding: "0", margin: "-1px", overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0" }, yu = "DropdownMenu", [eM] = pt(yu, [Nf]), Ct = Nf(), [tM, qb] = eM(yu), Kb = (l) => {
