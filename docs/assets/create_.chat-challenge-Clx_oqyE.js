import { D as V, r as m, E as P, u as C, j as e } from "./react-BPCshYXX.js";
import { f as A } from "./@tanstack-BuNX36FW.js";
import { B as g } from "./button-CKyQl8ny.js";
import { T as R } from "./textarea-Dc_MpBxB.js";
import { C as $, a as K, b as Y, d as H } from "./card-B79febki.js";
import { B as M } from "./badge-b3CWeD_H.js";
import { c as G } from "./shadcn-utils-BMZD7_jZ.js";
import { n as b } from "./id-OxPLOBIU.js";
import { b as q, m as W } from "./db-master-xI8DZi24.js";
import { _ as L, o as I, n as D, s as _, b as Q, a as X, l as Z } from "./zod-fbN9ubnj.js";
import { u as ee } from "./useLLM-CCvhQGvi.js";
import { A as te, v as O, c as J, R as U, _ as se, P as ne, D as ae } from "./icons-BpfK1DnB.js";
...
function he() {
  ...
  const c = ((_a = o.currentSession) == null ? void 0 : _a.modeState.currentUIState) ?? "idle", p = ie[c], i = ((_b = o.currentSession) == null ? void 0 : _b.modeState.messages) ?? [], a = (_c = o.currentSession) == null ? void 0 : _c.modeState.generatedJson, h = m.useCallback(async () => {
    ...
    if (a) try {
      ...
      await W.challenges.add(s), C.success(`\u6311\u6218 ${s.name} \u5DF2\u6DFB\u52A0\u5230\u5E7F\u573A`), t.setUIState("completed"), n({ to: "/plaza/challenges" });
    } catch (s) {
