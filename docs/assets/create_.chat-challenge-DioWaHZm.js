import{y as V,r as m,u as P,t as C,j as e}from"./react-BwrVEnbn.js";import{f as A}from"./@tanstack-DHpjEvx5.js";import{B as g}from"./button-DfQJxXN9.js";import{T as R}from"./textarea-sQNmV-G1.js";import{C as $,a as K,b as Y,d as H}from"./card-a5yXWtxZ.js";import{B as M}from"./badge-BTwyrS6y.js";import{c as G}from"./shadcn-utils-Cnr6N47i.js";import{n as b}from"./id-BY9c7rfI.js";import{f as q,m as W}from"./db-master-CvVq9mNL.js";import{_ as L,o as I,n as D,s as _,c as Q,b as X,l as Z}from"./zod-BOL00Oce.js";import{u as ee}from"./useLLM-B4c3CpN5.js";import{A as te,a4 as O,c as J,R as U,S as se,P as ne,a3 as ae}from"./icons-0flmCaj9.js";import"./vendor-Btzk85e_.js";import"./formatting-Cgd9k2rU.js";import"./@radix-ui-BQCqNqg0.js";import"./immer-BCQU3qJI.js";import"./dexie-C4f2dvgg.js";import"./components-and-styling-lnR2ABT4.js";import"./@tailwind-CPcsbTWB.js";import"./analytics-DsuSsh9n.js";import"./app-configurations-CSzDTqfg.js";import"./clarity-CFmzqZLM.js";import"./nex-tavern-uuid-BRGLU0IZ.js";import"./global-llm-config.store-CMShswv9.js";import"./es-toolkit-9bjl2JfA.js";const re=L(["idle","interview_running","interview_waiting","description_generating","description_confirming","json_generating","json_editing","json_confirmed","completed"]),ie={idle:{label:"开始",placeholder:"描述一下你想创建的挑战吧...",inputEnabled:!0},interview_running:{label:"助理回复中",placeholder:"助理正在思考...",inputEnabled:!1},interview_waiting:{label:"继续描述",placeholder:"继续描述你的挑战，或回答助理的问题...",inputEnabled:!0},description_generating:{label:"生成设计中",placeholder:"正在整理挑战设计...",inputEnabled:!1},description_confirming:{label:"确认设计",placeholder:"确认设计无误，或告诉我需要修改的地方...",inputEnabled:!0},json_generating:{label:"生成挑战卡中",placeholder:"正在生成挑战卡数据...",inputEnabled:!1},json_editing:{label:"编辑挑战卡",placeholder:"告诉我需要修改的地方，或直接在右侧编辑...",inputEnabled:!0},json_confirmed:{label:"挑战卡已就绪",placeholder:"挑战卡已生成，可以导出或添加到广场",inputEnabled:!1},completed:{label:"完成",placeholder:"挑战卡创建完成！",inputEnabled:!1}},oe=I({id:_().describe("消息ID"),role:L(["user","assistant","system"]).describe("消息角色"),content:_().describe("消息内容"),timestamp:D().describe("时间戳"),messageType:L(["chat","description_summary","json_preview"]).optional().describe("消息类型")}),ce=I({presetHint:_().optional().describe("预设的挑战类型提示"),preselectedCharacterId:_().optional().describe("预选的角色 ID")}),le=I({currentUIState:re.describe("当前 UI 状态"),messages:X(oe).describe("对话历史"),generatedDescription:_().optional().describe("生成的设计总结"),generatedJson:q.optional().describe("生成的挑战卡 JSON"),descriptionConfirmed:Q().default(!1).describe("用户是否已确认设计")});I({id:_().describe("会话ID"),mode:Z("chat-create-challenge").describe("模式标识"),modeConfig:ce.describe("模式配置"),modeState:le.describe("模式状态"),createdAt:D().describe("创建时间"),updatedAt:D().describe("更新时间")});function T(){return{currentUIState:"idle",messages:[],descriptionConfirmed:!1}}const t=V({currentSession:null,isLoading:!1,streamingContent:"",startNewSession(n,o){const r=Date.now(),x={id:`chat-create-chal-${r}`,mode:"chat-create-challenge",modeConfig:{presetHint:n,preselectedCharacterId:o},modeState:T(),createdAt:r,updatedAt:r};return this.currentSession=x,this.isLoading=!1,this.streamingContent="",x},getState(){return this.currentSession?.modeState??null},getMessages(){return this.currentSession?.modeState.messages??[]},addUserMessage(n){const o={id:b(),role:"user",content:n,timestamp:Date.now(),messageType:"chat"};return this.currentSession&&(this.currentSession.modeState.messages.push(o),this.currentSession.updatedAt=Date.now()),o},addAssistantMessage(n,o="chat"){const r={id:b(),role:"assistant",content:n,timestamp:Date.now(),messageType:o};return this.currentSession&&(this.currentSession.modeState.messages.push(r),this.currentSession.updatedAt=Date.now()),r},setUIState(n){this.currentSession&&(this.currentSession.modeState.currentUIState=n,this.currentSession.updatedAt=Date.now())},setGeneratedDescription(n){this.currentSession&&(this.currentSession.modeState.generatedDescription=n,this.currentSession.updatedAt=Date.now())},setGeneratedJson(n){this.currentSession&&(this.currentSession.modeState.generatedJson=n,this.currentSession.updatedAt=Date.now())},updateGeneratedJsonField(n,o){this.currentSession?.modeState.generatedJson&&(this.currentSession.modeState.generatedJson[n]=o,this.currentSession.updatedAt=Date.now())},setDescriptionConfirmed(n){this.currentSession&&(this.currentSession.modeState.descriptionConfirmed=n,this.currentSession.updatedAt=Date.now())},setLoading(n){this.isLoading=n},setStreamingContent(n){this.streamingContent=n},clearStreamingContent(){this.streamingContent=""},endSession(){this.currentSession=null,this.isLoading=!1,this.streamingContent=""},resetSession(){this.currentSession&&(this.currentSession.modeState=T(),this.currentSession.updatedAt=Date.now()),this.isLoading=!1,this.streamingContent=""}}),de=`你是一位专业的挑战设计顾问。你的任务是通过对话引导用户创建一个挑战卡。
