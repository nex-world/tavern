...
import { j as ct, m as Ce, S as lt } from "./db-master-eAmex8rT.js";
import { k as ie, m as ce, j as dt } from "./@tanstack-Bc2-Ej4a.js";
import { _ as mt, __tla as __tla_0 } from "./index-DNgj8bwD.js";
import { C as pt, A as ut } from "./AutoScrollDownArea-cUzgyL9F.js";
import { S as ht } from "./session-manager.class-jV90p7NY.js";
        ...
        async updateSessionInDB () {
            if (o.currentSession) try {
                const { masterDb: t } = await mt(async ()=>{
                    const { masterDb: r } = await import("./db-master-eAmex8rT.js").then((a)=>a.A);
                    return {
                        masterDb: r
                    };
