...
import { F as fe, ak as ot, D as Ie, aH as _e, r as T, u as C, j as e, E as Y } from "./react-BPCshYXX.js";
import { r as it, m as je, S as ct } from "./db-master-xI8DZi24.js";
import { k as ae, m as oe, i as lt } from "./@tanstack-BuNX36FW.js";
import { _ as dt, __tla as __tla_0 } from "./index-Ni0JwIOS.js";
import { C as mt } from "./context-manager.class-DV_N9RL3.js";
import { S as pt } from "./session-manager.class-9OcQVs3g.js";
...
import { D as xt } from "./dexie-DOn8o3hw.js";
import { B as j } from "./button-CKyQl8ny.js";
import { u as se, a as q } from "./global-llm-config.store-B8jg895c.js";
import { T as G } from "./textarea-Dc_MpBxB.js";
import { L as W } from "./label-DxXosFPV.js";
import { l as Ce } from "./formatting-8HslT92O.js";
import { D as gt, a as _t, b as ft, c as wt, d as St, e as yt } from "./dialog-CbwgCfJB.js";
import { v as z, L as H, P as Nt, ar as vt, as as he, g as bt, a6 as It, at as jt, aa as De, au as $, W as F, ac as Te, E as Ct, R as $e, q as ie, ai as we, o as Tt, D as At, ak as Ae } from "./icons-BpfK1DnB.js";
import { I as ke } from "./input-Dje6SeH9.js";
import { C as O } from "./card-B79febki.js";
import { C as kt } from "./CharacterAvatar-DwtbYeXp.js";
import { S as Ee, a as Me, b as Pe, c as Oe, d as de } from "./select-CgkKzHrj.js";
...
- \u6709\u89C6\u89C9\u51B2\u51FB\u529B
`.trim(), A = {
    WORLDVIEW_GENERATION: Et,
    WORLDVIEW_FIELD: Mt,
    CHARACTERS_BATCH_GENERATION: Pt,
    SINGLE_CHARACTER_GENERATION: Ot,
    CHARACTER_ENHANCEMENT: Rt,
    THEME_GENERATION: Dt,
    THEME_ANALYSIS: $t,
    PLOT_GENERATION_TEMPLATE: Lt,
    PLOT_GENERATION_FREE: Ut,
    PLOT_OPTIMIZATION: Bt,
    CHAPTER_OUTLINE_GENERATION: Ft,
    CHAPTER_OUTLINE_OPTIMIZATION: Ht,
    DESIGN_REVIEW: Wt,
    CHAPTER_PREP_REVIEW: Gt,
    INTEREST_ANALYSIS: Yt,
    EMOTION_DESIGN: zt,
    CHAPTER_PLAN_GENERATION: Kt,
    BLOCK_WRITE_DIRECT: Vt,
    BLOCK_WRITE_GUIDED: qt,
    INSTRUCTION_SUGGESTION: Jt,
    BLOCK_POLISH: Zt,
    WRITING_HINT: Xt,
    CONTENT_EXPANSION: Qt,
    BLOCK_WRITE_ROLEPLAY: es,
    ACTION_SUGGESTION: ts,
    BLOCK_EVALUATION: ss,
    IMPROVEMENT_SUGGESTIONS: ns,
    AUTO_CORRECTION: rs,
    CHAPTER_EVALUATION: as,
    CHAPTER_IMPROVEMENT_SUGGESTIONS: os,
    CHAPTER_OPTIMIZATION: is,
    CHAPTER_SUMMARY: cs,
    KNOWLEDGE_EXTRACTION: ls,
    COMPLETION_CHECK: ds,
    BOOK_SUMMARY: ms,
    RECOMMENDATION: ps,
    READING_GUIDE: us,
    AUTHOR_NOTE: hs,
    COVER_DESCRIPTION: xs
  };
  function R(t) {
...
\u8BF7\u751F\u6210\u9002\u5408 AI \u7ED8\u753B\u5DE5\u5177\u7684\u5C01\u9762\u63CF\u8FF0\u3002`
  ...
  const Z = {
    makeMessagesForWorldviewGeneration: _s,
    makeMessagesForWorldviewField: fs,
    makeMessagesForCharactersBatchGeneration: ws,
    makeMessagesForSingleCharacterGeneration: Ss,
    makeMessagesForCharacterEnhancement: ys,
    makeMessagesForThemeGeneration: Ns,
    makeMessagesForThemeAnalysis: vs,
    makeMessagesForPlotGenerationWithTemplate: bs,
    makeMessagesForPlotGenerationFree: Is,
    makeMessagesForPlotOptimization: js,
    makeMessagesForChapterOutlineGeneration: Cs,
    makeMessagesForChapterOutlineOptimization: Ts,
    ...
    makeMessagesForInstructionSuggestion: As,
    makeMessagesForBlockPolish: Ye,
    makeMessagesForWritingHint: ks,
    makeMessagesForContentExpansion: Es,
    makeMessagesForBlockWriteRoleplay: ze,
    makeMessagesForActionSuggestion: Ms,
    makeMessagesForBlockEvaluation: Ps,
    makeMessagesForImprovementSuggestions: Os,
    makeMessagesForAutoCorrection: Rs,
    makeMessagesForChapterEvaluation: Ds,
    makeMessagesForChapterImprovementSuggestions: $s,
    makeMessagesForChapterOptimization: Ls,
  ...
  class Vs {
    ...
    initDatabase() {
      ...
      return s || (s = Ks(this.projectId), Re.set(this.projectId, s)), s;
    }
    getTable(s) {
    ...
    async loadSession(t) {
      ...
      try {
        ...
        if (o.currentSession) {
          ...
          const g = new Us(o.currentSession, s);
    ...
    async updateSessionInDB() {
      if (o.currentSession) try {
        const { masterDb: t } = await dt(async () => {
          const { masterDb: r } = await import("./db-master-xI8DZi24.js").then((a) => a.t);
          return {
            masterDb: r
          };
...
`).filter(Boolean);
    ...
    function i(d) {
      ...
      }, v = d.match(/世界观完整性[：:]\s*(\d+)/), S = d.match(/角色设计合理性[：:]\s*(\d+)/), u = d.match(/主题深度[：:]\s*(\d+)/), h = d.match(/情节逻辑[：:]\s*(\d+)/), m = d.match(/大纲可行性[：:]\s*(\d+)/), _ = d.match(/综合评分[：:]?\s*(\d+(\.\d+)?)/);
...
`).filter((h) => h.trim().startsWith("{")), v = [], S = [], u = [];
  ...
  const qs = U([
    ...
    avatar: f().optional().describe("\u89D2\u8272\u5934\u50CF URI \u6216 Base64"),
    ...
    keyPlots: L(sn).describe("\u5173\u952E\u60C5\u8282\u70B9\u5217\u8868"),
    ...
    entities: L(ln).describe("\u5B9E\u4F53\u5217\u8868"),
    events: L(dn).describe("\u4E8B\u4EF6\u5217\u8868"),
    rules: L(mn).describe("\u89C4\u5219\u5217\u8868")
  }), un = M({
    id: f().describe("\u5206\u5757 ID"),
    content: f().describe("\u5206\u5757\u5185\u5BB9"),
    wordCount: I().describe("\u5B57\u6570"),
    writeMode: Xs.describe("\u5199\u4F5C\u6A21\u5F0F"),
  ...
  const xn = M({
    ...
    worldview: Qs.optional().describe("\u4E16\u754C\u89C2"),
    keyCharacters: L(en).describe("\u5173\u952E\u89D2\u8272\u5217\u8868"),
    theme: tn.optional().describe("\u4E3B\u9898"),
    plotOutline: nn.optional().describe("\u60C5\u8282\u8109\u7EDC"),
    chapterOutline: L(rn).optional().describe("\u7AE0\u8282\u5927\u7EB2"),
    hasOutline: ue().default(false).describe("\u662F\u5426\u6709\u5927\u7EB2")
  }), gn = M({
    currentPhase: qs.describe("\u5F53\u524D\u9636\u6BB5"),
    currentUIState: Js.describe("\u5F53\u524D UI \u72B6\u6001"),
    ...
    currentChapter: hn.optional().describe("\u5F53\u524D\u7AE0\u8282"),
    progressTracking: M({
      ...
      currentInterestPoints: L(an).describe("\u5F53\u524D\u5174\u8DA3\u70B9"),
      emotionSequence: L(on).describe("\u60C5\u7EEA\u5E8F\u5217"),
      foreshadows: L(cn).describe("\u4F0F\u7B14\u5217\u8868")
    }).describe("\u8FDB\u5EA6\u8FFD\u8E2A"),
    knowledgeBase: pn.describe("\u77E5\u8BC6\u5E93"),
  ...
  it.extend({
    ...
    modeConfig: xn.describe("Novel Writing \u6A21\u5F0F\u914D\u7F6E"),
    modeState: gn.describe("Novel Writing \u6A21\u5F0F\u72B6\u6001")
  });
  function _n(t) {
    return t.trim().replace(/<think>[\s\S]*<\/think>/g, "").trim().replace(/^[\s]*```[^\n]*|```[\s]*$/g, "").trim();
  }
  let ve, pe, fn, wn, Sn, yn, Nn, vn, bn, In, jn, Cn, Tn, An, kn;
  ve = (t) => {
    const s = _n(t);
    try {
      return Ce.parse(s);
...
` : "") + m
  ...
  wn = ({ character: t, onUpdate: s, onRemove: n, onExport: r, onEnhance: a, isEnhancing: i }) => {
...
`), m = [];
      let _ = null;
      h.forEach((N) => {
        const b = N.trim(), E = b.match(/^#+\s*第?(\d+)[章节][\s:：]*(.*)/);
        E ? (_ && m.push(_), _ = {
          id: k(),
...
`)) || "")
  ...
  rr = (t) => {
    ...
    const d = o.sessionManager && o.contextManager ? o.sessionManager.getActualCurrentUIState(o.contextManager) : ((_b = (_a = l.currentSession) == null ? void 0 : _a.modeState) == null ? void 0 : _b.currentUIState) || "idle", c = (_d = (_c = l.currentSession) == null ? void 0 : _c.modeState) == null ? void 0 : _d.currentPhase, v = Zs[d], S = () => c ? c.startsWith("design_") ? e.jsx(bn, {
      sessionId: t.sessionId
    }) : c === "ai_review" || c === "user_revision" ? e.jsx(In, {
      sessionId: t.sessionId
    }) : c.startsWith("chapter_") || c.startsWith("block_") || c === "re_planning_check" || c === "knowledge_update" ? e.jsx(An, {
      sessionId: t.sessionId
    }) : c === "completion_check" || c.includes("_generation") || c === "completed" ? e.jsx(kn, {
      sessionId: t.sessionId
    }) : null : null;
    return e.jsxs("div", {
...
export {
  rr as SessionMainForNovelWriting,
  __tla
};
