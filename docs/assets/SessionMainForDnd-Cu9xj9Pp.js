...
import { al as ee, a6 as K, aI as _e, r as j, u as V, v as be, j as e } from "./react-gFHNOnf5.js";
import { f as re, i as ye } from "./@tanstack-DDpiKjUN.js";
import { r as Se, S as Ce, m as Ne } from "./db-master-DI3V0061.js";
import { s as ke } from "./db-BmpCv5B4.js";
import { _ as te, __tla as __tla_0 } from "./index-7c6pKJ8J.js";
import { C as De } from "./context-manager.class-BTc8g_cx.js";
import { n as P } from "./id-OxPLOBIU.js";
import { S as je } from "./session-manager.class-z-y1oVSb.js";
import { B as v } from "./button-D3G-RLOw.js";
import { T as Ie } from "./textarea-DqdRyzs9.js";
import { B as H } from "./badge-C9CmQsZA.js";
import { u as we, a as Me } from "./global-llm-config.store-BYX0tcdb.js";
import { o as $, n as S, s as _, _ as X, c as oe, a as ve, r as Pe, l as $e } from "./zod-DPWJ_A9_.js";
import { c as N } from "./shadcn-utils-BMZD7_jZ.js";
import { S as Te } from "./switch-D6eVMgf5.js";
import { C as ie } from "./CharacterAvatar-TKrkqhhW.js";
import { an as W, t as Q, ap as Re, aq as Le, Q as Z, a7 as Ee, p as Ue, a8 as Ae, ar as He, f as Fe, a6 as ce, as as Be, at as Oe, u as Ge } from "./icons-CW-0NDo_.js";
...
let __tla = Promise.all([
  ...
  const We = /<think>([\s\S]*?)<\/think>/, Qe = /<speak>([\s\S]*?)<\/speak>/, Ze = /<action>([\s\S]*?)<\/action>/;
  function le(a) {
    var _a, _b, _c, _d, _e2, _f;
    const n = Ke(a), t = (_b = (_a = n.match(We)) == null ? void 0 : _a[1]) == null ? void 0 : _b.trim(), r = (_d = (_c = n.match(Qe)) == null ? void 0 : _c[1]) == null ? void 0 : _d.trim(), o = (_f = (_e2 = n.match(Ze)) == null ? void 0 : _e2[1]) == null ? void 0 : _f.trim(), s = n.replace(/<\/?[a-zA-Z]\w*[^>]*>/g, "").trim();
    return {
      think: t,
      speak: r,
      action: o,
...
`);
  ...
  const m = ee({
    ...
    async saveNewContextItemsToDB(a, n) {
      const { SessionDB: t } = await te(async () => {
        const { SessionDB: s } = await import("./db-master-DI3V0061.js").then((i) => i.s);
        return {
          SessionDB: s
        };
    ...
    async updateSessionInDB() {
      ...
      const { masterDb: a } = await te(async () => {
        const { masterDb: r } = await import("./db-master-DI3V0061.js").then((o) => o.t);
        return {
          masterDb: r
        };
      }, __vite__mapDeps([0,1,2,3,4,5,6,7])), n = K(this.currentSession.modeState), t = K(this.currentSession.modeConfig);
  ...
  function dt() {
    const a = we((u) => u.config), n = j.useRef(false), t = j.useRef(false), r = re(), o = async (u, g, f, l, x = {}) => {
      ...
      let z = "";
      return await Me(u, g, [], (q, L) => {
        l == null ? void 0 : l(q), z = L;
      ...
      try {
        ...
        console.error("[DndLoop] Critical Error:", l), V.error("LLM \u8C03\u7528\u5931\u8D25\uFF0C\u8BF7\u524D\u5F80 LLM \u914D\u7F6E\u9875\u9762\u8FDB\u884C\u914D\u7F6E", {
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsx(Ie, {
                      ...
                      onKeyDown: (c) => {
                        c.key === "Enter" && !c.shiftKey && (c.preventDefault(), q());
                      }
                    }),
                    e.jsx(v, {
                      type: "button",
  ...
  yt = ({ item: a, participants: n }) => {
    ...
    switch (a.type) {
      ...
      case "participant_message":
        return ((_a = a.data) == null ? void 0 : _a.isDM) ? e.jsx(J, {
          content: a.data.content
        }) : e.jsx(ae, {
          item: a,
          participants: n
      ...
      default:
        return ((_b = a.data) == null ? void 0 : _b.content) ? e.jsx(J, {
          content: a.data.content,
          title: "\u6D88\u606F"
        }) : null;
    }
  };
  J = ({ content: a, title: n = "Dungeon Master" }) => {
    const t = le(a);
    return e.jsxs("div", {
