...
import { D as O, a as E, b as U, c as G, d as K, e as W } from "./dialog-v6BqSj-g.js";
import { B as h } from "./button-CMoAlsw3.js";
import { f as X } from "./@tanstack-3iyDWv8L.js";
import { c as N } from "./llm-readiness-DgR8F2ee.js";
import { ah as q, C as v, N as H, J as y, af as J, I as P, h as Q, m as V, ai as Y, q as Z, ae as z, A as ee, y as se } from "./icons-bBaH0MBC.js";
...
const oe = ({ config: s, onChange: n, character: t }) => {
  ...
  return e.jsxs("div", { className: "space-y-6", children: [e.jsxs("div", { className: "space-y-2", children: [e.jsxs("h3", { className: "text-lg font-bold flex items-center gap-2", children: [e.jsx(J, { className: "w-5 h-5 text-primary" }), "\u804A\u5929\u4F1A\u8BDD\u914D\u7F6E"] }), e.jsxs("p", { className: "text-sm text-muted-foreground", children: ["\u914D\u7F6E\u672C\u6B21\u4E0E ", e.jsx("span", { className: "font-medium text-foreground", children: t.name }), " \u7684\u804A\u5929\u4F1A\u8BDD\u53C2\u6570\u3002"] })] }), e.jsxs("div", { className: "space-y-2", children: [e.jsx(b, { htmlFor: r, className: "text-sm font-medium", children: "\u4F60\u7684\u540D\u79F0" }), e.jsx(te, { id: r, value: s.userName, onChange: (a) => n({ ...s, userName: a.target.value }), placeholder: "\u8F93\u5165\u4F60\u5728\u5BF9\u8BDD\u4E2D\u7684\u540D\u79F0...", className: "max-w-xs" }), e.jsx("p", { className: "text-xs text-muted-foreground", children: "\u89D2\u8272\u5728\u5BF9\u8BDD\u4E2D\u5982\u4F55\u79F0\u547C\u4F60\u3002" })] }), i && e.jsxs("div", { className: "flex items-start gap-3 p-3 rounded-xl bg-muted/50 border border-muted", children: [e.jsx(P, { className: "w-4 h-4 text-muted-foreground shrink-0 mt-0.5" }), e.jsxs("div", { className: "text-xs text-muted-foreground space-y-1", children: [e.jsx("p", { className: "font-medium", children: "\u8BE5\u89D2\u8272\u81EA\u5E26\u7CFB\u7EDF\u63D0\u793A\u8BCD" }), e.jsx("p", { className: "line-clamp-2 italic", children: t.system_prompt })] })] }), e.jsxs(ne, { children: [e.jsxs(ie, { className: "flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors group w-full", children: [e.jsx(Q, { className: "w-4 h-4 transition-transform group-data-[state=open]:rotate-180" }), "\u9AD8\u7EA7\u914D\u7F6E"] }), e.jsx(le, { className: "pt-4 space-y-4", children: e.jsxs("div", { className: "space-y-2", children: [e.jsx(b, { htmlFor: l, className: "text-sm font-medium", children: "\u9644\u52A0\u7CFB\u7EDF\u63D0\u793A\u8BCD" }), e.jsx(ae, { id: l, value: s.globalSystemPrompt, onChange: (a) => n({ ...s, globalSystemPrompt: a.target.value }), placeholder: "\u8F93\u5165\u989D\u5916\u7684\u7CFB\u7EDF\u63D0\u793A\u8BCD\uFF0C\u5C06\u8FFD\u52A0\u5230\u89D2\u8272\u5361\u81EA\u5E26\u7684\u63D0\u793A\u8BCD\u4E4B\u540E...", className: "min-h-24 resize-y" }), e.jsx("p", { className: "text-xs text-muted-foreground", children: "\u53EF\u9009\u3002\u7528\u4E8E\u6DFB\u52A0\u989D\u5916\u7684\u89C4\u5219\u6216\u9650\u5236\uFF0C\u5982\u300C\u8BF7\u4F7F\u7528\u4E2D\u6587\u56DE\u590D\u300D\u3002" })] }) })] })] });
...
const Me = ({ open: s, onOpenChange: n, wizardProps: t }) => {
  ...
  return e.jsx(O, { open: s, onOpenChange: L, children: e.jsxs(E, { className: "sm:max-w-lg max-h-[85vh] overflow-y-auto", children: [e.jsxs(U, { children: [e.jsxs(G, { className: "flex items-center gap-2", children: ["\u5F00\u59CB", j] }), e.jsx(K, { children: c == null ? void 0 : c.description })] }), e.jsx("div", { className: "flex items-center gap-2 py-2", children: o.map((d, u) => e.jsxs("div", { className: "flex items-center gap-2", children: [u > 0 && e.jsx("div", { className: "h-px w-6 bg-muted-foreground/20" }), e.jsx("div", { className: `
