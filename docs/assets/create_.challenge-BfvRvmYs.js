import { j as e, r as D, D as X, F as _, E as M, t as q } from "./react-D9TtqY-V.js";
import { f as U } from "./@tanstack-3iyDWv8L.js";
import { B as g } from "./button-CMoAlsw3.js";
import { I as u } from "./input-CtGFdN_9.js";
import { T as b } from "./textarea-NuAUq_bK.js";
import { C as G, d as z, a as Y, b as Z, c as J, e as Q } from "./card-85OZoUtz.js";
import { L as h } from "./label-CBzbyhxK.js";
import { T as W, a as ee, b as y, c as C } from "./tabs-D5XuT8p1.js";
import { S as w, a as T, b as S, c as F, d as N } from "./select-BTDHXfPN.js";
import { B as se } from "./badge-B6qKYUZD.js";
import { P as O, d as P, Y as ae, q as te, N as A, Z as le, _ as ie, I as re, $ as E, a0 as ne, a1 as ce, a2 as oe, m as de, a3 as me, a4 as he, T as xe, X as ue, a5 as pe } from "./icons-bBaH0MBC.js";
import { n as K } from "./id-OxPLOBIU.js";
import { S as je } from "./switch-CGreuh1l.js";
import { m as ge } from "./db-master-BrZHBPj2.js";
...
const ve = ["isTrue", "isFalse", "eq", "neq", "gt", "gte", "lt", "lte", "includes", "has"], B = ["and", "or"], R = (i) => {
  ...
  if (B.includes(d)) {
    const s = r[1];
    return e.jsxs("div", { className: `p-4 border rounded-lg space-y-4 bg-muted/5 ${l > 0 ? "ml-6" : ""}`, children: [e.jsxs("div", { className: "flex items-center justify-between", children: [e.jsxs("div", { className: "flex items-center gap-2", children: [e.jsx(se, { variant: "outline", className: "bg-primary/5", children: "\u590D\u5408\u903B\u8F91" }), e.jsxs(w, { value: d, onValueChange: (c) => v(c), children: [e.jsx(T, { className: "h-8 w-24", children: e.jsx(S, {}) }), e.jsxs(F, { children: [e.jsx(N, { value: "and", children: "\u5E76\u4E14 (AND)" }), e.jsx(N, { value: "or", children: "\u6216\u8005 (OR)" })] })] })] }), e.jsxs("div", { className: "flex gap-2", children: [e.jsx(g, { variant: "outline", size: "sm", className: "h-7 text-[10px]", onClick: () => o([...s[0]]), type: "button", children: "\u8F6C\u4E3A\u5355\u4E00\u6761\u4EF6" }), e.jsxs(g, { variant: "outline", size: "sm", className: "h-7 text-[10px]", onClick: () => o([d, [...s, ["isTrue", p[0] || ""]]]), type: "button", children: [e.jsx(O, { className: "w-3 h-3 mr-1" }), " \u6DFB\u52A0\u5B50\u6761\u4EF6"] })] })] }), e.jsx("div", { className: "space-y-3", children: s.map((c, m) => e.jsxs("div", { className: "relative group", children: [e.jsx(R, { condition: c, variables: n, level: l + 1, onChange: (f) => {
      const I = [...s];
      I[m] = f, o([d, I]);
      ...
      const f = s.filter((I, H) => H !== m);
      f.length === 0 ? v("isTrue") : o([d, f]);
  ...
  return e.jsxs("div", { className: `flex flex-wrap items-center gap-2 p-2 border rounded-md bg-background ${l > 0 ? "ml-6" : ""}`, children: [e.jsxs(w, { value: t, onValueChange: (s) => {
    const c = [...r];
    c[1] = s, o(c);
  }, children: [e.jsx(T, { className: "h-8 w-40 overflow-hidden", children: e.jsx(S, { placeholder: "\u9009\u62E9\u53D8\u91CF" }) }), e.jsx(F, { children: p.map((s) => e.jsx(N, { value: s, children: s }, s)) })] }), e.jsxs(w, { value: d, onValueChange: (s) => v(s), children: [e.jsx(T, { className: "h-8 w-28", children: e.jsx(S, {}) }), e.jsx(F, { children: ve.map((s) => e.jsx(N, { value: s, children: s }, s)) })] }), !["isTrue", "isFalse"].includes(d) && e.jsx(u, { value: String(a ?? ""), onChange: (s) => {
    const c = [...r];
  ...
  const { variables: r, variableConfigs: n, onChange: o } = i, [l, d] = D.useState(""), p = () => {
    ...
    const m = { ...n, [t]: c }, f = { ...r, [t]: { key: t, value: c.initial ?? 0 } };
    o(f, m);
  };
  ...
  i ? (Object.assign(this.formData, { ...i, goals: i.goals || [], failureChecks: i.failureChecks || [], variables: i.variables || {}, tags: i.tags || [], ...i.createdAt ? { createdAt: i.createdAt } : {}, ...i.updatedAt ? { updatedAt: i.updatedAt } : {} }), this.variableConfigs = i.variables || {}) : (Object.assign(this.formData, k), this.variables = { ...V }, this.variableConfigs = { ...$ });
}, resetForm() {
  Object.assign(this.formData, k), this.variables = { ...V }, this.variableConfigs = { ...$ };
}, getFormDataForSave() {
