const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/db-master-BrZHBPj2.js","assets/@tanstack-3iyDWv8L.js","assets/react-D9TtqY-V.js","assets/vendor-C4ToNUTj.js","assets/@radix-ui-BQCqNqg0.js","assets/immer-BCQU3qJI.js","assets/dexie-C2pyTzVO.js","assets/zod-fbN9ubnj.js","assets/PlayerInputItem-Ce2vNpzb.js","assets/id-OxPLOBIU.js","assets/icons-bBaH0MBC.js"])))=>i.map(i=>d[i]);
...
import { s as O } from "./db--eUIPBg3.js";
import { _ as M, __tla as __tla_0 } from "./index-IzUhM_kF.js";
import { n as _ } from "./id-OxPLOBIU.js";
import { C as j } from "./context-manager.class-B2xis078.js";
import { m as z, P, C as E, a as V } from "./PlayerInputItem-Ce2vNpzb.js";
import { B as U } from "./button-CMoAlsw3.js";
import { T as $ } from "./textarea-NuAUq_bK.js";
import { B as T } from "./badge-B6qKYUZD.js";
import { u as K } from "./useLLM-tAU3ECR6.js";
import { E as B, W as Y } from "./icons-bBaH0MBC.js";
...
let __tla = Promise.all([
  ...
  const m = b({
    ...
    async saveNewContextItemsToDB(e, s) {
      const { SessionDB: i } = await M(async () => {
        const { SessionDB: g } = await import("./db-master-BrZHBPj2.js").then((I) => I.s);
        return {
          SessionDB: g
        };
    ...
    const i = K(), n = l.useRef(false), g = H(), I = l.useCallback(async (h) => {
      if (!(n.current || !s || s.getHistoryCount() > 0 || !e)) try {
        ...
        const { makeChatModeStartingContextItems_CN: p } = await M(async () => {
          const { makeChatModeStartingContextItems_CN: d } = await import("./PlayerInputItem-Ce2vNpzb.js").then((r) => r.c);
          return {
      ...
      if (!(n.current || !e || !s)) try {
        ...
        const { makeChatModeLLMMessagesFromContextStateForCharacterId: x } = await M(async () => {
          const { makeChatModeLLMMessagesFromContextStateForCharacterId: u } = await import("./PlayerInputItem-Ce2vNpzb.js").then((w) => w.c);
          return {
  ...
  we = (e) => {
    ...
    const { sendUserMessage: u, initializeChat: w } = Q(o, m.contextManager);
    if (l.useEffect(() => {
      var _a2;
            ...
            children: t.jsxs("div", {
              ...
              children: [
                (() => {
                  ...
                  return c && !a.some((y) => y.id === c.id) && f.push(c), f.map((y, N) => t.jsx(W, {
                    item: y,
                    character: o,
  ...
  W = (e) => {
    switch (e.item.type) {
      ...
      case "character_message_group":
        return t.jsx("div", {
          className: "space-y-4",
          children: (e.item.data.list || []).map((s, i) => t.jsx(E, {
            item: {
              ...e.item,
              type: "character_message",
              data: {
