import { j as e, G as K, H as U, J as A, K as O, _ as p, r as m } from "./react-BPCshYXX.js";
...
import { I as d } from "./input-Dje6SeH9.js";
import { L as v } from "./label-DxXosFPV.js";
import { S as I, a as _, b as V, c as F, d as u } from "./select-CgkKzHrj.js";
...
function de({ config: a, setConfig: t, models: l, isFetchingModels: c, fetchModels: b, customParamList: f, addCustomParam: N, updateCustomParam: x, removeCustomParam: y }) {
  var _a;
  const g = m.useId(), w = m.useId(), [j, C] = m.useState(""), [k, M] = m.useState("string"), [S, P] = m.useState(""), [L, z] = m.useState(false);
