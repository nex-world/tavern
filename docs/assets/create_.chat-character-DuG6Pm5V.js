import { D as V, r as u, E as R, t as C, j as e } from "./react-BQpw03Eg.js";
import { f as T } from "./@tanstack-B4B5CfFY.js";
...
import { P as Q, m as W } from "./db-master-l33tB5ke.js";
import { _ as L, o as k, n as D, s as v, b as q, a as X, l as Z } from "./zod-fbN9ubnj.js";
import { u as ee } from "./useLLM-D0SorjDU.js";
import { A as te, i as U, g as M, R as O, Q as se, P as ne, D as ae } from "./icons-BC63ChG4.js";
...
const t = V({ currentSession: null, isLoading: false, streamingContent: "", startNewSession(s) {
...
} }), de = `\u4F60\u662F\u4E00\u4F4D\u4E13\u4E1A\u7684\u89D2\u8272\u521B\u5EFA\u987E\u95EE\u3002\u4F60\u7684\u4EFB\u52A1\u662F\u901A\u8FC7\u5BF9\u8BDD\u5F15\u5BFC\u7528\u6237\u521B\u5EFA\u4E00\u4E2A AI \u89D2\u8272\u5361\u3002
...
\u5F53\u4F60\u8BA4\u4E3A\u6536\u96C6\u7684\u4FE1\u606F\u8DB3\u591F\u521B\u5EFA\u4E00\u4E2A\u5B8C\u6574\u7684\u89D2\u8272\u65F6\uFF0C\u5728\u56DE\u590D\u7684\u672B\u5C3E\u6DFB\u52A0 [INFO_COMPLETE] \u6807\u8BB0\u3002`, me = `\u6839\u636E\u4E4B\u524D\u7684\u5BF9\u8BDD\u5185\u5BB9\uFF0C\u751F\u6210\u4E00\u4EFD\u5B8C\u6574\u7684\u89D2\u8272\u63CF\u8FF0\u603B\u7ED3\u3002
\u8BF7\u4F7F\u7528\u4EE5\u4E0B\u683C\u5F0F\u8F93\u51FA\uFF1A
...
\u8BF7\u786E\u4FDD\u63CF\u8FF0\u8BE6\u7EC6\u3001\u751F\u52A8\uFF0C\u80FD\u591F\u5B8C\u6574\u5448\u73B0\u8FD9\u4E2A\u89D2\u8272\u7684\u5F62\u8C61\u3002`, ue = `\u6839\u636E\u4E4B\u524D\u7684\u5BF9\u8BDD\u548C\u89D2\u8272\u63CF\u8FF0\uFF0C\u751F\u6210\u4E00\u4E2A\u7B26\u5408\u89C4\u8303\u7684\u89D2\u8272\u5361 JSON\u3002
...
function pe() {
  const s = ee(), r = T(), i = u.useRef(false), b = R(t), _ = u.useCallback(async (d) => {
    if (!(i.current || !t.currentSession)) try {
      ...
      const c = t.getMessages(), h = [{ id: S(), role: "system", content: de }, ...c.map((x) => ({ id: x.id, role: x.role, content: x.content }))];
      let o = "";
    ...
    if (!(i.current || !t.currentSession)) try {
      ...
      const d = t.getMessages(), m = [{ id: S(), role: "system", content: me }, ...d.map((h) => ({ id: h.id, role: h.role, content: h.content })), { id: S(), role: "user", content: "\u8BF7\u6839\u636E\u4EE5\u4E0A\u5BF9\u8BDD\u5185\u5BB9\uFF0C\u751F\u6210\u89D2\u8272\u63CF\u8FF0\u603B\u7ED3\u3002" }];
      let c = "";
    ...
    if (!(i.current || !t.currentSession)) try {
      ...
      const d = t.getMessages(), m = t.currentSession.modeState.generatedDescription, c = [{ id: S(), role: "system", content: ue }, ...d.map((o) => ({ id: o.id, role: o.role, content: o.content }))];
...
function he() {
  var _a, _b, _c, _d;
  const s = T(), r = R(t), { sendMessage: i, generateDescription: b, generateJson: _, confirmJson: j, regenerateJson: f, isLoading: p, streamingContent: w } = pe(), [d, m] = u.useState("");
  ...
  const c = ((_a = r.currentSession) == null ? void 0 : _a.modeState.currentUIState) ?? "idle", h = ie[c], o = ((_b = r.currentSession) == null ? void 0 : _b.modeState.messages) ?? [], a = (_c = r.currentSession) == null ? void 0 : _c.modeState.generatedJson, l = u.useCallback(async () => {
    ...
    if (a) try {
      ...
      await W.characters.add(n), C.success(`\u89D2\u8272 ${n.name} \u5DF2\u6DFB\u52A0\u5230\u5E7F\u573A`), t.setUIState("completed"), s({ to: "/plaza/characters" });
    } catch (n) {
