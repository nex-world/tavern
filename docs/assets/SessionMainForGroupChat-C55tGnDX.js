...
import { j as se, S as ae } from "./db-master-eAmex8rT.js";
import { s as ne } from "./db-g5sbJCRD.js";
import { _ as G, __tla as __tla_0 } from "./index-DNgj8bwD.js";
import { C as re, A as oe } from "./AutoScrollDownArea-cUzgyL9F.js";
import { S as ie } from "./session-manager.class-jV90p7NY.js";
...
import { b as R, a as he } from "./analytics-BTxGqTJY.js";
    ...
    const C = T({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-eAmex8rT.js").then((i)=>i.z);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-eAmex8rT.js").then((o)=>o.A);
                return {
                    masterDb: n
                };
