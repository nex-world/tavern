import { j as e, u as n } from "./react-gFHNOnf5.js";
import { f as g, i as f } from "./@tanstack-DDpiKjUN.js";
import { S as N, m as v } from "./db-master-DI3V0061.js";
import { B as o } from "./button-D3G-RLOw.js";
import { C as d, a as b, b as w, c as y, d as m } from "./card-B4CxGEM-.js";
import { B as x } from "./badge-C9CmQsZA.js";
import { A as C, a as D, b as A, c as S, d as T, e as k, f as P, g as B, h as I } from "./alert-dialog-fySQUPs-.js";
import { I as H } from "./InvitationGuard-DpWHmU2-.js";
import { v as l, P as h, j as F, U as L, w as R } from "./icons-CW-0NDo_.js";
...
function te() {
  const r = g(), { data: p = [] } = f((s) => s.from({ s: N })), c = p.filter((s) => s.mode === "small-town").sort((s, t) => t.updatedAt - s.updatedAt), j = async (s) => {
    try {
