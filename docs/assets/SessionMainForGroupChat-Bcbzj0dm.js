...
import { D as U, ac as $, aN as Z, r as I, t as T, u as ee, j as e } from "./react-DE62XWsa.js";
import { f as J, j as te } from "./@tanstack-m-1uuL6k.js";
import { j as se, S as ae } from "./db-master-DXT9Czfg.js";
import { s as ne } from "./db-CD5QMPEf.js";
import { _ as G, __tla as __tla_0 } from "./index-JyDiBVul.js";
import { C as re, A as oe } from "./AutoScrollDownArea-ByANIzBJ.js";
import { S as ie } from "./session-manager.class-Bzrb43hn.js";
...
import { _ as V, o as L, s as g, n as A, b as me, r as pe, l as xe } from "./zod-BTj0C3yc.js";
import { c as P } from "./shadcn-utils-Cnr6N47i.js";
import { C as q } from "./CharacterAvatar-DYmvpMDg.js";
import { b as R, a as he } from "./analytics-Chh7YMpj.js";
import { au as ge, Q as O, a8 as fe, aC as Se, e as be, h as B, w as Ce } from "./icons-B4Nv5HRG.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-DXT9Czfg.js").then((i)=>i.z);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-DXT9Czfg.js").then((o)=>o.A);
                return {
                    masterDb: n
                };
...
`);
            ...
            try {
                for(;;){
                    ...
                    for(let S = 0; S < z; S++){
                        ...
                        if (m = je(M), m) break;
                        console.warn(`[GroupChat] DM 选择解析失败 (${S + 1}/${z})`);
                    }
                    if (!m) {
    ...
    it = (s)=>{
        ...
        const m = i.currentSession?.modeState?.currentUIState || "idle", f = H[m] || H.idle, v = i.currentSession?.modeConfig?.participantSnapshots?.find((l)=>l.id === i.currentSession?.modeState?.currentSpeakerId), S = async ()=>{
            if (!a.trim()) return;
            const l = a;
