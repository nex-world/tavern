import { al as V, r as m, v as P, u as C, j as e } from "./react-gFHNOnf5.js";
import { f as A } from "./@tanstack-DDpiKjUN.js";
import { B as g } from "./button-D3G-RLOw.js";
import { T as R } from "./textarea-DqdRyzs9.js";
import { C as $, a as K, b as Y, d as H } from "./card-B4CxGEM-.js";
import { B as J } from "./badge-C9CmQsZA.js";
import { c as G } from "./shadcn-utils-BMZD7_jZ.js";
import { n as b } from "./id-OxPLOBIU.js";
import { e as q, m as Q } from "./db-master-DI3V0061.js";
import { _ as L, o as I, n as D, s as _, c as W, a as X, l as Z } from "./zod-DPWJ_A9_.js";
import { u as ee } from "./useLLM-B1Ewhspf.js";
import { A as te, Q as O, c as M, R as U, a8 as se, P as ne, J as ae } from "./icons-CW-0NDo_.js";
...
function he() {
  ...
  return e.jsxs("div", { className: "flex flex-col h-full max-h-[calc(100vh-4rem)]", children: [e.jsxs("div", { className: "flex items-center justify-between p-4 border-b", children: [e.jsxs("div", { className: "flex items-center gap-3", children: [e.jsx(g, { type: "button", variant: "ghost", size: "icon", onClick: F, children: e.jsx(te, { className: "w-5 h-5" }) }), e.jsxs("div", { children: [e.jsx("h1", { className: "text-lg font-semibold", children: "\u804A\u5929\u5F0F\u521B\u5EFA\u6311\u6218" }), e.jsx("p", { className: "text-sm text-muted-foreground", children: "\u901A\u8FC7\u5BF9\u8BDD\u5F15\u5BFC\u521B\u5EFA\u6311\u6218\u5361" })] })] }), e.jsxs("div", { className: "flex items-center gap-2", children: [e.jsx(J, { variant: "outline", children: p.label }), i.length > 0 && e.jsx(g, { type: "button", variant: "outline", size: "sm", onClick: B, children: "\u91CD\u65B0\u5F00\u59CB" })] })] }), e.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [e.jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [e.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-4", children: [i.length === 0 && !v && e.jsxs("div", { className: "text-center text-muted-foreground py-12", children: [e.jsx(O, { className: "w-12 h-12 mx-auto mb-4 opacity-50" }), e.jsx("p", { children: "\u5F00\u59CB\u63CF\u8FF0\u4F60\u60F3\u521B\u5EFA\u7684\u6311\u6218\u5427\uFF01" }), e.jsx("p", { className: "text-sm mt-2", children: "\u4F8B\u5982\uFF1A\u6211\u60F3\u521B\u5EFA\u4E00\u4E2A\u8BA8\u4EF7\u8FD8\u4EF7\u7684\u6311\u6218..." })] }), i.map((s) => e.jsxs("div", { className: G("max-w-[80%] rounded-lg p-3", s.role === "user" ? "ml-auto bg-primary text-primary-foreground" : "bg-muted"), children: [e.jsx("div", { className: "whitespace-pre-wrap text-sm", children: s.content }), s.messageType === "description_summary" && e.jsx(J, { variant: "secondary", className: "mt-2", children: "\u6311\u6218\u8BBE\u8BA1\u603B\u7ED3" })] }, s.id)), v && e.jsxs("div", { className: "max-w-[80%] rounded-lg p-3 bg-muted", children: [e.jsx("div", { className: "whitespace-pre-wrap text-sm", children: v }), e.jsx("span", { className: "inline-block w-2 h-4 bg-foreground/50 animate-pulse ml-1" })] })] }), e.jsxs("div", { className: "p-4 border-t space-y-3", children: [e.jsxs("div", { className: "flex flex-wrap gap-2", children: [c === "description_confirming" && e.jsxs(e.Fragment, { children: [e.jsxs(g, { type: "button", size: "sm", onClick: w, disabled: u, children: [e.jsx(M, { className: "w-4 h-4 mr-1" }), "\u786E\u8BA4\u5E76\u751F\u6210\u6311\u6218\u5361"] }), e.jsxs(g, { type: "button", size: "sm", variant: "outline", onClick: x, disabled: u, children: [e.jsx(U, { className: "w-4 h-4 mr-1" }), "\u91CD\u65B0\u751F\u6210\u8BBE\u8BA1"] })] }), (c === "interview_waiting" || c === "idle") && i.length > 2 && e.jsxs(g, { type: "button", size: "sm", variant: "secondary", onClick: w, disabled: u, children: [e.jsx(O, { className: "w-4 h-4 mr-1" }), "\u7ACB\u5373\u751F\u6210\u6311\u6218\u5361"] })] }), e.jsxs("div", { className: "flex gap-2", children: [e.jsx(R, { value: l, onChange: (s) => d(s.target.value), onKeyDown: f, placeholder: p.placeholder, disabled: !p.inputEnabled || u, className: "min-h-[60px] max-h-[120px] resize-none" }), e.jsx(g, { type: "button", size: "icon", onClick: h, disabled: !p.inputEnabled || u || !l.trim(), children: e.jsx(se, { className: "w-4 h-4" }) })] })] })] }), (c === "json_editing" || c === "json_confirmed" || c === "completed") && a && e.jsxs("div", { className: "w-96 border-l overflow-y-auto p-4 space-y-4", children: [e.jsxs($, { children: [e.jsx(K, { className: "pb-2", children: e.jsxs(Y, { className: "text-base flex items-center justify-between", children: ["\u6311\u6218\u5361\u9884\u89C8", e.jsx("div", { className: "flex gap-1", children: e.jsx(g, { type: "button", size: "icon", variant: "ghost", onClick: j, disabled: u, title: "\u91CD\u65B0\u751F\u6210", children: e.jsx(U, { className: "w-4 h-4" }) }) })] }) }), e.jsxs(H, { className: "space-y-3", children: [e.jsx(k, { label: "\u540D\u79F0", value: a.name, onChange: (s) => t.updateGeneratedJsonField("name", s) }), e.jsx(k, { label: "\u63CF\u8FF0", value: a.description, multiline: true, onChange: (s) => t.updateGeneratedJsonField("description", s) }), e.jsx(k, { label: "\u89D2\u8272\u884C\u4E3A\u6307\u5BFC", value: a.roleTaskPrompt, multiline: true, onChange: (s) => t.updateGeneratedJsonField("roleTaskPrompt", s) }), e.jsx(k, { label: "\u73A9\u5BB6\u5F15\u5BFC", value: a.userGuidance, multiline: true, onChange: (s) => t.updateGeneratedJsonField("userGuidance", s) }), e.jsxs("div", { children: [e.jsx("span", { className: "text-xs text-muted-foreground", children: "\u53D8\u91CF" }), e.jsx("div", { className: "mt-1 space-y-1", children: Object.entries(a.variables || {}).map(([s, S]) => e.jsxs("div", { className: "text-xs bg-muted rounded p-2", children: [e.jsx("span", { className: "font-medium", children: s }), e.jsxs("span", { className: "text-muted-foreground ml-2", children: ["\u521D\u59CB\u503C:", " ", String(S.initial ?? 0)] })] }, s)) })] }), e.jsxs("div", { children: [e.jsx("span", { className: "text-xs text-muted-foreground", children: "\u76EE\u6807" }), e.jsx("div", { className: "mt-1 space-y-1", children: (a.goals || []).map((s, S) => e.jsx("div", { className: "text-xs bg-muted rounded p-2", children: e.jsx("span", { className: "font-medium", children: s.description }) }, S)) })] }), e.jsxs("div", { children: [e.jsx("span", { className: "text-xs text-muted-foreground", children: "\u5931\u8D25\u6761\u4EF6" }), e.jsx("div", { className: "mt-1 space-y-1", children: (a.failureChecks || []).map((s, S) => e.jsx("div", { className: "text-xs bg-muted rounded p-2", children: e.jsx("span", { className: "font-medium", children: s.description }) }, S)) })] }), e.jsxs("div", { children: [e.jsx("span", { className: "text-xs text-muted-foreground", children: "\u6807\u7B7E" }), e.jsx("div", { className: "flex flex-wrap gap-1 mt-1", children: (_d = a.tags) == null ? void 0 : _d.map((s, S) => e.jsx(J, { variant: "secondary", className: "text-xs", children: s }, S)) })] })] })] }), c !== "completed" && e.jsxs("div", { className: "flex flex-col gap-2", children: [e.jsxs(g, { type: "button", onClick: z, className: "w-full", children: [e.jsx(ne, { className: "w-4 h-4 mr-2" }), "\u6DFB\u52A0\u5230\u5E7F\u573A"] }), e.jsxs(g, { type: "button", variant: "outline", onClick: y, className: "w-full", children: [e.jsx(ae, { className: "w-4 h-4 mr-2" }), "\u5BFC\u51FA\u4E3A\u6587\u4EF6"] }), c === "json_editing" && e.jsxs(g, { type: "button", variant: "secondary", onClick: N, className: "w-full", children: [e.jsx(M, { className: "w-4 h-4 mr-2" }), "\u786E\u8BA4\u5B8C\u6210\u7F16\u8F91"] })] }), c === "completed" && e.jsxs("div", { className: "text-center text-muted-foreground py-4", children: [e.jsx(M, { className: "w-8 h-8 mx-auto mb-2 text-green-500" }), e.jsx("p", { children: "\u6311\u6218\u5361\u5DF2\u6DFB\u52A0\u5230\u5E7F\u573A\uFF01" })] })] })] })] });
}
