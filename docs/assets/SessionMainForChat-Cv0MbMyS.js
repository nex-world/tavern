const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/db-master-BrZHBPj2.js","assets/@tanstack-3iyDWv8L.js","assets/react-D9TtqY-V.js","assets/vendor-C4ToNUTj.js","assets/@radix-ui-BQCqNqg0.js","assets/immer-BCQU3qJI.js","assets/dexie-C2pyTzVO.js","assets/zod-fbN9ubnj.js","assets/PlayerInputItem-CoBNH5z-.js","assets/id-OxPLOBIU.js","assets/CharacterAvatar-Cnp2urxB.js","assets/shadcn-utils-BMZD7_jZ.js","assets/components-and-styling-lnR2ABT4.js","assets/@tailwind-COJ8Fh6m.js","assets/icons-d5PdVRlQ.js"])))=>i.map(i=>d[i]);
import { D as b, r as l, t as L, j as t } from "./react-D9TtqY-V.js";
import { S as A, C as F, f as D } from "./db-master-BrZHBPj2.js";
import { f as H, i as k } from "./@tanstack-3iyDWv8L.js";
import { s as z } from "./db--eUIPBg3.js";
import { _ as M, __tla as __tla_0 } from "./index-Cxjv2Jza.js";
import { n as _ } from "./id-OxPLOBIU.js";
import { C as S } from "./context-manager.class-B2xis078.js";
import { m as O, P, C as T, a as V } from "./PlayerInputItem-CoBNH5z-.js";
import { B as U } from "./button-CMoAlsw3.js";
import { T as $ } from "./textarea-NuAUq_bK.js";
import { B as E } from "./badge-B6qKYUZD.js";
import { C as B } from "./CharacterAvatar-Cnp2urxB.js";
import { u as K } from "./useLLM-tAU3ECR6.js";
import { W as Y } from "./icons-d5PdVRlQ.js";
...
let __tla = Promise.all([
  ...
  const m = b({
    ...
    async saveNewContextItemsToDB(e, s) {
      const { SessionDB: o } = await M(async () => {
        const { SessionDB: g } = await import("./db-master-BrZHBPj2.js").then((y) => y.s);
        return {
          SessionDB: g
        };
    ...
    const o = K(), n = l.useRef(false), g = H(), y = l.useCallback(async (h) => {
      if (!(n.current || !s || s.getHistoryCount() > 0 || !e)) try {
        ...
        const { makeChatModeStartingContextItems_CN: p } = await M(async () => {
          const { makeChatModeStartingContextItems_CN: d } = await import("./PlayerInputItem-CoBNH5z-.js").then((r) => r.c);
          return {
      ...
      if (!(n.current || !e || !s)) try {
        ...
        const { makeChatModeLLMMessagesFromContextStateForCharacterId: x } = await M(async () => {
          const { makeChatModeLLMMessagesFromContextStateForCharacterId: u } = await import("./PlayerInputItem-CoBNH5z-.js").then((C) => C.c);
          return {
            ...
            children: t.jsxs("div", {
              ...
              children: [
                (() => {
                  ...
                  return c && !a.some((I) => I.id === c.id) && f.push(c), f.map((I, N) => t.jsx(W, {
                    item: I,
                    character: i,
  ...
  q = (e) => e.item.type === "character_message" ? t.jsxs("div", {
    className: "flex gap-4 animate-pulse",
    children: [
      t.jsx("div", {
        className: "shrink-0",
