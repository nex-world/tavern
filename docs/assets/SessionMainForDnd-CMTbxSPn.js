...
import { h as Ne, S as De, m as je } from "./db-master-CKbpIx9B.js";
import { s as Ie } from "./db-DP29k3dM.js";
import { _ as ee, __tla as __tla_0 } from "./index-B9wsPAr2.js";
import { C as we, A as ve } from "./AutoScrollDownArea-D24Ehsjw.js";
import { n as $ } from "./id-BY9c7rfI.js";
import { S as Me } from "./session-manager.class-Bym06Z1Z.js";
...
import { b as He, a as Fe } from "./analytics-WLusMZQN.js";
    ...
    const m = Q({
        ...
        async saveNewContextItemsToDB (a, t) {
            const { SessionDB: e } = await ee(async ()=>{
                const { SessionDB: o } = await import("./db-master-CKbpIx9B.js").then((i)=>i.v);
                return {
                    SessionDB: o
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: a } = await ee(async ()=>{
                const { masterDb: s } = await import("./db-master-CKbpIx9B.js").then((r)=>r.w);
                return {
                    masterDb: s
                };
