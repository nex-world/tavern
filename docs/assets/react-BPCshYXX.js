import { r as sE, c as fE, o as dE, s as pE, f as mE, a as vE, h as hE, b as Kv, l as gE, d as yE, _ as ga, e as wh, g as bE, i as SE, j as ki, m as Xv, k as EE, n as xE, p as CE, q as TE } from "./vendor-DqU8PgXE.js";
...
For more information, see https://radix-ui.com/primitives/docs/components/${i.docsSlug}`;
  ...
  return u.displayName = `Primitive.${i}`, { ...l, [i]: u };
}, {}), Vy = "AlertDialog", [Y_] = pt(Vy, [Sy]), In = Sy(), Iy = (l) => {
  const { __scopeAlertDialog: i, ...r } = l, u = In(i);
  return E.jsx(By, { ...u, ...r, modal: true });
};
Iy.displayName = Vy;
var V_ = "AlertDialogTrigger", qy = d.forwardRef((l, i) => {
  const { __scopeAlertDialog: r, ...u } = l, s = In(r);
  return E.jsx(B_, { ...s, ...u, ref: i });
});
qy.displayName = V_;
var I_ = "AlertDialogPortal", Ky = (l) => {
  const { __scopeAlertDialog: i, ...r } = l, u = In(i);
  return E.jsx(Hy, { ...u, ...r });
};
Ky.displayName = I_;
var q_ = "AlertDialogOverlay", Xy = d.forwardRef((l, i) => {
  const { __scopeAlertDialog: r, ...u } = l, s = In(r);
  return E.jsx(Ly, { ...s, ...u, ref: i });
});
Xy.displayName = q_;
var kl = "AlertDialogContent", [K_, X_] = Y_(kl), P_ = zh("AlertDialogContent"), Py = d.forwardRef((l, i) => {
  const { __scopeAlertDialog: r, children: u, ...s } = l, f = In(r), m = d.useRef(null), h = he(i, m), y = d.useRef(null);
  return E.jsx(N_, { contentName: kl, titleName: ky, docsSlug: "alert-dialog", children: E.jsx(K_, { scope: r, cancelRef: y, children: E.jsxs(Gy, { role: "alertdialog", ...f, ...s, ref: h, onOpenAutoFocus: W(s.onOpenAutoFocus, (g) => {
    var _a2;
    g.preventDefault(), (_a2 = y.current) == null ? void 0 : _a2.focus({ preventScroll: true });
  }), onPointerDownOutside: (g) => g.preventDefault(), onInteractOutside: (g) => g.preventDefault(), children: [E.jsx(P_, { children: u }), E.jsx(Q_, { contentRef: m })] }) }) });
});
Py.displayName = kl;
var ky = "AlertDialogTitle", Qy = d.forwardRef((l, i) => {
  const { __scopeAlertDialog: r, ...u } = l, s = In(r);
  return E.jsx(H_, { ...s, ...u, ref: i });
});
Qy.displayName = ky;
var Zy = "AlertDialogDescription", $y = d.forwardRef((l, i) => {
  const { __scopeAlertDialog: r, ...u } = l, s = In(r);
  return E.jsx(L_, { ...s, ...u, ref: i });
});
$y.displayName = Zy;
var k_ = "AlertDialogAction", Jy = d.forwardRef((l, i) => {
  const { __scopeAlertDialog: r, ...u } = l, s = In(r);
  return E.jsx(Yy, { ...s, ...u, ref: i });
});
Jy.displayName = k_;
var Fy = "AlertDialogCancel", Wy = d.forwardRef((l, i) => {
  const { __scopeAlertDialog: r, ...u } = l, { cancelRef: s } = X_(Fy, r), f = In(r), m = he(i, s);
...
You can add a description to the \`${kl}\` by passing a \`${Zy}\` component as a child, which also benefits sighted users by adding visible context to the dialog.
...
}, JM = Iy, FM = qy, WM = Ky, ew = Xy, tw = Py, nw = Jy, aw = Wy, lw = Qy, ow = $y;
const qi = {}, Yf = (l) => typeof l == "object" && l !== null, Z_ = (l) => Yf(l) && !lu.has(l) && (Array.isArray(l) || !(Symbol.iterator in l)) && !(l instanceof WeakMap) && !(l instanceof WeakSet) && !(l instanceof Error) && !(l instanceof Number) && !(l instanceof Date) && !(l instanceof String) && !(l instanceof RegExp) && !(l instanceof ArrayBuffer) && !(l instanceof Promise), e0 = (l, i) => {
  const r = Ch.get(l);
...
}, $_ = (l, i, r, u) => ({ deleteProperty(s, f) {
  Reflect.get(s, f), r(f);
  const m = Reflect.deleteProperty(s, f);
  return m && u(void 0), m;
}, set(s, f, m, h) {
  const y = !l() && Reflect.has(s, f), g = Reflect.get(s, f, h);
  if (y && (Th(g, m) || Ki.has(m) && Th(g, Ki.get(m)))) return true;
  r(f), Yf(m) && (m = EE(m) || m);
  const b = !ba.has(m) && F_(m) ? tR(m) : m;
  return i(f, b), Reflect.set(s, f, b, h), u(void 0), true;
} }), ba = /* @__PURE__ */ new WeakMap(), lu = /* @__PURE__ */ new WeakSet(), Ch = /* @__PURE__ */ new WeakMap(), ks = [1], Ki = /* @__PURE__ */ new WeakMap();
let Th = Object.is, J_ = (l, i) => new Proxy(l, i), F_ = Z_, W_ = e0, eR = $_;
function tR(l = {}) {
  if (!Yf(l)) throw new Error("object required");
  const i = Ki.get(l);
  if (i) return i;
  let r = ks[0];
  ...
  const m = (T = ks[0]) => (f !== T && (f = T, y.forEach(([M]) => {
    ...
    const N = !lu.has(M) && ba.get(M);
    if (N) {
      if ((qi ? "production" : void 0) !== "production" && y.has(T)) throw new Error("prop listener already exists");
      if (u.size) {
        const j = N[2](h(T));
        y.set(T, [N, j]);
      } else y.set(T, [N]);
    ...
    if ((qi ? "production" : void 0) !== "production" && j) throw new Error("remove already exists");
    const $ = N[2](h(Y));
    y.set(Y, [N, $]);
  }), () => {
  ...
  let C = true;
  const w = eR(() => C, g, b, s), O = J_(l, w);
  Ki.set(l, O);
  const x = [l, m, v];
  return ba.set(O, x), Reflect.ownKeys(l).forEach((T) => {
...
function nR(l, i, r) {
  const u = ba.get(l);
  (qi ? "production" : void 0) !== "production" && !u && console.warn("Please use proxy object");
  let s;
  const f = [], m = u[2];
  let h = false;
  const g = m((b) => {
...
function _h(l) {
  const i = ba.get(l);
  (qi ? "production" : void 0) !== "production" && !i && console.warn("Please use proxy object");
  const [r, u] = i;
  return W_(r, u());
}
function iw(l) {
...
function uw(l, i) {
  ...
  d.useLayoutEffect(() => {
    s.current = m;
  }), (aR ? "production" : void 0) !== "production" && oR(m, u);
  const h = d.useMemo(() => /* @__PURE__ */ new WeakMap(), []);
  return CE(m, u, h, rR);
}
var ou = "Tabs", [iR] = pt(ou, [Fl]), t0 = Fl(), [uR, Vf] = iR(ou), n0 = d.forwardRef((l, i) => {
  ...
  return E.jsx(uR, { scope: r, baseId: Xe(), value: v, onValueChange: C, orientation: m, dir: b, activationMode: y, children: E.jsx(ue.div, { dir: b, "data-orientation": m, ...g, ref: i }) });
});
n0.displayName = ou;
var a0 = "TabsList", l0 = d.forwardRef((l, i) => {
  const { __scopeTabs: r, loop: u = true, ...s } = l, f = Vf(a0, r), m = t0(r);
...
var o0 = "TabsTrigger", r0 = d.forwardRef((l, i) => {
  const { __scopeTabs: r, value: u, disabled: s = false, ...f } = l, m = Vf(o0, r), h = t0(r), y = c0(m.baseId, u), g = s0(m.baseId, u), b = u === m.value;
...
var i0 = "TabsContent", u0 = d.forwardRef((l, i) => {
  const { __scopeTabs: r, value: u, forceMount: s, children: f, ...m } = l, h = Vf(i0, r), y = c0(h.baseId, u), g = s0(h.baseId, u), b = u === h.value, v = d.useRef(b);
  return d.useEffect(() => {
...
var cw = n0, sw = l0, fw = r0, dw = u0, cR = "Label", f0 = d.forwardRef((l, i) => E.jsx(Vn.label, { ...l, ref: i, onMouseDown: (r) => {
  var _a2;
...
var sR = [" ", "Enter", "ArrowUp", "ArrowDown"], fR = [" ", "Enter"], $a = "Select", [iu, uu, dR] = Jl($a), [Wl] = pt($a, [dR, Ea]), cu = Ea(), [pR, Ca] = Wl($a), [mR, vR] = Wl($a), d0 = (l) => {
  const { __scopeSelect: i, children: r, open: u, defaultOpen: s, onOpenChange: f, value: m, defaultValue: h, onValueChange: y, dir: g, name: b, autoComplete: v, disabled: C, required: w, form: O } = l, x = cu(i), [T, M] = d.useState(null), [N, j] = d.useState(null), [Y, $] = d.useState(false), J = Wa(g), [V, ae] = xt({ prop: u, defaultProp: s ?? false, onChange: f, caller: $a }), [ye, me] = xt({ prop: m, defaultProp: h, onChange: y, caller: $a }), ce = d.useRef(null), de = T ? O || !!T.closest("form") : true, [pe, be] = d.useState(/* @__PURE__ */ new Set()), Se = Array.from(pe).map((I) => I.props.value).join(";");
  return E.jsx(Zi, { ...x, children: E.jsxs(pR, { required: w, scope: i, trigger: T, onTriggerChange: M, valueNode: N, onValueNodeChange: j, valueNodeHasChildren: Y, onValueNodeHasChildrenChange: $, contentId: Xe(), value: ye, onValueChange: me, open: V, onOpenChange: ae, dir: J, triggerPointerDownPosRef: ce, disabled: C, children: [E.jsx(iu.Provider, { scope: i, children: E.jsx(mR, { scope: l.__scopeSelect, onNativeOptionAdd: d.useCallback((I) => {
  ...
  }, []), children: r }) }), de ? E.jsxs(j0, { "aria-hidden": true, required: w, tabIndex: -1, name: b, autoComplete: v, value: ye, onChange: (I) => me(I.target.value), disabled: C, form: O, children: [ye === void 0 ? E.jsx("option", { value: "" }) : null, Array.from(pe)] }, Se) : null] }) });
};
d0.displayName = $a;
var p0 = "SelectTrigger", m0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, disabled: u = false, ...s } = l, f = cu(r), m = Ca(p0, r), h = m.disabled || u, y = he(i, m.onTriggerChange), g = uu(r), b = d.useRef("touch"), [v, C, w] = B0((x) => {
    const T = g().filter((j) => !j.disabled), M = T.find((j) => j.value === m.value), N = H0(T, x, M);
  ...
  return E.jsx(or, { asChild: true, ...f, children: E.jsx(ue.button, { type: "button", role: "combobox", "aria-controls": m.contentId, "aria-expanded": m.open, "aria-required": m.required, "aria-autocomplete": "none", dir: m.dir, "data-state": m.open ? "open" : "closed", disabled: h, "data-disabled": h ? "" : void 0, "data-placeholder": U0(m.value) ? "" : void 0, ...s, ref: y, onClick: W(s.onClick, (x) => {
    ...
    const T = v.current !== "";
    !(x.ctrlKey || x.altKey || x.metaKey) && x.key.length === 1 && C(x.key), !(T && x.key === " ") && sR.includes(x.key) && (O(), x.preventDefault());
  }) }) });
});
m0.displayName = p0;
var v0 = "SelectValue", h0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, className: u, style: s, children: f, placeholder: m = "", ...h } = l, y = Ca(v0, r), { onValueNodeHasChildrenChange: g } = y, b = f !== void 0, v = he(i, y.onValueNodeChange);
  return dt(() => {
    g(b);
  }, [g, b]), E.jsx(ue.span, { ...h, ref: v, style: { pointerEvents: "none" }, children: U0(y.value) ? E.jsx(E.Fragment, { children: m }) : f });
});
h0.displayName = v0;
var hR = "SelectIcon", g0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, children: u, ...s } = l;
  return E.jsx(ue.span, { "aria-hidden": true, ...s, ref: i, children: u || "\u25BC" });
});
g0.displayName = hR;
var gR = "SelectPortal", y0 = (l) => E.jsx(rr, { asChild: true, ...l });
y0.displayName = gR;
var Ja = "SelectContent", b0 = d.forwardRef((l, i) => {
  const r = Ca(Ja, l.__scopeSelect), [u, s] = d.useState();
  if (dt(() => {
    s(new DocumentFragment());
  }, []), !r.open) {
    const f = u;
    return f ? lr.createPortal(E.jsx(S0, { scope: l.__scopeSelect, children: E.jsx(iu.Slot, { scope: l.__scopeSelect, children: E.jsx("div", { children: l.children }) }) }), f) : null;
  }
  return E.jsx(E0, { ...l, ref: i });
});
b0.displayName = Ja;
var un = 10, [S0, Ta] = Wl(Ja), yR = "SelectContentImpl", bR = Qa("SelectContent.RemoveScroll"), E0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, position: u = "item-aligned", onCloseAutoFocus: s, onEscapeKeyDown: f, onPointerDownOutside: m, side: h, sideOffset: y, align: g, alignOffset: b, arrowPadding: v, collisionBoundary: C, collisionPadding: w, sticky: O, hideWhenDetached: x, avoidCollisions: T, ...M } = l, N = Ca(Ja, r), [j, Y] = d.useState(null), [$, J] = d.useState(null), V = he(i, (K) => Y(K)), [ae, ye] = d.useState(null), [me, ce] = d.useState(null), de = uu(r), [pe, be] = d.useState(false), Se = d.useRef(false);
  d.useEffect(() => {
    if (j) return ki(j);
  }, [j]), eu();
  ...
  const [Ee, R] = B0((K) => {
    const te = de().filter((De) => !De.disabled), ie = te.find((De) => De.ref.current === document.activeElement), Ce = H0(te, K, ie);
  ...
  }, [N.value]), P = u === "popper" ? uf : x0, F = P === uf ? { side: h, sideOffset: y, align: g, alignOffset: b, arrowPadding: v, collisionBoundary: C, collisionPadding: w, sticky: O, hideWhenDetached: x, avoidCollisions: T } : {};
  return E.jsx(S0, { scope: r, content: j, viewport: $, onViewportChange: J, itemRefCallback: A, selectedItem: ae, onItemLeave: H, itemTextRefCallback: X, focusSelectedItem: ee, selectedItemText: me, position: u, isPositioned: pe, searchRef: Ee, children: E.jsx(cr, { as: bR, allowPinchZoom: true, children: E.jsx(ir, { asChild: true, trapped: N.open, onMountAutoFocus: (K) => {
    K.preventDefault();
...
E0.displayName = yR;
var SR = "SelectItemAlignedPosition", x0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, onPlaced: u, ...s } = l, f = Ca(Ja, r), m = Ta(Ja, r), [h, y] = d.useState(null), [g, b] = d.useState(null), v = he(i, (V) => b(V)), C = uu(r), w = d.useRef(false), O = d.useRef(true), { viewport: x, selectedItem: T, selectedItemText: M, focusSelectedItem: N } = m, j = d.useCallback(() => {
  ...
  return E.jsx(xR, { scope: r, contentWrapper: h, shouldExpandOnScrollRef: w, onScrollButtonChange: J, children: E.jsx("div", { ref: y, style: { display: "flex", flexDirection: "column", position: "fixed", zIndex: Y }, children: E.jsx(ue.div, { ...s, ref: v, style: { boxSizing: "border-box", maxHeight: "100%", ...s.style } }) }) });
});
x0.displayName = SR;
var ER = "SelectPopperPosition", uf = d.forwardRef((l, i) => {
  const { __scopeSelect: r, align: u = "start", collisionPadding: s = un, ...f } = l, m = cu(r);
...
uf.displayName = ER;
var [xR, If] = Wl(Ja, {}), cf = "SelectViewport", C0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, nonce: u, ...s } = l, f = Ta(cf, r), m = If(cf, r), h = he(i, f.onViewportChange), y = d.useRef(0);
  return E.jsxs(E.Fragment, { children: [E.jsx("style", { dangerouslySetInnerHTML: { __html: "[data-radix-select-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-radix-select-viewport]::-webkit-scrollbar{display:none}" }, nonce: u }), E.jsx(iu.Slot, { scope: r, children: E.jsx(ue.div, { "data-radix-select-viewport": "", role: "presentation", ...s, ref: h, style: { position: "relative", flex: 1, overflow: "hidden auto", ...s.style }, onScroll: W(s.onScroll, (g) => {
...
C0.displayName = cf;
var T0 = "SelectGroup", [CR, TR] = Wl(T0), _R = d.forwardRef((l, i) => {
  const { __scopeSelect: r, ...u } = l, s = Xe();
  return E.jsx(CR, { scope: r, id: s, children: E.jsx(ue.div, { role: "group", "aria-labelledby": s, ...u, ref: i }) });
});
_R.displayName = T0;
var _0 = "SelectLabel", RR = d.forwardRef((l, i) => {
  const { __scopeSelect: r, ...u } = l, s = TR(_0, r);
  return E.jsx(ue.div, { id: s.id, ...u, ref: i });
});
RR.displayName = _0;
var Xi = "SelectItem", [AR, R0] = Wl(Xi), A0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, value: u, disabled: s = false, textValue: f, ...m } = l, h = Ca(Xi, r), y = Ta(Xi, r), g = h.value === u, [b, v] = d.useState(f ?? ""), [C, w] = d.useState(false), O = he(i, (N) => {
    var _a2;
  ...
  return E.jsx(AR, { scope: r, value: u, disabled: s, textId: x, isSelected: g, onItemTextChange: d.useCallback((N) => {
    v((j) => j || ((N == null ? void 0 : N.textContent) ?? "").trim());
  }, []), children: E.jsx(iu.ItemSlot, { scope: r, value: u, disabled: s, textValue: b, children: E.jsx(ue.div, { role: "option", "aria-labelledby": x, "data-highlighted": C ? "" : void 0, "aria-selected": g && C, "data-state": g ? "checked" : "unchecked", "aria-disabled": s || void 0, "data-disabled": s ? "" : void 0, tabIndex: s ? void 0 : -1, ...m, ref: O, onFocus: W(m.onFocus, () => w(true)), onBlur: W(m.onBlur, () => w(false)), onClick: W(m.onClick, () => {
    T.current !== "mouse" && M();
    ...
    var _a2;
    ((_a2 = y.searchRef) == null ? void 0 : _a2.current) !== "" && N.key === " " || (fR.includes(N.key) && M(), N.key === " " && N.preventDefault());
  }) }) }) });
});
A0.displayName = Xi;
var er = "SelectItemText", M0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, className: u, style: s, ...f } = l, m = Ca(er, r), h = Ta(er, r), y = R0(er, r), g = vR(er, r), [b, v] = d.useState(null), C = he(i, (M) => v(M), y.onItemTextChange, (M) => {
    var _a2;
...
M0.displayName = er;
var w0 = "SelectItemIndicator", D0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, ...u } = l;
  return R0(w0, r).isSelected ? E.jsx(ue.span, { "aria-hidden": true, ...u, ref: i }) : null;
});
D0.displayName = w0;
var sf = "SelectScrollUpButton", O0 = d.forwardRef((l, i) => {
  const r = Ta(sf, l.__scopeSelect), u = If(sf, l.__scopeSelect), [s, f] = d.useState(false), m = he(i, u.onScrollButtonChange);
  return dt(() => {
  ...
  }, [r.viewport, r.isPositioned]), s ? E.jsx(z0, { ...l, ref: m, onAutoScroll: () => {
    const { viewport: h, selectedItem: y } = r;
    h && y && (h.scrollTop = h.scrollTop - y.offsetHeight);
  } }) : null;
});
O0.displayName = sf;
var ff = "SelectScrollDownButton", N0 = d.forwardRef((l, i) => {
  const r = Ta(ff, l.__scopeSelect), u = If(ff, l.__scopeSelect), [s, f] = d.useState(false), m = he(i, u.onScrollButtonChange);
  return dt(() => {
    if (r.viewport && r.isPositioned) {
      let h = function() {
...
N0.displayName = ff;
var z0 = d.forwardRef((l, i) => {
  const { __scopeSelect: r, onAutoScroll: u, ...s } = l, f = Ta("SelectScrollButton", r), m = d.useRef(null), h = uu(r), y = d.useCallback(() => {
...
}), MR = "SelectSeparator", wR = d.forwardRef((l, i) => {
  const { __scopeSelect: r, ...u } = l;
  return E.jsx(ue.div, { "aria-hidden": true, ...u, ref: i });
});
wR.displayName = MR;
var df = "SelectArrow", DR = d.forwardRef((l, i) => {
  const { __scopeSelect: r, ...u } = l, s = cu(r), f = Ca(df, r), m = Ta(df, r);
  return f.open && m.position === "popper" ? E.jsx(Ji, { ...s, ...u, ref: i }) : null;
});
DR.displayName = df;
var OR = "SelectBubbleInput", j0 = d.forwardRef(({ __scopeSelect: l, value: i, ...r }, u) => {
  const s = d.useRef(null), f = he(u, s), m = ru(i);
  return d.useEffect(() => {
    const h = s.current;
    if (!h) return;
...
var mw = d0, vw = m0, hw = h0, gw = g0, yw = y0, bw = b0, Sw = C0, Ew = A0, xw = M0, Cw = D0, Tw = O0, _w = N0, su = "Checkbox", [zR] = pt(su), [jR, qf] = zR(su);
function UR(l) {
  const { __scopeCheckbox: i, checked: r, children: u, defaultChecked: s, disabled: f, form: m, name: h, onCheckedChange: y, required: g, value: b = "on", internal_do_not_use_render: v } = l, [C, w] = xt({ prop: r, defaultProp: s ?? false, onChange: y, caller: su }), [O, x] = d.useState(null), [T, M] = d.useState(null), N = d.useRef(false), j = O ? !!m || !!O.closest("form") : true, Y = { checked: C, disabled: f, setChecked: w, control: O, setControl: x, name: h, form: m, value: b, hasConsumerStoppedPropagationRef: N, required: g, defaultChecked: ya(s) ? false : s, isFormControl: j, bubbleInput: T, setBubbleInput: M };
  return E.jsx(jR, { scope: i, ...Y, children: LR(v) ? v(Y) : u });
}
var L0 = "CheckboxTrigger", G0 = d.forwardRef(({ __scopeCheckbox: l, onKeyDown: i, onClick: r, ...u }, s) => {
  const { control: f, value: m, disabled: h, checked: y, required: g, setControl: b, setChecked: v, hasConsumerStoppedPropagationRef: C, isFormControl: w, bubbleInput: O } = qf(L0, l), x = he(s, b), T = d.useRef(y);
  return d.useEffect(() => {
  ...
  }, [f, v]), E.jsx(ue.button, { type: "button", role: "checkbox", "aria-checked": ya(y) ? "mixed" : y, "aria-required": g, "data-state": q0(y), "data-disabled": h ? "" : void 0, disabled: h, value: m, ...u, ref: x, onKeyDown: W(i, (M) => {
...
G0.displayName = L0;
var BR = d.forwardRef((l, i) => {
  const { __scopeCheckbox: r, name: u, checked: s, defaultChecked: f, required: m, disabled: h, value: y, onCheckedChange: g, form: b, ...v } = l;
  return E.jsx(UR, { __scopeCheckbox: r, checked: s, defaultChecked: f, disabled: h, required: m, onCheckedChange: g, name: u, form: b, value: y, internal_do_not_use_render: ({ isFormControl: C }) => E.jsxs(E.Fragment, { children: [E.jsx(G0, { ...v, ref: i, __scopeCheckbox: r }), C && E.jsx(I0, { __scopeCheckbox: r })] }) });
});
BR.displayName = su;
var Y0 = "CheckboxIndicator", HR = d.forwardRef((l, i) => {
  const { __scopeCheckbox: r, forceMount: u, ...s } = l, f = qf(Y0, r);
  return E.jsx(Ut, { present: u || ya(f.checked) || f.checked === true, children: E.jsx(ue.span, { "data-state": q0(f.checked), "data-disabled": f.disabled ? "" : void 0, ...s, ref: i, style: { pointerEvents: "none", ...l.style } }) });
});
HR.displayName = Y0;
var V0 = "CheckboxBubbleInput", I0 = d.forwardRef(({ __scopeCheckbox: l, ...i }, r) => {
  const { control: u, hasConsumerStoppedPropagationRef: s, checked: f, defaultChecked: m, required: h, disabled: y, name: g, value: b, form: v, bubbleInput: C, setBubbleInput: w } = qf(V0, l), O = he(r, w), x = ru(f), T = Qi(u);
  d.useEffect(() => {
    const N = C;
    if (!N) return;
...
var K0 = ["PageUp", "PageDown"], X0 = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"], P0 = { "from-left": ["Home", "PageDown", "ArrowDown", "ArrowLeft"], "from-right": ["Home", "PageDown", "ArrowDown", "ArrowRight"], "from-bottom": ["Home", "PageDown", "ArrowDown", "ArrowLeft"], "from-top": ["Home", "PageDown", "ArrowUp", "ArrowLeft"] }, eo = "Slider", [pf, GR, YR] = Jl(eo), [k0] = pt(eo, [YR]), [VR, fu] = k0(eo), Q0 = d.forwardRef((l, i) => {
  ...
  }, inverted: w = false, form: O, ...x } = l, T = d.useRef(/* @__PURE__ */ new Set()), M = d.useRef(0), j = m === "horizontal" ? IR : qR, [Y = [], $] = xt({ prop: b, defaultProp: g, onChange: (ce) => {
    var _a2;
  ...
  return E.jsx(VR, { scope: l.__scopeSlider, name: r, disabled: h, min: u, max: s, valueIndexToChangeRef: M, thumbs: T.current, values: Y, orientation: m, form: O, children: E.jsx(pf.Provider, { scope: l.__scopeSlider, children: E.jsx(pf.Slot, { scope: l.__scopeSlider, children: E.jsx(j, { "aria-disabled": h, "data-disabled": h ? "" : void 0, ...x, ref: i, onPointerDown: W(x.onPointerDown, () => {
    h || (J.current = Y);
...
var [Z0, $0] = k0(eo, { startEdge: "left", endEdge: "right", size: "width", direction: 1 }), IR = d.forwardRef((l, i) => {
  ...
  function N(j) {
    const Y = O.current || v.getBoundingClientRect(), $ = [0, Y.width], V = Kf($, M ? [r, u] : [u, r]);
...
var vf = "SliderThumb", tb = d.forwardRef((l, i) => {
  ...
  const { __scopeSlider: r, index: u, name: s, ...f } = l, m = fu(vf, r), h = $0(vf, r), [y, g] = d.useState(null), b = he(i, (N) => g(N)), v = y ? m.form || !!y.closest("form") : true, C = Qi(y), w = m.values[u], O = w === void 0 ? 0 : ab(w, m.min, m.max), x = kR(u, m.values.length), T = C == null ? void 0 : C[h.size], M = T ? ZR(T, O, h.direction) : 0;
  return d.useEffect(() => {
    if (y) return m.thumbs.add(y), () => {
      m.thumbs.delete(y);
    };
  }, [y, m.thumbs]), E.jsxs("span", { style: { transform: "var(--radix-slider-thumb-transform)", position: "absolute", [h.startEdge]: `calc(${O}% + ${M}px)` }, children: [E.jsx(pf.ItemSlot, { scope: l.__scopeSlider, children: E.jsx(ue.span, { role: "slider", "aria-label": l["aria-label"] || x, "aria-valuemin": m.min, "aria-valuenow": w, "aria-valuemax": m.max, "aria-orientation": m.orientation, "data-orientation": m.orientation, "data-disabled": m.disabled ? "" : void 0, tabIndex: m.disabled ? void 0 : 0, ...f, ref: b, style: w === void 0 ? { display: "none" } : l.style, onFocus: W(l.onFocus, () => {
...
var XR = "RadioBubbleInput", nb = d.forwardRef(({ __scopeSlider: l, value: i, ...r }, u) => {
  const s = d.useRef(null), f = he(s, u), m = ru(i);
  return d.useEffect(() => {
    const h = s.current;
    if (!h) return;
...
var aA = d.forwardRef((l, i) => {
  const { __scopeCollapsible: r, present: u, children: s, ...f } = l, m = Xf(Pf, r), [h, y] = d.useState(u), g = d.useRef(null), b = he(i, g), v = d.useRef(0), C = v.current, w = d.useRef(0), O = w.current, x = m.open || h, T = d.useRef(x), M = d.useRef(void 0);
  return d.useEffect(() => {
  ...
  }, [m.open, u]), E.jsx(ue.div, { "data-state": kf(m.open), "data-disabled": m.disabled ? "" : void 0, id: m.contentId, hidden: !x, ...f, ref: b, style: { "--radix-collapsible-content-height": C ? `${C}px` : void 0, "--radix-collapsible-content-width": O ? `${O}px` : void 0, ...l.style }, children: x && s });
});
function kf(l) {
  return l ? "open" : "closed";
}
...
var Ow = cb, Nw = pb, zw = vb, jw = hb, Uw = yb, vu = "Switch", [hA] = pt(vu), [gA, yA] = hA(vu), Sb = d.forwardRef((l, i) => {
  const { __scopeSwitch: r, name: u, checked: s, defaultChecked: f, required: m, disabled: h, value: y = "on", onCheckedChange: g, form: b, ...v } = l, [C, w] = d.useState(null), O = he(i, (j) => w(j)), x = d.useRef(false), T = C ? b || !!C.closest("form") : true, [M, N] = xt({ prop: s, defaultProp: f ?? false, onChange: g, caller: vu });
  return E.jsxs(gA, { scope: r, checked: M, disabled: h, children: [E.jsx(ue.button, { type: "button", role: "switch", "aria-checked": M, "aria-required": m, "data-state": Tb(M), "data-disabled": h ? "" : void 0, disabled: h, value: y, ...v, ref: O, onClick: W(l.onClick, (j) => {
...
var bA = "SwitchBubbleInput", Cb = d.forwardRef(({ __scopeSwitch: l, control: i, checked: r, bubbles: u = true, ...s }, f) => {
  const m = d.useRef(null), h = he(m, f), y = ru(r), g = Qi(i);
  return d.useEffect(() => {
    const b = m.current;
    if (!b) return;
...
var Bw = Sb, Hw = xb, hu = "Popover", [_b] = pt(hu, [Ea]), mr = Ea(), [SA, _a] = _b(hu), Rb = (l) => {
  ...
  return E.jsx(Zi, { ...h, children: E.jsx(SA, { scope: i, contentId: Xe(), triggerRef: y, open: v, onOpenChange: C, onOpenToggle: d.useCallback(() => C((w) => !w), [C]), hasCustomAnchor: g, onCustomAnchorAdd: d.useCallback(() => b(true), []), onCustomAnchorRemove: d.useCallback(() => b(false), []), modal: m, children: r }) });
};
Rb.displayName = hu;
...
Db.displayName = Jf;
var Zl = "PopoverContent", Ob = d.forwardRef((l, i) => {
...
var TA = Qa("PopoverContent.RemoveScroll"), _A = d.forwardRef((l, i) => {
  ...
  return d.useEffect(() => {
    const m = u.current;
    if (m) return ki(m);
  }, []), E.jsx(cr, { as: TA, allowPinchZoom: true, children: E.jsx(Nb, { ...l, ref: s, trapFocus: r.open, disableOutsidePointerEvents: true, onCloseAutoFocus: W(l.onCloseAutoFocus, (m) => {
    var _a2;
  ...
  return E.jsx(Nb, { ...l, ref: i, trapFocus: false, disableOutsidePointerEvents: false, onCloseAutoFocus: (f) => {
    var _a2, _b2;
    (_a2 = l.onCloseAutoFocus) == null ? void 0 : _a2.call(l, f), f.defaultPrevented || (u.current || ((_b2 = r.triggerRef.current) == null ? void 0 : _b2.focus()), f.preventDefault()), u.current = false, s.current = false;
  }, onInteractOutside: (f) => {
    var _a2, _b2;
...
var Lw = Rb, Gw = wb, Yw = Db, Vw = Ob, Rh = 1, DA = 0.9, OA = 0.8, NA = 0.17, Qs = 0.1, Zs = 0.999, zA = 0.9999, jA = 0.99, UA = /[\\\/_+.#"@\[\(\{&]/, BA = /[\\\/_+.#"@\[\(\{&]/g, HA = /[\s-]/, Ub = /[\s-]/g;
function gf(l, i, r, u, s, f, m) {
  if (f === i.length) return s === l.length ? Rh : jA;
  var h = `${s},${f}`;
  if (m[h] !== void 0) return m[h];
  for (var y = u.charAt(f), g = r.indexOf(y, s), b = 0, v, C, w, O; g >= 0; ) v = gf(l, i, r, u, g + 1, f + 1, m), v > b && (g === s ? v *= Rh : UA.test(l.charAt(g - 1)) ? (v *= OA, w = l.slice(s, g - 1).match(BA), w && s > 0 && (v *= Math.pow(Zs, w.length))) : HA.test(l.charAt(g - 1)) ? (v *= DA, O = l.slice(s, g - 1).match(Ub), O && s > 0 && (v *= Math.pow(Zs, O.length))) : (v *= NA, s > 0 && (v *= Math.pow(Zs, g - s))), l.charAt(g) !== i.charAt(f) && (v *= zA)), (v < Qs && r.charAt(g - 1) === u.charAt(f + 1) || u.charAt(f + 1) === u.charAt(f) && r.charAt(g - 1) !== u.charAt(f)) && (C = gf(l, i, r, u, g + 1, f + 2, m), C * Qs > v && (v = C * Qs)), v > b && (b = v), g = r.indexOf(y, g + 1);
  return m[h] = b, b;
}
function Ah(l) {
...
var Fo = '[cmdk-group=""]', $s = '[cmdk-group-items=""]', GA = '[cmdk-group-heading=""]', Bb = '[cmdk-item=""]', Mh = `${Bb}:not([aria-disabled="true"])`, yf = "cmdk-item-select", Kl = "data-value", YA = (l, i, r) => LA(l, i, r), Hb = d.createContext(void 0), vr = () => d.useContext(Hb), Lb = d.createContext(void 0), Ff = () => d.useContext(Lb), Gb = d.createContext(void 0), Yb = d.forwardRef((l, i) => {
  ...
  }), u = Xl(() => /* @__PURE__ */ new Set()), s = Xl(() => /* @__PURE__ */ new Map()), f = Xl(() => /* @__PURE__ */ new Map()), m = Xl(() => /* @__PURE__ */ new Set()), h = Vb(l), { label: y, children: g, value: b, onValueChange: v, filter: C, shouldFilter: w, loop: O, disablePointerSelection: x = false, vimBindings: T = true, ...M } = l, N = Xe(), j = Xe(), Y = Xe(), $ = d.useRef(null), J = JA();
  Fa(() => {
    if (b !== void 0) {
      let A = b.trim();
  ...
  d.useEffect(() => {
    let J = f.current;
    if (!(!J || l.disabled)) return J.addEventListener(yf, O), () => J.removeEventListener(yf, O);
  ...
  return d.createElement(By, { open: r, onOpenChange: u }, d.createElement(Hy, { container: m }, d.createElement(Ly, { "cmdk-overlay": "", className: s }), d.createElement(Gy, { "aria-label": l.label, "cmdk-dialog": "", className: f }, d.createElement(Yb, { ref: i, ...h }))));
...
var WA = { position: "absolute", width: "1px", height: "1px", padding: "0", margin: "-1px", overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0" }, yu = "DropdownMenu", [eM] = pt(yu, [Rf]), Ct = Rf(), [tM, qb] = eM(yu), Kb = (l) => {
