...
import { h as se, S as ae } from "./db-master-Dr_kUyje.js";
import { s as ne } from "./db-BfpiPamX.js";
import { _ as G, __tla as __tla_0 } from "./index-C01xXbOW.js";
import { C as re, A as oe } from "./AutoScrollDownArea-BOLqJlEe.js";
import { S as ie } from "./session-manager.class-CB-zg5KZ.js";
...
import { C as q } from "./CharacterAvatar-DuUEEGWm.js";
import { b as R, a as he } from "./analytics-BIdYc2ao.js";
import { au as ge, P as O, a4 as fe, aC as Se, S as be, g as B, v as Ce } from "./icons-CjLrWvzf.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-Dr_kUyje.js").then((i)=>i.v);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-Dr_kUyje.js").then((o)=>o.w);
                return {
                    masterDb: n
                };
