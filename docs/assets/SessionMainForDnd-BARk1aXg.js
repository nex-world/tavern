const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/db-master-Dr_kUyje.js","assets/@tanstack-m-1uuL6k.js","assets/react-DE62XWsa.js","assets/vendor-BJF3NJg5.js","assets/formatting-Bt4POpGk.js","assets/@radix-ui-BQCqNqg0.js","assets/immer-BCQU3qJI.js","assets/dexie-DDTiHGxC.js","assets/zod-BOL00Oce.js","assets/analytics-BIdYc2ao.js","assets/nex-tavern-uuid-DXLIR15-.js","assets/index-C01xXbOW.js","assets/icons-CjLrWvzf.js","assets/index-CwGLb_ZP.css","assets/id-BY9c7rfI.js"])))=>i.map(i=>d[i]);
import { D as Q, ac as K, aN as Se, r as S, t as V, u as Ce, j as n } from "./react-DE62XWsa.js";
import { f as oe, j as Ne } from "./@tanstack-m-1uuL6k.js";
import { h as ke, S as De, m as je } from "./db-master-Dr_kUyje.js";
import { s as Ie } from "./db-BfpiPamX.js";
import { _ as ee, __tla as __tla_0 } from "./index-C01xXbOW.js";
import { C as we, A as Me } from "./AutoScrollDownArea-BOLqJlEe.js";
import { n as $ } from "./id-BY9c7rfI.js";
import { S as ve } from "./session-manager.class-CB-zg5KZ.js";
import { B as P } from "./button-B05uqCHL.js";
import { T as Pe } from "./textarea-Dy3g7GWU.js";
import { B } from "./badge-BDEsDlsM.js";
import { u as $e, g as Te, a as Re } from "./global-llm-config.store-C3SCKavw.js";
import { o as T, n as N, s as b, _ as X, c as ie, b as Le, r as Ae, l as Ee } from "./zod-BOL00Oce.js";
import { c as k } from "./shadcn-utils-Cnr6N47i.js";
import { S as Ue } from "./switch-HIxCs_qt.js";
import { C as ce } from "./CharacterAvatar-DuUEEGWm.js";
import { b as He, a as Fe } from "./analytics-BIdYc2ao.js";
import { au as W, x as Y, ay as Be, az as Oe, a4 as Z, ag as Ge, r as ze, S as qe, ax as Je, g as Xe, af as de, aA as Ke, aB as Ve, v as We } from "./icons-CjLrWvzf.js";
...
import "./nex-tavern-uuid-DXLIR15-.js";
let an;
...
`);
    ...
    const m = Q({
        ...
        async saveNewContextItemsToDB (a, t) {
            const { SessionDB: e } = await ee(async ()=>{
                const { SessionDB: o } = await import("./db-master-Dr_kUyje.js").then((i)=>i.v);
                return {
                    SessionDB: o
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: a } = await ee(async ()=>{
                const { masterDb: s } = await import("./db-master-Dr_kUyje.js").then((r)=>r.w);
                return {
                    masterDb: s
                };
    ...
    function ft() {
        const a = $e((p)=>Te(p.config)), t = S.useRef(!1), e = S.useRef(async ()=>{}), s = S.useRef(!1), r = oe(), o = S.useCallback(async (p, f, u, h, g = {})=>{
            ...
            if (g.type === "LLM_CALL") {
                ...
                const w = await o(f, g.messages.map((M)=>({
                        ...M,
                        id: $()
        ...
        const _ = S.useCallback(async (p)=>{
            ...
            if (p) {
                ...
                const g = f.modeState.currentTurnCharacterId, w = f.modeConfig.playerCharacterSnapshots.find((v)=>v.id === g);
    ...
    const _t = T({
        ...
        gameMode: Nt.describe("玩法模式"),
        playerCharacterSnapshots: Le(kt).describe("参与角色快照列表"),
        ...
        turnCounts: Ae(b(), N()).describe("每个角色的行动次数统计"),
    ...
    let wt, J, se, Mt, re;
    an = (a)=>{
        const t = oe(), [e, s] = S.useState(""), [r, o] = S.useState(!1), [i, l] = S.useState(!1), d = Ce(m), { data: _ = [] } = Ne((c)=>c.from({
                s: De
                                ...
                                n.jsxs("div", {
                                    ...
                                    children: [
                                        n.jsx(Pe, {
                                            ...
                                            disabled: H,
                                            className: k("min-h-25 max-h-60 pr-14 py-4 resize-none rounded-2xl border-muted-foreground/15 bg-muted/20 focus-visible:ring-amber-500/20 focus-visible:bg-background transition-all", H && "opacity-50 cursor-not-allowed"),
                                            onKeyDown: (c)=>{
