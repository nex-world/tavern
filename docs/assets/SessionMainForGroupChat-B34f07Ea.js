...
import { D as T, F as $, aH as Z, r as C, u as R, E as ee, j as e } from "./react-BPCshYXX.js";
...
import { T as ie } from "./textarea-Dc_MpBxB.js";
import { B as y } from "./badge-b3CWeD_H.js";
import { n as _ } from "./id-OxPLOBIU.js";
import { u as ce, a as de } from "./global-llm-config.store-B8jg895c.js";
import { _ as J, o as L, s as f, n as A, a as le, r as ue, l as me } from "./zod-fbN9ubnj.js";
import { c as P } from "./shadcn-utils-BMZD7_jZ.js";
import { C as V } from "./CharacterAvatar-DwtbYeXp.js";
import { ai as pe, u as G, v as xe, ap as he, _ as ge, f as B, r as fe } from "./icons-BpfK1DnB.js";
  ...
  const w = T({
    ...
    async saveNewContextItemsToDB(s, t) {
      const { SessionDB: a } = await U(async () => {
        const { SessionDB: m } = await import("./db-master-xI8DZi24.js").then((g) => g.s);
        return {
          SessionDB: m
        };
    ...
    async updateSessionInDB() {
      ...
      const { masterDb: s } = await U(async () => {
        const { masterDb: n } = await import("./db-master-xI8DZi24.js").then((o) => o.t);
        return {
          masterDb: n
        };
      }, __vite__mapDeps([0,1,2,3,4,5,6,7])), t = $(this.currentSession.modeState), a = $(this.currentSession.modeConfig);
...
`);
  ...
  function K(s, t, a = 30) {
    ...
    return s.getFlatHistoryItems(a).filter((m) => !m.hidden && !m.deleted).map((m) => {
      var _a;
      const { type: g, data: i } = m, l = we(m.timestamp), r = l ? `[${l}] ` : "";
...
\u6CE8\u610F\u6839\u636E\u5BF9\u8BDD\u5386\u53F2\u4E2D\u7684\u65F6\u95F4\u6233\u611F\u77E5\u65F6\u95F4\u6D41\u901D\uFF0C\u505A\u51FA\u81EA\u7136\u7684\u53CD\u5E94\u3002`, l = K(t, s, 20), r = o.filter((u) => u.id !== a), c = [
      g ? `\u3010\u7FA4\u804A\u8BDD\u9898\u3011
${g}` : "",
      r.length > 0 ? `\u3010\u5176\u4ED6\u7FA4\u804A\u6210\u5458\u3011
- ${m} (\u73A9\u5BB6)
...
`);
  ...
  const H = 3;
  function Ne() {
    const s = ce((l) => l.config), t = C.useRef(false), a = F(), n = C.useCallback(async (l, r, c, u = {}) => {
      ...
      try {
        for (; ; ) {
          ...
          let h = null;
          for (let S = 0; S < H; S++) {
            const N = Ce(c, x), M = await n(l, N, "gc_select_speaker");
            if (h = Ie(M), h) break;
          ...
          const I = ve(c, x);
          await n(l, I, "gc_character_message", {
      ...
      const l = w, { sessionManager: r } = l;
      r && (r.resetAIAutoSpeakCounter(), await l.updateSessionInDB(), t.current || o());
    }, [
      o
    ]), i = C.useCallback(async () => {
      const l = w, { sessionManager: r } = l;
      r && (r.setCurrentPhase("dm_select_speaker"), r.setCurrentUIState("ai_loop_running"), r.resetAIAutoSpeakCounter(), await l.updateSessionInDB(), await new Promise((c) => setTimeout(c, 50)), o());
    }, [
      o
    ]);
    return {
  ...
  const ke = J([
    ...
    speakCounts: ue(f(), A()).describe("\u6BCF\u4E2A\u89D2\u8272\u7684\u53D1\u8A00\u6B21\u6570"),
  ...
  tt = (s) => {
    ...
    const t = F(), [a, n] = C.useState(""), o = C.useRef(null), [m, g] = C.useState(false), i = ee(w), { data: l = [] } = te((d) => d.from({
      s: ae
    })), r = l.find((d) => d.id === s.sessionId);
    C.useEffect(() => {
      var _a2;
      let d = false;
      if (!r) return;
    ...
    const p = ((_b = (_a = i.currentSession) == null ? void 0 : _a.modeState) == null ? void 0 : _b.currentUIState) || "idle", I = O[p] || O.idle, S = (_e2 = (_d = (_c = i.currentSession) == null ? void 0 : _c.modeConfig) == null ? void 0 : _d.participantSnapshots) == null ? void 0 : _e2.find((d) => {
      var _a2, _b2;
      return d.id === ((_b2 = (_a2 = i.currentSession) == null ? void 0 : _a2.modeState) == null ? void 0 : _b2.currentSpeakerId);
    }), N = async () => {
      if (!a.trim()) return;
      const d = a;
      n(""), await c(d);
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsx("span", {
                          ...
                          children: S && p === "ai_loop_running" ? `${S.name} \u6B63\u5728\u8F93\u5165...` : I.label
                        })
                      ]
                    })
                  ]
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    ...
                    e.jsxs(y, {
                      ...
                      children: [
                        e.jsx("span", {
                          className: P("w-1.5 h-1.5 rounded-full", p === "ai_loop_running" ? "bg-violet-500 animate-pulse" : p === "ai_loop_paused" ? "bg-amber-500" : "bg-muted-foreground/30")
                        }),
                        "\u7FA4\u804A"
                      ]
                    })
            ...
            e.jsx("div", {
              ...
              children: e.jsx("div", {
                ...
                children: (() => {
                  ...
                  const d = (((_a2 = i.contextManager) == null ? void 0 : _a2.state.historyItems) || []).filter((b) => !b.hidden), v = (_b2 = i.contextManager) == null ? void 0 : _b2.state.processingItem;
                  if (p === "idle") {
                    const b = d.length === 0 ? "\u5F00\u59CB\u7FA4\u804A" : "\u7EE7\u7EED\u7FA4\u804A";
                    return e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsxs("p", {
                          ...
                          children: [
                            "\u4E0E ",
                            (_g2 = (_f2 = (_e3 = i.currentSession) == null ? void 0 : _e3.modeConfig) == null ? void 0 : _f2.participantSnapshots) == null ? void 0 : _g2.map((D) => D.name).join("\u3001"),
                            " \u4E00\u8D77\u804A\u5929"
                          ]
                        }),
                        e.jsxs(j, {
                  ...
                  return v && !v.hidden && !d.some((b) => b.id === v.id) && k.push(v), k.map((b, D) => {
                    var _a3, _b3, _c3, _d3;
                    return e.jsx(Me, {
                      item: b,
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsx(j, {
                          ...
                          size: "icon",
                          variant: "ghost",
                          className: P("h-10 w-10 rounded-xl text-muted-foreground hover:text-violet-600", p === "ai_loop_paused" && "text-amber-500 animate-pulse"),
                          disabled: h.current,
                          onClick: Q,
          ...
          children: [
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx("div", {
                  className: "space-y-2",
                  children: (_u = (_t = (_s = i.currentSession) == null ? void 0 : _s.modeConfig) == null ? void 0 : _t.participantSnapshots) == null ? void 0 : _u.map((d) => {
                    var _a2, _b2, _c2, _d2, _e3;
                    const v = d.id === ((_b2 = (_a2 = i.currentSession) == null ? void 0 : _a2.modeState) == null ? void 0 : _b2.currentSpeakerId) && p === "ai_loop_running", k = ((_e3 = (_d2 = (_c2 = i.currentSession) == null ? void 0 : _c2.modeState) == null ? void 0 : _d2.speakCounts) == null ? void 0 : _e3[d.id]) || 0;
                    return e.jsx("div", {
                      className: P("p-3 rounded-xl border transition-all duration-300", v ? "bg-violet-500/5 border-violet-500/30 shadow-sm shadow-violet-500/10" : "bg-background/40 border-muted/30"),
                      children: e.jsxs("div", {
                        className: "flex items-center gap-3",
                        children: [
                          e.jsx(V, {
  ...
  Me = ({ item: s, participants: t, userName: a, isStreaming: n }) => {
    ...
    switch (s.type) {
      ...
      case "gc_select_speaker":
        return null;
      default:
        return ((_a = s.data) == null ? void 0 : _a.content) ? e.jsx(z, {
          item: s,
          participants: t,
          isStreaming: n
        }) : null;
  ...
  z = ({ item: s, participants: t, isStreaming: a }) => {
    const n = s.data, o = t.find((i) => i.id === n.characterId), m = n.characterName || (o == null ? void 0 : o.name) || "\u89D2\u8272", g = a ? "..." : X(s.timestamp);
    return e.jsxs("div", {
