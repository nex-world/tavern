...
import { h as se, S as ae } from "./db-master-BEOlno_m.js";
import { s as ne } from "./db-CwrrHjxp.js";
import { _ as G, __tla as __tla_0 } from "./index-DuFQN0T7.js";
import { C as re, A as oe } from "./AutoScrollDownArea-DzopjOBa.js";
import { S as ie } from "./session-manager.class-BMUETjFh.js";
...
import { b as R, a as he } from "./analytics-DGRgH5yV.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-BEOlno_m.js").then((i)=>i.v);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-BEOlno_m.js").then((o)=>o.w);
                return {
                    masterDb: n
                };
