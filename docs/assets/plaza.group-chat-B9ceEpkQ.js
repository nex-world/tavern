import { j as e, u as n } from "./react-BPCshYXX.js";
import { f as j, i as f } from "./@tanstack-BuNX36FW.js";
import { S as N, m as v } from "./db-master-xI8DZi24.js";
import { B as o } from "./button-CKyQl8ny.js";
import { C as d, a as b, b as C, c as y, d as m } from "./card-B79febki.js";
import { B as x } from "./badge-b3CWeD_H.js";
import { A as w, a as A, b as D, c as S, d as k, e as P, f as B, g as T, h as I } from "./alert-dialog-D3tRcaR3.js";
import { u as l, P as p, g as H, U as L, t as M } from "./icons-BpfK1DnB.js";
...
function Z() {
  const r = j(), { data: h = [] } = f((s) => s.from({ s: N })), c = h.filter((s) => s.mode === "group-chat").sort((s, t) => t.updatedAt - s.updatedAt), g = async (s) => {
    try {
