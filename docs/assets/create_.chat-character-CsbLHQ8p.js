import { D as $, r as u, E as R, u as C, j as e } from "./react-BPCshYXX.js";
import { f as T } from "./@tanstack-BuNX36FW.js";
import { B as g } from "./button-CKyQl8ny.js";
import { T as P } from "./textarea-Dc_MpBxB.js";
import { C as V, a as K, b as Y, d as H } from "./card-B79febki.js";
import { B as J } from "./badge-b3CWeD_H.js";
import { c as F } from "./shadcn-utils-BMZD7_jZ.js";
import { n as S } from "./id-OxPLOBIU.js";
import { P as W, m as q } from "./db-master-xI8DZi24.js";
import { _ as L, o as k, n as D, s as v, b as Q, a as X, l as Z } from "./zod-fbN9ubnj.js";
import { u as ee } from "./useLLM-CCvhQGvi.js";
import { A as te, v as U, c as M, R as O, _ as se, P as ne, D as ae } from "./icons-BpfK1DnB.js";
...
`.trim();
function he() {
  const s = ee(), r = T(), i = u.useRef(false), b = R(t), w = u.useCallback(async (d) => {
...
${m}` }), c.push({ id: S(), role: "user", content: "\u8BF7\u6839\u636E\u4EE5\u4E0A\u4FE1\u606F\uFF0C\u751F\u6210\u89D2\u8272\u5361 JSON\u3002\u53EA\u8F93\u51FA JSON\uFF0C\u4E0D\u8981\u6709\u5176\u4ED6\u5185\u5BB9\u3002" });
  ...
  }, []), _ = u.useCallback(async () => {
    await f();
  }, [f]);
  return { store: b, sendMessage: w, generateDescription: j, generateJson: f, confirmJson: p, regenerateJson: _, isLoading: b.isLoading, streamingContent: b.streamingContent };
}
function ge() {
  var _a, _b, _c, _d;
  const s = T(), r = R(t), { sendMessage: i, generateDescription: b, generateJson: w, confirmJson: j, regenerateJson: f, isLoading: p, streamingContent: _ } = he(), [d, m] = u.useState("");
