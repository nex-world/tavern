...
import { h as ct, m as Ce, S as lt } from "./db-master-CbDKzz4h.js";
import { k as ie, m as ce, j as dt } from "./@tanstack-DHpjEvx5.js";
import { _ as mt, __tla as __tla_0 } from "./index-DwIbAt2a.js";
import { C as pt, A as ut } from "./AutoScrollDownArea-B6OpBmAX.js";
import { S as ht } from "./session-manager.class-CZxvteyb.js";
        ...
        async updateSessionInDB () {
            if (o.currentSession) try {
                const { masterDb: t } = await mt(async ()=>{
                    const { masterDb: r } = await import("./db-master-CbDKzz4h.js").then((a)=>a.w);
                    return {
                        masterDb: r
                    };
