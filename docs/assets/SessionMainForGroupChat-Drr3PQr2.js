...
import { h as se, S as ae } from "./db-master-CvVq9mNL.js";
import { s as ne } from "./db-6jKjQj6k.js";
import { _ as G, __tla as __tla_0 } from "./index-kxbYIK51.js";
import { C as re, A as oe } from "./AutoScrollDownArea-Bqqn_mPt.js";
import { S as ie } from "./session-manager.class-CRdrGxB3.js";
...
import { C as q } from "./CharacterAvatar-DYLZQENt.js";
import { b as R, a as he } from "./analytics-DsuSsh9n.js";
import { au as ge, J as O, a4 as fe, aE as Se, S as be, g as B, W as Ce } from "./icons-0flmCaj9.js";
    ...
    const C = U({
        ...
        async saveNewContextItemsToDB (s, t) {
            const { SessionDB: a } = await G(async ()=>{
                const { SessionDB: p } = await import("./db-master-CvVq9mNL.js").then((i)=>i.v);
                return {
                    SessionDB: p
                };
        ...
        async updateSessionInDB () {
            ...
            const { masterDb: s } = await G(async ()=>{
                const { masterDb: n } = await import("./db-master-CvVq9mNL.js").then((o)=>o.w);
                return {
                    masterDb: n
                };
