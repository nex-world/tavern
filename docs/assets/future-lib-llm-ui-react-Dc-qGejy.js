import { r as N, j as e } from "./react-C1-gKlL3.js";
import { ao as R, ap as T, aq as I, ar as u, as as x, f as j, at as q, au as V, av as K, B as P, aw as M, ax as W, ay as G, az as _, aA as X, aB as H, aC as Q, ad as F, X as U, af as E, ag as $, ah as z, ai as A, aj as w } from "./app-components-Cazi3mLF.js";
import { ah as Y, d as Z } from "./icons-D0dskdnL.js";
...
function de({ config: s, setConfig: t, models: n, isFetchingModels: r, fetchModels: o, customParamList: l, addCustomParam: i, updateCustomParam: c, removeCustomParam: b }) {
  ...
  return e.jsxs("div", { className: "space-y-1", children: [e.jsxs(R, { children: [e.jsx(T, { children: "API Configuration" }), e.jsxs(I, { className: "space-y-1", children: [e.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-1", children: [e.jsxs(u, { children: [e.jsx(x, { children: "Base URL" }), e.jsx(j, { value: s.baseUrl, onChange: (a) => t({ baseUrl: a.target.value }), placeholder: "https://api.example.com" })] }), e.jsxs(u, { children: [e.jsx(x, { children: "API Key" }), e.jsx(j, { type: "password", value: s.apiKey, onChange: (a) => t({ apiKey: a.target.value }), placeholder: "sk-..." })] })] }), e.jsxs(u, { children: [e.jsx(x, { children: "Model" }), e.jsxs(q, { className: "w-full", children: [e.jsxs(V, { open: S, onOpenChange: m, children: [e.jsx(K, { asChild: true, children: e.jsxs(P, { variant: "outline", role: "combobox", "aria-expanded": S, className: "justify-between flex-1", size: "sm", children: [s.model ? (_a = n.find((a) => a.id === s.model)) == null ? void 0 : _a.id : "Select model...", e.jsx(Y, { className: "ml-2 h-4 w-4 shrink-0 opacity-50" })] }) }), e.jsx(M, { className: "w-full p-0", children: e.jsxs(W, { children: [e.jsx(G, { placeholder: "Search model..." }), e.jsxs(_, { children: [e.jsx(X, { children: "No model found." }), e.jsx(H, { children: n.map((a) => e.jsxs(Q, { value: a.id, onSelect: (d) => {
